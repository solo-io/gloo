...
// DNM: prototyping in gloo before moving to solo-projects
require istio.io/istio v0.0.0-20240903161425-b8197f455bcf

replace github.com/imdario/mergo => github.com/imdario/mergo v0.3.5

replace github.com/solo-io/skv2 v0.39.1 => github.com/stevenctl/skv2 v0.41.0-bump-k8s-131
...
replace (
	...
	// version of kube-openapi used by client-go v0.31.0
