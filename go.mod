...
replace (
	...
	// Pin go-control-plane proto bindings to match the envoy v1.32 runtime used on v1.18.x.
	// Newer versions were pulled in transitively by google.golang.org/grpc v1.82.1 (CVE bump).
