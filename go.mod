...
require (
	...
	github.com/solo-io/envoy-gloo/go v0.0.0-20250311192924-276da41952a3
...
replace (
	sigs.k8s.io/gateway-api => sigs.k8s.io/gateway-api v1.2.1-0.20250228032030-a5be7b543323
