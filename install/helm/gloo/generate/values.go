...
type GatewayValidation struct {
	...
	NonGlooFailurePolicy             *string  `json:"nonGlooFailurePolicy,omitempty" desc:"nonGlooFailurePolicy defines how unrecognized errors for non-Gloo resources from the Gateway validation endpoint are handled - allowed values are 'Ignore' or 'Fail'. Defaults to Ignore "`
