...
type GatewayValidation struct {
	...
	// TODO-JAKE not sure if we want to include wording for Rate Limit and Ext Auth
	// TODO-JAKE not sure if we want to set this by default.  I assume we would want to have this set by default? Maybe only set this by default in Enterprise mode only.
	EnableExtensionValidation        *bool    `json:"enableExtensionValidation,omitempty" desc:"(Enterprise Only): If set allows validation of Rate Limit and Ext Auth Configs."`
