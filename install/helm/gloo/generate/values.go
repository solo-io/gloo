...
type Global struct {
	...
	ExtraSpecs        bool             `json:"extraSpecs" desc:"Add additional specs to include in the settings manifest, as defined by a helm partial. Defaults to false in open source, and true in enterprise."`
...
type Settings struct {
	...
	RegexMaxProgramSize           uint32               `json:"regexMaxProgramSize" desc:"Set this field to specify the RE2 default max program size which is a rough estimate of how complex the compiled regex is to evaluate. If not specified, this defaults to 100."`
