...
func (m *MockBasicRateLimitTranslator) GenerateResourceConfig(resourceName, headerName string, stage uint32) []*routev3.RateLimit {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateResourceConfig", resourceName, headerName, stage)
	ret0, _ := ret[0].([]*routev3.RateLimit)
	return ret0
}
