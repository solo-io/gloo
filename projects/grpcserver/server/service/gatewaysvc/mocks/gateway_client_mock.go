...
// Source: github.com/solo-io/gloo/projects/gateway/pkg/api/v2 (interfaces: GatewayClient)
...
func (m *MockGatewayClient) List(arg0 string, arg1 clients.ListOpts) (v2.GatewayList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", arg0, arg1)
	ret0, _ := ret[0].(v2.GatewayList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockGatewayClient) Read(arg0, arg1 string, arg2 clients.ReadOpts) (*v2.Gateway, error) {
	m.ctrl.T.Helper()
...
func (m *MockGatewayClient) Watch(arg0 string, arg1 clients.WatchOpts) (<-chan v2.GatewayList, <-chan error, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Watch", arg0, arg1)
	ret0, _ := ret[0].(<-chan v2.GatewayList)
...
func (m *MockGatewayClient) Write(arg0 *v2.Gateway, arg1 clients.WriteOpts) (*v2.Gateway, error) {
	m.ctrl.T.Helper()
