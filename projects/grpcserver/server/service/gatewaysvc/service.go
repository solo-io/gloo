...
func (s *gatewayGrpcService) GetGateway(ctx context.Context, request *v1.GetGatewayRequest) (*v1.GetGatewayResponse, error) {
	gateway, err := s.clientCache.GetGatewayClient().Read(request.GetRef().GetNamespace(), request.GetRef().GetName(), clients.ReadOpts{Ctx: s.ctx})
	if err != nil {
...
func (s *gatewayGrpcService) UpdateGatewayYaml(ctx context.Context, request *v1.UpdateGatewayYamlRequest) (*v1.UpdateGatewayResponse, error) {
	...
	written, err := s.clientCache.GetGatewayClient().Write(gatewayFromYaml, clients.WriteOpts{Ctx: s.ctx, OverwriteExisting: true})
	if err != nil {
