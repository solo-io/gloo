...
func InitDevPortal(ctx context.Context) (Registrar, error) {
	...
	apikeyscopeGrpcService := apikeyscope.NewKeyScopeGrpcService(apiDocClient, portalClient, resourceLabeler)
	registrar := NewRegistrar(grpcService, apidocGrpcService, userGrpcService, groupGrpcService, apikeyGrpcService, apikeyscopeGrpcService)
