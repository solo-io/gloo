...
import (
	...
	v11 "github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/plugins/extauth/v1"
...
type VirtualServiceInput_Oauth struct {
	Oauth *v11.OAuth `protobuf:"bytes,8,opt,name=oauth,proto3,oneof" json:"oauth,omitempty"`
}
type VirtualServiceInput_CustomAuth struct {
	CustomAuth *v11.CustomAuth `protobuf:"bytes,9,opt,name=custom_auth,json=customAuth,proto3,oneof" json:"custom_auth,omitempty"`
}
...
func (m *VirtualServiceInput) GetOauth() *v11.OAuth {
...
func (m *VirtualServiceInput) GetCustomAuth() *v11.CustomAuth {
...
var fileDescriptor_3c1e74246b50b246 = []byte{
	...
	,
}
