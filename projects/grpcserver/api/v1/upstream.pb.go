...
type ListUpstreamsResponse struct {
	UpstreamList         []*v1.Upstream `protobuf:"bytes,1,rep,name=upstream_list,json=upstreamList,proto3" json:"upstream_list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *ListUpstreamsResponse) GetUpstreamList() []*v1.Upstream {
	if m != nil {
		return m.UpstreamList
	}
	return nil
}
...
func (m *StreamUpstreamListResponse) GetUpstreamList() []*v1.Upstream {
	if m != nil {
		return m.UpstreamList
	}
	return nil
...
var fileDescriptor_b7d24dd6d13c7a0b = []byte{
	...
	,
}
...
func (this *ListUpstreamsResponse) Equal(that interface{}) bool {
	...
	if len(this.UpstreamList) != len(that1.UpstreamList) {
		return false
	}
	for i := range this.UpstreamList {
		if !this.UpstreamList[i].Equal(that1.UpstreamList[i]) {
			return false
		}
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
