...
type ListArtifactsResponse struct {
	ArtifactList         []*v1.Artifact `protobuf:"bytes,1,rep,name=artifact_list,json=artifactList,proto3" json:"artifact_list,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *ListArtifactsResponse) GetArtifactList() []*v1.Artifact {
	if m != nil {
...
func (m *CreateArtifactRequest) GetData() string {
	if m != nil {
		return m.Data
	}
	return ""
...
func (m *UpdateArtifactRequest) GetData() string {
	if m != nil {
		return m.Data
	}
	return ""
...
var fileDescriptor_31231f9377f1df05 = []byte{
	...
	,
}
...
func (this *ListArtifactsResponse) Equal(that interface{}) bool {
	...
	if len(this.ArtifactList) != len(that1.ArtifactList) {
		return false
	}
	for i := range this.ArtifactList {
		if !this.ArtifactList[i].Equal(that1.ArtifactList[i]) {
			return false
		}
	}
	if !bytes.Equal(this.XXX_unrecognized, that1.XXX_unrecognized) {
