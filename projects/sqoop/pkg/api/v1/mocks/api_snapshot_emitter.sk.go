...
// Source: ./projects/sqoop/pkg/api/v1/api_snapshot_emitter.sk.go
...
// ResolverMap mocks base method
func (m *MockApiEmitter) ResolverMap() v1.ResolverMapClient {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResolverMap")
	ret0, _ := ret[0].(v1.ResolverMapClient)
	return ret0
}

// ResolverMap indicates an expected call of ResolverMap
func (mr *MockApiEmitterMockRecorder) ResolverMap() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResolverMap", reflect.TypeOf((*MockApiEmitter)(nil).ResolverMap))
}

// Schema mocks base method
func (m *MockApiEmitter) Schema() v1.SchemaClient {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Schema")
	ret0, _ := ret[0].(v1.SchemaClient)
	return ret0
}

// Schema indicates an expected call of Schema
func (mr *MockApiEmitterMockRecorder) Schema() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Schema", reflect.TypeOf((*MockApiEmitter)(nil).Schema))
}
