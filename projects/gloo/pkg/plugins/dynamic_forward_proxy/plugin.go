...
const (
	...
	DFP_AUTOGENERATED_CLUSTER_PREFIX = "solo_io_generated_dfp:"
)
...
func GetGeneratedClusterName(dfpListenerCfg *dynamic_forward_proxy.FilterConfig) string {
	...
	return fmt.Sprintf("%s%s", DFP_AUTOGENERATED_CLUSTER_PREFIX, getHashString(dfpListenerCfg))
}

func getGeneratedCacheName(cc *dynamic_forward_proxy.DnsCacheConfig) string {
	return fmt.Sprintf("%s%s", DFP_AUTOGENERATED_CLUSTER_PREFIX, fmt.Sprintf("%v", hashutils.MustHash(cc)))
}
