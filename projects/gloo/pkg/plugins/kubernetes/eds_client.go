...
func NewEdsClient(kube kubernetes.Interface, upstreams v1.UpstreamList) v1.EndpointClient {
...
func (c *edsClient) List(namespace string, opts clients.ListOpts) (v1.EndpointList, error) {
...
func (c *edsClient) Watch(namespace string, opts clients.WatchOpts) (<-chan v1.EndpointList, <-chan error, error) {
	opts = opts.WithDefaults()
...
func (c *edsClient) BaseClient() clients.ResourceClient {
	panic("implement me")
}

func (c *edsClient) Register() error {
	panic("implement me")
}

func (c *edsClient) Read(namespace, name string, opts clients.ReadOpts) (*v1.Endpoint, error) {
	panic("implement me")
}

func (c *edsClient) Write(resource *v1.Endpoint, opts clients.WriteOpts) (*v1.Endpoint, error) {
	panic("implement me")
}

func (c *edsClient) Delete(namespace, name string, opts clients.DeleteOpts) error {
	panic("implement me")
}
