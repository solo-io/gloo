...
func TranslateIpFamily(ipFamily v1.GlooOptions_IpFamily) envoy_config_cluster_v3.Cluster_DnsLookupFamily {
	switch ipFamily {
	case v1.GlooOptions_V4_ONLY:
		return envoy_config_cluster_v3.Cluster_V4_ONLY
	case v1.GlooOptions_V6_ONLY:
		return envoy_config_cluster_v3.Cluster_V6_ONLY
	case v1.GlooOptions_V4_PREFERRED:
