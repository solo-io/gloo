...
func (m *MockAuthMethod) Login(ctx context.Context, client *api.Client) (*api.Secret, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAuthMethodMockRecorder) Login(ctx, client any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Login", reflect.TypeOf((*MockAuthMethod)(nil).Login), ctx, client)
}
