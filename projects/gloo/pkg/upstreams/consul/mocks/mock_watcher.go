...
//
//	mockgen -destination ./mocks/mock_watcher.go -source watcher.go -aux_files github.com/solo-io/gloo/projects/gloo/pkg/upstreams/consul=./consul_client.go
//
...
func (mr *MockConsulWatcherMockRecorder) Connect(service, tag, q any) *gomock.Call {
...
func (mr *MockConsulWatcherMockRecorder) Service(service, tag, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConsulWatcherMockRecorder) Services(q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConsulWatcherMockRecorder) WatchServices(ctx, dataCenters, cm, queryOpts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
