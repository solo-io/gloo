...
//
//	mockgen -destination=./mocks/mock_consul_client.go -source consul_client.go
//
...
func (mr *MockClientWrapperMockRecorder) Connect(service, tag, q any) *gomock.Call {
...
func (mr *MockClientWrapperMockRecorder) Service(service, tag, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientWrapperMockRecorder) Services(q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
