...
func (m *MockSnapshotCache) CreateWatch(arg0 envoy_api_v2.DiscoveryRequest) (chan cache.Response, func()) {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotCache) Fetch(arg0 context.Context, arg1 envoy_api_v2.DiscoveryRequest) (*cache.Response, error) {
	m.ctrl.T.Helper()
