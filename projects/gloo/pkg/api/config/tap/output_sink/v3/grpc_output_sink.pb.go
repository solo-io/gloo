...
const file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_tap_output_sink_v3_grpc_output_sink_proto_rawDesc = "" +
	"\n" +
	"igithub.com/solo-io/gloo/projects/gloo/api/external/envoy/config/tap/output_sink/v3/grpc_output_sink.proto\x12\x1fenvoy.config.tap.output_sink.v3\x1a\x17validate/validate.proto\x1aZgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/grpc_service.proto\"h\n" +
	"\x0eGrpcOutputSink\x12V\n" +
	"\fgrpc_service\x18\x01 \x01(\v2).solo.io.envoy.config.core.v3.GrpcServiceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vgrpcServiceB\x8f\x01\n" +
	"-io.envoyproxy.envoy.config.output_sink.tap.v3B\x13GrpcOutputSinkProtoP\x01ZGgithub.com/solo-io/gloo/projects/gloo/pkg/api/config/tap/output_sink/v3b\x06proto3"
...
var (
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_tap_output_sink_v3_grpc_output_sink_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_tap_output_sink_v3_grpc_output_sink_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_tap_output_sink_v3_grpc_output_sink_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_tap_output_sink_v3_grpc_output_sink_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
