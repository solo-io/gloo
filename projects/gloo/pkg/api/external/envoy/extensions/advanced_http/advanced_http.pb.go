...
const file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc = "" +
	"\n" +
	"egithub.com/solo-io/gloo/projects/gloo/api/external/envoy/extensions/advanced_http/advanced_http.proto\x12,envoy.config.health_checker.advanced_http.v2\x1a\x1dudpa/annotations/status.proto\x1aZgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/health_check.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17validate/validate.proto\"\xe8\x01\n" +
	"\fAdvancedHttp\x12e\n" +
	"\x11http_health_check\x18\x01 \x01(\v29.solo.io.envoy.config.core.v3.HealthCheck.HttpHealthCheckR\x0fhttpHealthCheck\x12q\n" +
	"\x13response_assertions\x18\x02 \x01(\v2@.envoy.config.health_checker.advanced_http.v2.ResponseAssertionsR\x12responseAssertions\"\xe9\x01\n" +
	"\x12ResponseAssertions\x12j\n" +
	"\x11response_matchers\x18\x01 \x03(\v2=.envoy.config.health_checker.advanced_http.v2.ResponseMatcherR\x10responseMatchers\x12g\n" +
	"\x0fno_match_health\x18\x02 \x01(\x0e2?.envoy.config.health_checker.advanced_http.v2.HealthCheckResultR\rnoMatchHealth\"\xd9\x01\n" +
	"\x0fResponseMatcher\x12b\n" +
	"\x0eresponse_match\x18\x01 \x01(\v2;.envoy.config.health_checker.advanced_http.v2.ResponseMatchR\rresponseMatch\x12b\n" +
	"\fmatch_health\x18\x02 \x01(\x0e2?.envoy.config.health_checker.advanced_http.v2.HealthCheckResultR\vmatchHealth\"\xfc\x01\n" +
	"\rResponseMatch\x12P\n" +
	"\bjson_key\x18\x01 \x01(\v25.envoy.config.health_checker.advanced_http.v2.JsonKeyR\ajsonKey\x121\n" +
	...
	"\x06source\"\xa6\x01\n" +
	"\aJsonKey\x12_\n" +
	"\x04path\x18\x02 \x03(\v2A.envoy.config.health_checker.advanced_http.v2.JsonKey.PathSegmentB\b\xfaB\x05\x92\x01\x02\b\x01R\x04path\x1a:\n" +
	...
	"\tunhealthy\x10\x02B\xa3\x01\n" +
	":io.envoyproxy.envoy.config.health_checker.advanced_http.v2B\fAdvancedHttpP\x01ZUgithub.com/solo-io/gloo/projects/gloo/pkg/api/external/envoy/extensions/advanced_httpb\x06proto3"
...
var (
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_msgTypes[3].OneofWrappers = []any{
		(*ResponseMatch_Header)(nil),
		(*ResponseMatch_Body)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
