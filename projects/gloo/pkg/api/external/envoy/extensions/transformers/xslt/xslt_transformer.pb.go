...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_transformers_xslt_xslt_transformer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_transformers_xslt_xslt_transformer_proto_msgTypes[0].Exporter = func(v any, i int) any {
