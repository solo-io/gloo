...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_xff_offset_solo_xff_offset_filter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_xff_offset_solo_xff_offset_filter_proto_msgTypes[0].Exporter = func(v any, i int) any {
