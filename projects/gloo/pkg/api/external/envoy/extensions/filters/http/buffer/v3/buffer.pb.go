...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Buffer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_proto_msgTypes[1].Exporter = func(v any, i int) any {
