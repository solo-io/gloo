...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_proto_rawDesc = []byte{
	...
	0x4c, 0x10, 0x02, 0x42, 0x08, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xe5, 0x0d,
	...
	0x72, 0x73, 0x12, 0x6b, 0x0a, 0x10, 0x73, 0x70, 0x61, 0x6e, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73,
	...
	0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4a, 0x04, 0x08, 0x0d, 0x10, 0x0e, 0x4a,
	0x04, 0x08, 0x0e, 0x10, 0x0f, 0x22, 0x22, 0x0a, 0x0c, 0x49, 0x6e, 0x6a, 0x61, 0x54, 0x65, 0x6d,
	...
	0x73, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x64, 0xb8, 0xf5, 0x04, 0x01,
	0xc0, 0xf5, 0x04, 0x01, 0xd0, 0xf5, 0x04, 0x01, 0x5a, 0x56, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_proto_goTypes = []interface{}{
	...
	(*TransformationTemplate_SpanTransformer)(nil),      // 22: envoy.api.v2.filter.http.TransformationTemplate.SpanTransformer
	(*v3.RouteMatch)(nil),                               // 23: solo.io.envoy.config.route.v3.RouteMatch
	(*v3.HeaderMatcher)(nil),                            // 24: solo.io.envoy.config.route.v3.HeaderMatcher
	(*v31.StringMatcher)(nil),                           // 25: solo.io.envoy.type.matcher.v3.StringMatcher
	(*v32.TypedExtensionConfig)(nil),                    // 26: solo.io.envoy.config.core.v3.TypedExtensionConfig
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_proto_depIdxs = []int32{
	...
	23, // 1: envoy.api.v2.filter.http.TransformationRule.match:type_name -> solo.io.envoy.config.route.v3.RouteMatch
	...
	24, // 6: envoy.api.v2.filter.http.ResponseMatcher.headers:type_name -> solo.io.envoy.config.route.v3.HeaderMatcher
	25, // 7: envoy.api.v2.filter.http.ResponseMatcher.response_code_details:type_name -> solo.io.envoy.type.matcher.v3.StringMatcher
	...
	26, // 12: envoy.api.v2.filter.http.Transformation.transformer_config:type_name -> solo.io.envoy.config.core.v3.TypedExtensionConfig
	27, // 13: envoy.api.v2.filter.http.Transformation.log_request_response_info:type_name -> google.protobuf.BoolValue
	28, // 14: envoy.api.v2.filter.http.Extraction.body:type_name -> google.protobuf.Empty
	29, // 15: envoy.api.v2.filter.http.Extraction.replacement_text:type_name -> google.protobuf.StringValue
	...
	22, // 25: envoy.api.v2.filter.http.TransformationTemplate.span_transformer:type_name -> envoy.api.v2.filter.http.TransformationTemplate.SpanTransformer
	7,  // 26: envoy.api.v2.filter.http.TransformationRule.Transformations.request_transformation:type_name -> envoy.api.v2.filter.http.Transformation
	7,  // 27: envoy.api.v2.filter.http.TransformationRule.Transformations.response_transformation:type_name -> envoy.api.v2.filter.http.Transformation
	7,  // 28: envoy.api.v2.filter.http.TransformationRule.Transformations.on_stream_completion_transformation:type_name -> envoy.api.v2.filter.http.Transformation
	16, // 29: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.request_match:type_name -> envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.RequestMatch
	17, // 30: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.response_match:type_name -> envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.ResponseMatch
	23, // 31: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.RequestMatch.match:type_name -> solo.io.envoy.config.route.v3.RouteMatch
	7,  // 32: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.RequestMatch.request_transformation:type_name -> envoy.api.v2.filter.http.Transformation
	7,  // 33: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.RequestMatch.response_transformation:type_name -> envoy.api.v2.filter.http.Transformation
	5,  // 34: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.ResponseMatch.match:type_name -> envoy.api.v2.filter.http.ResponseMatcher
	7,  // 35: envoy.api.v2.filter.http.RouteTransformations.RouteTransformation.ResponseMatch.response_transformation:type_name -> envoy.api.v2.filter.http.Transformation
	8,  // 36: envoy.api.v2.filter.http.TransformationTemplate.ExtractorsEntry.value:type_name -> envoy.api.v2.filter.http.Extraction
	10, // 37: envoy.api.v2.filter.http.TransformationTemplate.HeadersEntry.value:type_name -> envoy.api.v2.filter.http.InjaTemplate
	10, // 38: envoy.api.v2.filter.http.TransformationTemplate.HeaderToAppend.value:type_name -> envoy.api.v2.filter.http.InjaTemplate
	10, // 39: envoy.api.v2.filter.http.TransformationTemplate.DynamicMetadataValue.value:type_name -> envoy.api.v2.filter.http.InjaTemplate
	10, // 40: envoy.api.v2.filter.http.TransformationTemplate.SpanTransformer.name:type_name -> envoy.api.v2.filter.http.InjaTemplate
