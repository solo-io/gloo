...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_jwt_solo_jwt_authn_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_jwt_solo_jwt_authn_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_jwt_solo_jwt_authn_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_jwt_solo_jwt_authn_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_jwt_solo_jwt_authn_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_jwt_solo_jwt_authn_proto_msgTypes[4].Exporter = func(v any, i int) any {
