...
func (m *VmConfig) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	if _, err = hasher.Write([]byte("Runtime")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("AllowPrecompiled")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("NackOnCodeCacheMiss")); err != nil {
		return 0, err
	}
...
func (m *WasmService) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	if _, err = hasher.Write([]byte("Singleton")); err != nil {
		return 0, err
	}
