...
type VirtualHost struct {
	...
	PerFilterConfig map[string]*_struct.Struct `protobuf:"bytes,12,rep,name=per_filter_config,json=perFilterConfig,proto3" json:"per_filter_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// The per_filter_config field can be used to provide virtual host-specific
	// configurations for filters. The key should match the filter name, such as
	// *envoy.filters.http.buffer* for the HTTP buffer filter. Use of this field is filter
	// specific; see the `HTTP filter documentation (config_http_filters)`
...
type Route struct {
	...
	PerFilterConfig map[string]*_struct.Struct `protobuf:"bytes,8,rep,name=per_filter_config,json=perFilterConfig,proto3" json:"per_filter_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// The per_filter_config field can be used to provide route-specific
	// configurations for filters. The key should match the filter name, such as
	// *envoy.filters.http.buffer* for the HTTP buffer filter. Use of this field is filter
	// specific; see the `HTTP filter documentation (config_http_filters)` for
...
const file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDesc = "" +
	"\n" +
	"Qgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/api/v2/route/route.proto\x12\x1asolo.io.envoy.api.v2.route\x1aEgithub.com/solo-io/solo-kit/api/external/envoy/api/v2/core/base.proto\x1aAgithub.com/solo-io/solo-kit/api/external/envoy/type/percent.proto\x1aIgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/range.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17validate/validate.proto\x1a\x12extproto/ext.proto\"\xd4\v\n" +
	"\vVirtualHost\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12\"\n" +
	"\adomains\x18\x02 \x03(\tB\b\xfaB\x05\x92\x01\x02\b\x01R\adomains\x129\n" +
	"\x06routes\x18\x03 \x03(\v2!.solo.io.envoy.api.v2.route.RouteR\x06routes\x12[\n" +
	"\vrequire_tls\x18\x04 \x01(\x0e2:.solo.io.envoy.api.v2.route.VirtualHost.TlsRequirementTypeR\n" +
	"requireTls\x12U\n" +
	"\x10virtual_clusters\x18\x05 \x03(\v2*.solo.io.envoy.api.v2.route.VirtualClusterR\x0fvirtualClusters\x12F\n" +
	"\vrate_limits\x18\x06 \x03(\v2%.solo.io.envoy.api.v2.route.RateLimitR\n" +
	"rateLimits\x12l\n" +
	"\x16request_headers_to_add\x18\a \x03(\v2,.solo.io.envoy.api.v2.core.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x13requestHeadersToAdd\x129\n" +
	"\x19request_headers_to_remove\x18\r \x03(\tR\x16requestHeadersToRemove\x12n\n" +
	"\x17response_headers_to_add\x18\n" +
	" \x03(\v2,.solo.io.envoy.api.v2.core.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAdd\x12;\n" +
	"\x1aresponse_headers_to_remove\x18\v \x03(\tR\x17responseHeadersToRemove\x12:\n" +
	"\x04cors\x18\b \x01(\v2&.solo.io.envoy.api.v2.route.CorsPolicyR\x04cors\x12h\n" +
	"\x11per_filter_config\x18\f \x03(\v2<.solo.io.envoy.api.v2.route.VirtualHost.PerFilterConfigEntryR\x0fperFilterConfig\x12x\n" +
	"\x17typed_per_filter_config\x18\x0f \x03(\v2A.solo.io.envoy.api.v2.route.VirtualHost.TypedPerFilterConfigEntryR\x14typedPerFilterConfig\x12A\n" +
	"\x1dinclude_request_attempt_count\x18\x0e \x01(\bR\x1aincludeRequestAttemptCount\x12J\n" +
	"\fretry_policy\x18\x10 \x01(\v2'.solo.io.envoy.api.v2.route.RetryPolicyR\vretryPolicy\x12J\n" +
	"\fhedge_policy\x18\x11 \x01(\v2'.solo.io.envoy.api.v2.route.HedgePolicyR\vhedgePolicy\x1a[\n" +
	...
	"\n" +
	"\x05Route\x12\x12\n" +
	"\x04name\x18\x0e \x01(\tR\x04name\x12F\n" +
	"\x05match\x18\x01 \x01(\v2&.solo.io.envoy.api.v2.route.RouteMatchB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05match\x12?\n" +
	"\x05route\x18\x02 \x01(\v2'.solo.io.envoy.api.v2.route.RouteActionH\x00R\x05route\x12H\n" +
	"\bredirect\x18\x03 \x01(\v2*.solo.io.envoy.api.v2.route.RedirectActionH\x00R\bredirect\x12[\n" +
	"\x0fdirect_response\x18\a \x01(\v20.solo.io.envoy.api.v2.route.DirectResponseActionH\x00R\x0edirectResponse\x12?\n" +
	"\bmetadata\x18\x04 \x01(\v2#.solo.io.envoy.api.v2.core.MetadataR\bmetadata\x12C\n" +
	"\tdecorator\x18\x05 \x01(\v2%.solo.io.envoy.api.v2.route.DecoratorR\tdecorator\x12b\n" +
	"\x11per_filter_config\x18\b \x03(\v26.solo.io.envoy.api.v2.route.Route.PerFilterConfigEntryR\x0fperFilterConfig\x12r\n" +
	"\x17typed_per_filter_config\x18\r \x03(\v2;.solo.io.envoy.api.v2.route.Route.TypedPerFilterConfigEntryR\x14typedPerFilterConfig\x12l\n" +
	"\x16request_headers_to_add\x18\t \x03(\v2,.solo.io.envoy.api.v2.core.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x13requestHeadersToAdd\x129\n" +
	"\x19request_headers_to_remove\x18\f \x03(\tR\x16requestHeadersToRemove\x12n\n" +
	"\x17response_headers_to_add\x18\n" +
	" \x03(\v2,.solo.io.envoy.api.v2.core.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAdd\x12;\n" +
	"\x1aresponse_headers_to_remove\x18\v \x03(\tR\x17responseHeadersToRemove\x12=\n" +
	"\atracing\x18\x0f \x01(\v2#.solo.io.envoy.api.v2.route.TracingR\atracing\x1a[\n" +
	"\x14PerFilterConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x01\x1a]\n" +
	"\x19TypedPerFilterConfigEntry\x12\x10\n" +
	...
	"\x06action\x12\x03\xf8B\x01J\x04\b\x06\x10\a\"\xbc\t\n" +
	"\x0fWeightedCluster\x12_\n" +
	"\bclusters\x18\x01 \x03(\v29.solo.io.envoy.api.v2.route.WeightedCluster.ClusterWeightB\b\xfaB\x05\x92\x01\x02\b\x01R\bclusters\x12H\n" +
	"\ftotal_weight\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x01R\vtotalWeight\x12,\n" +
	"\x12runtime_key_prefix\x18\x02 \x01(\tR\x10runtimeKeyPrefix\x1a\xcf\a\n" +
	"\rClusterWeight\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x124\n" +
	"\x06weight\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x06weight\x12J\n" +
	"\x0emetadata_match\x18\x03 \x01(\v2#.solo.io.envoy.api.v2.core.MetadataR\rmetadataMatch\x12l\n" +
	"\x16request_headers_to_add\x18\x04 \x03(\v2,.solo.io.envoy.api.v2.core.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x13requestHeadersToAdd\x129\n" +
	"\x19request_headers_to_remove\x18\t \x03(\tR\x16requestHeadersToRemove\x12n\n" +
	"\x17response_headers_to_add\x18\x05 \x03(\v2,.solo.io.envoy.api.v2.core.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAdd\x12;\n" +
	"\x1aresponse_headers_to_remove\x18\x06 \x03(\tR\x17responseHeadersToRemove\x12z\n" +
	"\x11per_filter_config\x18\b \x03(\v2N.solo.io.envoy.api.v2.route.WeightedCluster.ClusterWeight.PerFilterConfigEntryR\x0fperFilterConfig\x12\x8a\x01\n" +
	"\x17typed_per_filter_config\x18\n" +
	" \x03(\v2S.solo.io.envoy.api.v2.route.WeightedCluster.ClusterWeight.TypedPerFilterConfigEntryR\x14typedPerFilterConfig\x1a[\n" +
	"\x14PerFilterConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x01\x1a]\n" +
	"\x19TypedPerFilterConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01J\x04\b\a\x10\b\"\xa0\x05\n" +
	"\n" +
	"RouteMatch\x12\x18\n" +
	"\x06prefix\x18\x01 \x01(\tH\x00R\x06prefix\x12\x14\n" +
	"\x04path\x18\x02 \x01(\tH\x00R\x04path\x12 \n" +
	"\x05regex\x18\x03 \x01(\tB\b\xfaB\x05r\x03(\x80\bH\x00R\x05regex\x12`\n" +
	"\x0fconnect_matcher\x18\n" +
	" \x01(\v25.solo.io.envoy.api.v2.route.RouteMatch.ConnectMatcherH\x00R\x0econnectMatcher\x12A\n" +
	"\x0ecase_sensitive\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\rcaseSensitive\x12^\n" +
	"\x10runtime_fraction\x18\t \x01(\v23.solo.io.envoy.api.v2.core.RuntimeFractionalPercentR\x0fruntimeFraction\x12C\n" +
	"\aheaders\x18\x06 \x03(\v2).solo.io.envoy.api.v2.route.HeaderMatcherR\aheaders\x12\\\n" +
	"\x10query_parameters\x18\a \x03(\v21.solo.io.envoy.api.v2.route.QueryParameterMatcherR\x0fqueryParameters\x12P\n" +
	"\x04grpc\x18\b \x01(\v2<.solo.io.envoy.api.v2.route.RouteMatch.GrpcRouteMatchOptionsR\x04grpc\x1a\x10\n" +
	"\x0eConnectMatcher\x1a\x17\n" +
	"\x15GrpcRouteMatchOptionsB\x15\n" +
	"\x0epath_specifier\x12\x03\xf8B\x01J\x04\b\x05\x10\x06\"\xca\x04\n" +
	"\n" +
	"CorsPolicy\x12!\n" +
	"\fallow_origin\x18\x01 \x03(\tR\vallowOrigin\x12;\n" +
	"\x12allow_origin_regex\x18\b \x03(\tB\r\xfaB\n" +
	"\x92\x01\a\"\x05r\x03(\x80\bR\x10allowOriginRegex\x12#\n" +
	...
	"\aenabled\x18\a \x01(\v2\x1a.google.protobuf.BoolValueB\x02\x18\x01H\x00R\aenabled\x12\\\n" +
	"\x0efilter_enabled\x18\t \x01(\v23.solo.io.envoy.api.v2.core.RuntimeFractionalPercentH\x00R\rfilterEnabled\x12Z\n" +
	"\x0eshadow_enabled\x18\n" +
	" \x01(\v23.solo.io.envoy.api.v2.core.RuntimeFractionalPercentR\rshadowEnabledB\x13\n" +
	"\x11enabled_specifier\"\xaf\x16\n" +
	"\vRouteAction\x12#\n" +
	"\acluster\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01H\x00R\acluster\x120\n" +
	"\x0ecluster_header\x18\x02 \x01(\tB\a\xfaB\x04r\x02 \x01H\x00R\rclusterHeader\x12Z\n" +
	"\x11weighted_clusters\x18\x03 \x01(\v2+.solo.io.envoy.api.v2.route.WeightedClusterH\x00R\x10weightedClusters\x12\x93\x01\n" +
	"\x1fcluster_not_found_response_code\x18\x14 \x01(\x0e2C.solo.io.envoy.api.v2.route.RouteAction.ClusterNotFoundResponseCodeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x1bclusterNotFoundResponseCode\x12J\n" +
	"\x0emetadata_match\x18\x04 \x01(\v2#.solo.io.envoy.api.v2.core.MetadataR\rmetadataMatch\x12%\n" +
	"\x0eprefix_rewrite\x18\x05 \x01(\tR\rprefixRewrite\x12#\n" +
	"\fhost_rewrite\x18\x06 \x01(\tH\x01R\vhostRewrite\x12H\n" +
	"\x11auto_host_rewrite\x18\a \x01(\v2\x1a.google.protobuf.BoolValueH\x01R\x0fautoHostRewrite\x129\n" +
	"\x18auto_host_rewrite_header\x18\x1d \x01(\tH\x01R\x15autoHostRewriteHeader\x123\n" +
	"\atimeout\x18\b \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12<\n" +
	"\fidle_timeout\x18\x18 \x01(\v2\x19.google.protobuf.DurationR\vidleTimeout\x12J\n" +
	"\fretry_policy\x18\t \x01(\v2'.solo.io.envoy.api.v2.route.RetryPolicyR\vretryPolicy\x12o\n" +
	"\x15request_mirror_policy\x18\n" +
	" \x01(\v2;.solo.io.envoy.api.v2.route.RouteAction.RequestMirrorPolicyR\x13requestMirrorPolicy\x12F\n" +
	"\bpriority\x18\v \x01(\x0e2*.solo.io.envoy.api.v2.core.RoutingPriorityR\bpriority\x12F\n" +
	"\vrate_limits\x18\r \x03(\v2%.solo.io.envoy.api.v2.route.RateLimitR\n" +
	"rateLimits\x12O\n" +
	"\x16include_vh_rate_limits\x18\x0e \x01(\v2\x1a.google.protobuf.BoolValueR\x13includeVhRateLimits\x12S\n" +
	"\vhash_policy\x18\x0f \x03(\v22.solo.io.envoy.api.v2.route.RouteAction.HashPolicyR\n" +
	"hashPolicy\x12:\n" +
	"\x04cors\x18\x11 \x01(\v2&.solo.io.envoy.api.v2.route.CorsPolicyR\x04cors\x12C\n" +
	"\x10max_grpc_timeout\x18\x17 \x01(\v2\x19.google.protobuf.DurationR\x0emaxGrpcTimeout\x12I\n" +
	"\x13grpc_timeout_offset\x18\x1c \x01(\v2\x19.google.protobuf.DurationR\x11grpcTimeoutOffset\x12^\n" +
	"\x0fupgrade_configs\x18\x19 \x03(\v25.solo.io.envoy.api.v2.route.RouteAction.UpgradeConfigR\x0eupgradeConfigs\x12x\n" +
	"\x18internal_redirect_action\x18\x1a \x01(\x0e2>.solo.io.envoy.api.v2.route.RouteAction.InternalRedirectActionR\x16internalRedirectAction\x12J\n" +
	"\fhedge_policy\x18\x1b \x01(\v2'.solo.io.envoy.api.v2.route.HedgePolicyR\vhedgePolicy\x1a\xbd\x01\n" +
	"\x13RequestMirrorPolicy\x12!\n" +
	"\acluster\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\acluster\x12#\n" +
	"\vruntime_key\x18\x02 \x01(\tB\x02\x18\x01R\n" +
	"runtimeKey\x12^\n" +
	"\x10runtime_fraction\x18\x03 \x01(\v23.solo.io.envoy.api.v2.core.RuntimeFractionalPercentR\x0fruntimeFraction\x1a\xbc\x04\n" +
	"\n" +
	"HashPolicy\x12S\n" +
	"\x06header\x18\x01 \x01(\v29.solo.io.envoy.api.v2.route.RouteAction.HashPolicy.HeaderH\x00R\x06header\x12S\n" +
	"\x06cookie\x18\x02 \x01(\v29.solo.io.envoy.api.v2.route.RouteAction.HashPolicy.CookieH\x00R\x06cookie\x12~\n" +
	"\x15connection_properties\x18\x03 \x01(\v2G.solo.io.envoy.api.v2.route.RouteAction.HashPolicy.ConnectionPropertiesH\x00R\x14connectionProperties\x12\x1a\n" +
	"\bterminal\x18\x04 \x01(\bR\bterminal\x1a2\n" +
	"\x06Header\x12(\n" +
	"\vheader_name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\n" +
	"headerName\x1af\n" +
	"\x06Cookie\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12+\n" +
	...
	"\tsource_ip\x18\x01 \x01(\bR\bsourceIpB\x17\n" +
	"\x10policy_specifier\x12\x03\xf8B\x01\x1ah\n" +
	"\rUpgradeConfig\x12!\n" +
	"\fupgrade_type\x18\x01 \x01(\tR\vupgradeType\x124\n" +
	...
	"\x16host_rewrite_specifierJ\x04\b\f\x10\rJ\x04\b\x12\x10\x13J\x04\b\x13\x10\x14J\x04\b\x10\x10\x11J\x04\b\x16\x10\x17J\x04\b\x15\x10\x16\"\xd4\b\n" +
	"\vRetryPolicy\x12\x19\n" +
	"\bretry_on\x18\x01 \x01(\tR\aretryOn\x12=\n" +
	"\vnum_retries\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\n" +
	"numRetries\x12A\n" +
	"\x0fper_try_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\rperTryTimeout\x12\\\n" +
	"\x0eretry_priority\x18\x04 \x01(\v25.solo.io.envoy.api.v2.route.RetryPolicy.RetryPriorityR\rretryPriority\x12l\n" +
	"\x14retry_host_predicate\x18\x05 \x03(\v2:.solo.io.envoy.api.v2.route.RetryPolicy.RetryHostPredicateR\x12retryHostPredicate\x12H\n" +
	"!host_selection_retry_max_attempts\x18\x06 \x01(\x03R\x1dhostSelectionRetryMaxAttempts\x124\n" +
	"\x16retriable_status_codes\x18\a \x03(\rR\x14retriableStatusCodes\x12Z\n" +
	"\x0eretry_back_off\x18\b \x01(\v24.solo.io.envoy.api.v2.route.RetryPolicy.RetryBackOffR\fretryBackOff\x1a\xa9\x01\n" +
	...
	"\fmax_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\vmaxInterval\"\xfa\x01\n" +
	"\vHedgePolicy\x12P\n" +
	"\x10initial_requests\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x01R\x0finitialRequests\x12a\n" +
	"\x19additional_request_chance\x18\x02 \x01(\v2%.solo.io.envoy.type.FractionalPercentR\x17additionalRequestChance\x126\n" +
	"\x18hedge_on_per_try_timeout\x18\x03 \x01(\bR\x14hedgeOnPerTryTimeout\"\xbe\x04\n" +
	"\x0eRedirectAction\x12'\n" +
	"\x0ehttps_redirect\x18\x04 \x01(\bH\x00R\rhttpsRedirect\x12)\n" +
	"\x0fscheme_redirect\x18\a \x01(\tH\x00R\x0eschemeRedirect\x12#\n" +
	"\rhost_redirect\x18\x01 \x01(\tR\fhostRedirect\x12#\n" +
	"\rport_redirect\x18\b \x01(\rR\fportRedirect\x12%\n" +
	"\rpath_redirect\x18\x02 \x01(\tH\x01R\fpathRedirect\x12'\n" +
	"\x0eprefix_rewrite\x18\x05 \x01(\tH\x01R\rprefixRewrite\x12n\n" +
	"\rresponse_code\x18\x03 \x01(\x0e2?.solo.io.envoy.api.v2.route.RedirectAction.RedirectResponseCodeB\b\xfaB\x05\x82\x01\x02\x10\x01R\fresponseCode\x12\x1f\n" +
	...
	"\x16path_rewrite_specifier\"u\n" +
	"\x14DirectResponseAction\x12\"\n" +
	"\x06status\x18\x01 \x01(\rB\n" +
	"\xfaB\a*\x05\x10\xd8\x04(dR\x06status\x129\n" +
	"\x04body\x18\x02 \x01(\v2%.solo.io.envoy.api.v2.core.DataSourceR\x04body\"2\n" +
	"\tDecorator\x12%\n" +
	"\toperation\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\toperation\"\xfb\x01\n" +
	"\aTracing\x12N\n" +
	"\x0fclient_sampling\x18\x01 \x01(\v2%.solo.io.envoy.type.FractionalPercentR\x0eclientSampling\x12N\n" +
	"\x0frandom_sampling\x18\x02 \x01(\v2%.solo.io.envoy.type.FractionalPercentR\x0erandomSampling\x12P\n" +
	"\x10overall_sampling\x18\x03 \x01(\v2%.solo.io.envoy.type.FractionalPercentR\x0foverallSampling\"\x95\x01\n" +
	"\x0eVirtualCluster\x12$\n" +
	"\apattern\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05 \x01(\x80\bR\apattern\x12\x1b\n" +
	"\x04name\x18\x02 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12@\n" +
	"\x06method\x18\x03 \x01(\x0e2(.solo.io.envoy.api.v2.core.RequestMethodR\x06method\"\x8d\n" +
	"\n" +
	"\tRateLimit\x12;\n" +
	...
	"disableKey\x12P\n" +
	"\aactions\x18\x03 \x03(\v2,.solo.io.envoy.api.v2.route.RateLimit.ActionB\b\xfaB\x05\x92\x01\x02\b\x01R\aactions\x1a\xcf\b\n" +
	"\x06Action\x12c\n" +
	"\x0esource_cluster\x18\x01 \x01(\v2:.solo.io.envoy.api.v2.route.RateLimit.Action.SourceClusterH\x00R\rsourceCluster\x12r\n" +
	"\x13destination_cluster\x18\x02 \x01(\v2?.solo.io.envoy.api.v2.route.RateLimit.Action.DestinationClusterH\x00R\x12destinationCluster\x12f\n" +
	"\x0frequest_headers\x18\x03 \x01(\v2;.solo.io.envoy.api.v2.route.RateLimit.Action.RequestHeadersH\x00R\x0erequestHeaders\x12c\n" +
	"\x0eremote_address\x18\x04 \x01(\v2:.solo.io.envoy.api.v2.route.RateLimit.Action.RemoteAddressH\x00R\rremoteAddress\x12Z\n" +
	"\vgeneric_key\x18\x05 \x01(\v27.solo.io.envoy.api.v2.route.RateLimit.Action.GenericKeyH\x00R\n" +
	"genericKey\x12m\n" +
	"\x12header_value_match\x18\x06 \x01(\v2=.solo.io.envoy.api.v2.route.RateLimit.Action.HeaderValueMatchH\x00R\x10headerValueMatch\x1a\x0f\n" +
	"\rSourceCluster\x1a\x14\n" +
	"\x12DestinationCluster\x1aj\n" +
	...
	"\n" +
	"GenericKey\x122\n" +
	"\x10descriptor_value\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x0fdescriptorValue\x1a\xd4\x01\n" +
	"\x10HeaderValueMatch\x122\n" +
	"\x10descriptor_value\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x0fdescriptorValue\x12=\n" +
	"\fexpect_match\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\vexpectMatch\x12M\n" +
	"\aheaders\x18\x03 \x03(\v2).solo.io.envoy.api.v2.route.HeaderMatcherB\b\xfaB\x05\x92\x01\x02\b\x01R\aheadersB\x17\n" +
	"\x10action_specifier\x12\x03\xf8B\x01\"\x8b\x03\n" +
	"\rHeaderMatcher\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12!\n" +
	"\vexact_match\x18\x04 \x01(\tH\x00R\n" +
	"exactMatch\x12+\n" +
	"\vregex_match\x18\x05 \x01(\tB\b\xfaB\x05r\x03(\x80\bH\x00R\n" +
	"regexMatch\x12A\n" +
	"\vrange_match\x18\x06 \x01(\v2\x1e.solo.io.envoy.type.Int64RangeH\x00R\n" +
	"rangeMatch\x12%\n" +
	...
	"\x16header_match_specifierJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\"\x7f\n" +
	"\x15QueryParameterMatcher\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05 \x01(\x80\bR\x04name\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\x120\n" +
	"\x05regex\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\x05regexB\x92\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\n" +
	"(io.envoyproxy.solo.io.envoy.api.v2.routeB\n" +
	"RouteProtoP\x01ZIgithub.com/solo-io/gloo/projects/gloo/pkg/api/external/envoy/api/v2/route\x88\x01\x01b\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[1].OneofWrappers = []any{
		(*Route_Route)(nil),
		(*Route_Redirect)(nil),
		(*Route_DirectResponse)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[3].OneofWrappers = []any{
		(*RouteMatch_Prefix)(nil),
		(*RouteMatch_Path)(nil),
		(*RouteMatch_Regex)(nil),
		(*RouteMatch_ConnectMatcher_)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[4].OneofWrappers = []any{
		(*CorsPolicy_Enabled)(nil),
		(*CorsPolicy_FilterEnabled)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[8].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[14].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[26].OneofWrappers = []any{
		(*RouteAction_HashPolicy_Header_)(nil),
		(*RouteAction_HashPolicy_Cookie_)(nil),
		(*RouteAction_HashPolicy_ConnectionProperties_)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[31].OneofWrappers = []any{
		(*RetryPolicy_RetryPriority_Config)(nil),
		(*RetryPolicy_RetryPriority_TypedConfig)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[32].OneofWrappers = []any{
		(*RetryPolicy_RetryHostPredicate_Config)(nil),
		(*RetryPolicy_RetryHostPredicate_TypedConfig)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_msgTypes[34].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_api_v2_route_route_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   41,
			NumExtensions: 0,
			NumServices:   0,
