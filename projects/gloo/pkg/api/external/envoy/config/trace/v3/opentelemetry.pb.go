...
const file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_trace_v3_opentelemetry_proto_rawDesc = "" +
	...
	"\fcluster_name\x18\x02 \x01(\tH\x00R\vclusterName:1\x8a\xc8ގ\x04+\n" +
	")envoy.config.trace.v2.OpenTelemetryConfigB\x13\n" +
	"\x11collector_clusterB\xdb\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\x82\x8a\u05ed\x040\x12.envoy.extensions.tracers.opentelemetry.v4alpha\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
