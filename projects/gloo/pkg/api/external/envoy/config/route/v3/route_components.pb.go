...
//
// Deprecated: Marked as deprecated in github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/route/v3/route_components.proto.
...
type VirtualHost struct {
	...
	TypedPerFilterConfig map[string]*any1.Any `protobuf:"bytes,15,rep,name=typed_per_filter_config,json=typedPerFilterConfig,proto3" json:"typed_per_filter_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Route struct {
	...
	TypedPerFilterConfig map[string]*any1.Any `protobuf:"bytes,13,rep,name=typed_per_filter_config,json=typedPerFilterConfig,proto3" json:"typed_per_filter_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type WeightedCluster_ClusterWeight struct {
	...
	// specific; see the :ref:`HTTP filter documentation <config_http_filters>`
	// for if and how it is utilized.
	TypedPerFilterConfig map[string]*any1.Any `protobuf:"bytes,10,rep,name=typed_per_filter_config,json=typedPerFilterConfig,proto3" json:"typed_per_filter_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
const file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDesc = "" +
	"\n" +
	"_github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/route/v3/route_components.proto\x12\x1dsolo.io.envoy.config.route.v3\x1aRgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/base.proto\x1aWgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/extension.proto\x1a\\github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/proxy_protocol.proto\x1aTgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/matcher/v3/regex.proto\x1aUgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/matcher/v3/string.proto\x1aXgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/metadata/v3/metadata.proto\x1aYgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/tracing/v3/custom_tag.proto\x1aNgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/v3/percent.proto\x1aLgithub.com/solo-io/gloo/projects/gloo/api/external/envoy/type/v3/range.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\x1a\x12extproto/ext.proto\"\x99\r\n" +
	"\vVirtualHost\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12,\n" +
	"\adomains\x18\x02 \x03(\tB\x12\xfaB\x0f\x92\x01\f\b\x01\"\br\x06\xc8\x01\x00\xc0\x01\x02R\adomains\x12<\n" +
	"\x06routes\x18\x03 \x03(\v2$.solo.io.envoy.config.route.v3.RouteR\x06routes\x12h\n" +
	"\vrequire_tls\x18\x04 \x01(\x0e2=.solo.io.envoy.config.route.v3.VirtualHost.TlsRequirementTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\n" +
	"requireTls\x12X\n" +
	"\x10virtual_clusters\x18\x05 \x03(\v2-.solo.io.envoy.config.route.v3.VirtualClusterR\x0fvirtualClusters\x12I\n" +
	"\vrate_limits\x18\x06 \x03(\v2(.solo.io.envoy.config.route.v3.RateLimitR\n" +
	"rateLimits\x12o\n" +
	"\x16request_headers_to_add\x18\a \x03(\v2/.solo.io.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x13requestHeadersToAdd\x12M\n" +
	"\x19request_headers_to_remove\x18\r \x03(\tB\x12\xfaB\x0f\x92\x01\f\"\n" +
	"r\b \x01\xc8\x01\x00\xc0\x01\x01R\x16requestHeadersToRemove\x12q\n" +
	"\x17response_headers_to_add\x18\n" +
	" \x03(\v2/.solo.io.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAdd\x12;\n" +
	"\x1aresponse_headers_to_remove\x18\v \x03(\tR\x17responseHeadersToRemove\x12=\n" +
	"\x04cors\x18\b \x01(\v2).solo.io.envoy.config.route.v3.CorsPolicyR\x04cors\x12{\n" +
	"\x17typed_per_filter_config\x18\x0f \x03(\v2D.solo.io.envoy.config.route.v3.VirtualHost.TypedPerFilterConfigEntryR\x14typedPerFilterConfig\x12A\n" +
	"\x1dinclude_request_attempt_count\x18\x0e \x01(\bR\x1aincludeRequestAttemptCount\x12H\n" +
	"!include_attempt_count_in_response\x18\x13 \x01(\bR\x1dincludeAttemptCountInResponse\x12M\n" +
	"\fretry_policy\x18\x10 \x01(\v2*.solo.io.envoy.config.route.v3.RetryPolicyR\vretryPolicy\x12O\n" +
	"\x19retry_policy_typed_config\x18\x14 \x01(\v2\x14.google.protobuf.AnyR\x16retryPolicyTypedConfig\x12M\n" +
	"\fhedge_policy\x18\x11 \x01(\v2*.solo.io.envoy.config.route.v3.HedgePolicyR\vhedgePolicy\x12`\n" +
	...
	"\x03ALL\x10\x02:.\x8a\xc8ގ\x04(\n" +
	"&solo.io.envoy.api.v2.route.VirtualHostJ\x04\b\t\x10\n" +
	"J\x04\b\f\x10\rR\x11per_filter_config\"m\n" +
	"\fFilterAction\x12,\n" +
	"\x06action\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\x06action:/\x8a\xc8ގ\x04)\n" +
	"'solo.io.envoy.api.v2.route.FilterAction\"\xf9\n" +
	"\n" +
	"\x05Route\x12\x12\n" +
	"\x04name\x18\x0e \x01(\tR\x04name\x12I\n" +
	"\x05match\x18\x01 \x01(\v2).solo.io.envoy.config.route.v3.RouteMatchB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05match\x12B\n" +
	"\x05route\x18\x02 \x01(\v2*.solo.io.envoy.config.route.v3.RouteActionH\x00R\x05route\x12K\n" +
	"\bredirect\x18\x03 \x01(\v2-.solo.io.envoy.config.route.v3.RedirectActionH\x00R\bredirect\x12^\n" +
	"\x0fdirect_response\x18\a \x01(\v23.solo.io.envoy.config.route.v3.DirectResponseActionH\x00R\x0edirectResponse\x12R\n" +
	"\rfilter_action\x18\x11 \x01(\v2+.solo.io.envoy.config.route.v3.FilterActionH\x00R\ffilterAction\x12B\n" +
	"\bmetadata\x18\x04 \x01(\v2&.solo.io.envoy.config.core.v3.MetadataR\bmetadata\x12F\n" +
	"\tdecorator\x18\x05 \x01(\v2(.solo.io.envoy.config.route.v3.DecoratorR\tdecorator\x12u\n" +
	"\x17typed_per_filter_config\x18\r \x03(\v2>.solo.io.envoy.config.route.v3.Route.TypedPerFilterConfigEntryR\x14typedPerFilterConfig\x12o\n" +
	"\x16request_headers_to_add\x18\t \x03(\v2/.solo.io.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x13requestHeadersToAdd\x12M\n" +
	"\x19request_headers_to_remove\x18\f \x03(\tB\x12\xfaB\x0f\x92\x01\f\"\n" +
	"r\b \x01\xc8\x01\x00\xc0\x01\x01R\x16requestHeadersToRemove\x12q\n" +
	"\x17response_headers_to_add\x18\n" +
	" \x03(\v2/.solo.io.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAdd\x12;\n" +
	"\x1aresponse_headers_to_remove\x18\v \x03(\tR\x17responseHeadersToRemove\x12@\n" +
	"\atracing\x18\x0f \x01(\v2&.solo.io.envoy.config.route.v3.TracingR\atracing\x12`\n" +
	"\x1eper_request_buffer_limit_bytes\x18\x10 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x1aperRequestBufferLimitBytes\x1a]\n" +
	"\x19TypedPerFilterConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01:(\x8a\xc8ގ\x04\"\n" +
	" solo.io.envoy.api.v2.route.RouteB\r\n" +
	"\x06action\x12\x03\xf8B\x01J\x04\b\x06\x10\aJ\x04\b\b\x10\tR\x11per_filter_config\"\x81\t\n" +
	"\x0fWeightedCluster\x12b\n" +
	"\bclusters\x18\x01 \x03(\v2<.solo.io.envoy.config.route.v3.WeightedCluster.ClusterWeightB\b\xfaB\x05\x92\x01\x02\b\x01R\bclusters\x12H\n" +
	"\ftotal_weight\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x01R\vtotalWeight\x12,\n" +
	"\x12runtime_key_prefix\x18\x02 \x01(\tR\x10runtimeKeyPrefix\x1a\xdd\x06\n" +
	"\rClusterWeight\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x124\n" +
	"\x06weight\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x06weight\x12M\n" +
	"\x0emetadata_match\x18\x03 \x01(\v2&.solo.io.envoy.config.core.v3.MetadataR\rmetadataMatch\x12o\n" +
	"\x16request_headers_to_add\x18\x04 \x03(\v2/.solo.io.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x13requestHeadersToAdd\x129\n" +
	"\x19request_headers_to_remove\x18\t \x03(\tR\x16requestHeadersToRemove\x12q\n" +
	"\x17response_headers_to_add\x18\x05 \x03(\v2/.solo.io.envoy.config.core.v3.HeaderValueOptionB\t\xfaB\x06\x92\x01\x03\x10\xe8\aR\x14responseHeadersToAdd\x12;\n" +
	"\x1aresponse_headers_to_remove\x18\x06 \x03(\tR\x17responseHeadersToRemove\x12\x8d\x01\n" +
	"\x17typed_per_filter_config\x18\n" +
	" \x03(\v2V.solo.io.envoy.config.route.v3.WeightedCluster.ClusterWeight.TypedPerFilterConfigEntryR\x14typedPerFilterConfig\x1a]\n" +
	"\x19TypedPerFilterConfigEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\x05value:\x028\x01:@\x8a\xc8ގ\x04:\n" +
	"8solo.io.envoy.api.v2.route.WeightedCluster.ClusterWeightJ\x04\b\a\x10\bJ\x04\b\b\x10\tR\x11per_filter_config:2\x8a\xc8ގ\x04,\n" +
	"*solo.io.envoy.api.v2.route.WeightedCluster\"\x9e\t\n" +
	"\n" +
	"RouteMatch\x12\x18\n" +
	"\x06prefix\x18\x01 \x01(\tH\x00R\x06prefix\x12\x14\n" +
	"\x04path\x18\x02 \x01(\tH\x00R\x04path\x12V\n" +
	"\n" +
	"safe_regex\x18\n" +
	" \x01(\v2+.solo.io.envoy.type.matcher.v3.RegexMatcherB\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\tsafeRegex\x12c\n" +
	"\x0fconnect_matcher\x18\f \x01(\v28.solo.io.envoy.config.route.v3.RouteMatch.ConnectMatcherH\x00R\x0econnectMatcher\x12A\n" +
	"\x0ecase_sensitive\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\rcaseSensitive\x12a\n" +
	"\x10runtime_fraction\x18\t \x01(\v26.solo.io.envoy.config.core.v3.RuntimeFractionalPercentR\x0fruntimeFraction\x12F\n" +
	"\aheaders\x18\x06 \x03(\v2,.solo.io.envoy.config.route.v3.HeaderMatcherR\aheaders\x12_\n" +
	"\x10query_parameters\x18\a \x03(\v24.solo.io.envoy.config.route.v3.QueryParameterMatcherR\x0fqueryParameters\x12S\n" +
	"\x04grpc\x18\b \x01(\v2?.solo.io.envoy.config.route.v3.RouteMatch.GrpcRouteMatchOptionsR\x04grpc\x12a\n" +
	"\vtls_context\x18\v \x01(\v2@.solo.io.envoy.config.route.v3.RouteMatch.TlsContextMatchOptionsR\n" +
	"tlsContext\x1a\\\n" +
	"\x15GrpcRouteMatchOptions:C\x8a\xc8ގ\x04=\n" +
	";solo.io.envoy.api.v2.route.RouteMatch.GrpcRouteMatchOptions\x1a\xd2\x01\n" +
	"\x16TlsContextMatchOptions\x128\n" +
	"\tpresented\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\tpresented\x128\n" +
	"\tvalidated\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\tvalidated:D\x8a\xc8ގ\x04>\n" +
	"<solo.io.envoy.api.v2.route.RouteMatch.TlsContextMatchOptions\x1a\x10\n" +
	"\x0eConnectMatcher:-\x8a\xc8ގ\x04'\n" +
	"%solo.io.envoy.api.v2.route.RouteMatchB\x15\n" +
	"\x0epath_specifier\x12\x03\xf8B\x01J\x04\b\x05\x10\x06J\x04\b\x03\x10\x04R\x05regex\"\x89\x05\n" +
	"\n" +
	"CorsPolicy\x12g\n" +
	"\x19allow_origin_string_match\x18\v \x03(\v2,.solo.io.envoy.type.matcher.v3.StringMatcherR\x16allowOriginStringMatch\x12#\n" +
	...
	"\x11allow_credentials\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\x10allowCredentials\x12_\n" +
	"\x0efilter_enabled\x18\t \x01(\v26.solo.io.envoy.config.core.v3.RuntimeFractionalPercentH\x00R\rfilterEnabled\x12]\n" +
	"\x0eshadow_enabled\x18\n" +
	" \x01(\v26.solo.io.envoy.config.core.v3.RuntimeFractionalPercentR\rshadowEnabled:-\x8a\xc8ގ\x04'\n" +
	"%solo.io.envoy.api.v2.route.CorsPolicyB\x13\n" +
	"\x11enabled_specifierJ\x04\b\x01\x10\x02J\x04\b\b\x10\tJ\x04\b\a\x10\bR\fallow_originR\x12allow_origin_regexR\aenabled\"\xcb$\n" +
	"\vRouteAction\x12#\n" +
	"\acluster\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01H\x00R\acluster\x126\n" +
	"\x0ecluster_header\x18\x02 \x01(\tB\r\xfaB\n" +
	"r\b \x01\xc8\x01\x00\xc0\x01\x01H\x00R\rclusterHeader\x12]\n" +
	"\x11weighted_clusters\x18\x03 \x01(\v2..solo.io.envoy.config.route.v3.WeightedClusterH\x00R\x10weightedClusters\x12\x96\x01\n" +
	"\x1fcluster_not_found_response_code\x18\x14 \x01(\x0e2F.solo.io.envoy.config.route.v3.RouteAction.ClusterNotFoundResponseCodeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x1bclusterNotFoundResponseCode\x12M\n" +
	"\x0emetadata_match\x18\x04 \x01(\v2&.solo.io.envoy.config.core.v3.MetadataR\rmetadataMatch\x122\n" +
	"\x0eprefix_rewrite\x18\x05 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02R\rprefixRewrite\x12[\n" +
	"\rregex_rewrite\x18  \x01(\v26.solo.io.envoy.type.matcher.v3.RegexMatchAndSubstituteR\fregexRewrite\x12?\n" +
	...
	"\x13host_rewrite_header\x18\x1d \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x01H\x01R\x11hostRewriteHeader\x123\n" +
	"\atimeout\x18\b \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12<\n" +
	"\fidle_timeout\x18\x18 \x01(\v2\x19.google.protobuf.DurationR\vidleTimeout\x12M\n" +
	"\fretry_policy\x18\t \x01(\v2*.solo.io.envoy.config.route.v3.RetryPolicyR\vretryPolicy\x12O\n" +
	"\x19retry_policy_typed_config\x18! \x01(\v2\x14.google.protobuf.AnyR\x16retryPolicyTypedConfig\x12v\n" +
	"\x17request_mirror_policies\x18\x1e \x03(\v2>.solo.io.envoy.config.route.v3.RouteAction.RequestMirrorPolicyR\x15requestMirrorPolicies\x12S\n" +
	"\bpriority\x18\v \x01(\x0e2-.solo.io.envoy.config.core.v3.RoutingPriorityB\b\xfaB\x05\x82\x01\x02\x10\x01R\bpriority\x12I\n" +
	"\vrate_limits\x18\r \x03(\v2(.solo.io.envoy.config.route.v3.RateLimitR\n" +
	"rateLimits\x12O\n" +
	"\x16include_vh_rate_limits\x18\x0e \x01(\v2\x1a.google.protobuf.BoolValueR\x13includeVhRateLimits\x12V\n" +
	"\vhash_policy\x18\x0f \x03(\v25.solo.io.envoy.config.route.v3.RouteAction.HashPolicyR\n" +
	"hashPolicy\x12=\n" +
	"\x04cors\x18\x11 \x01(\v2).solo.io.envoy.config.route.v3.CorsPolicyR\x04cors\x12C\n" +
	"\x10max_grpc_timeout\x18\x17 \x01(\v2\x19.google.protobuf.DurationR\x0emaxGrpcTimeout\x12I\n" +
	"\x13grpc_timeout_offset\x18\x1c \x01(\v2\x19.google.protobuf.DurationR\x11grpcTimeoutOffset\x12a\n" +
	"\x0fupgrade_configs\x18\x19 \x03(\v28.solo.io.envoy.config.route.v3.RouteAction.UpgradeConfigR\x0eupgradeConfigs\x12o\n" +
	"\x18internal_redirect_policy\x18\" \x01(\v25.solo.io.envoy.config.route.v3.InternalRedirectPolicyR\x16internalRedirectPolicy\x12\x7f\n" +
	"\x18internal_redirect_action\x18\x1a \x01(\x0e2A.solo.io.envoy.config.route.v3.RouteAction.InternalRedirectActionB\x02\x18\x01R\x16internalRedirectAction\x12V\n" +
	"\x16max_internal_redirects\x18\x1f \x01(\v2\x1c.google.protobuf.UInt32ValueB\x02\x18\x01R\x14maxInternalRedirects\x12M\n" +
	"\fhedge_policy\x18\x1b \x01(\v2*.solo.io.envoy.config.route.v3.HedgePolicyR\vhedgePolicy\x1a\xb3\x02\n" +
	"\x13RequestMirrorPolicy\x12!\n" +
	"\acluster\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\acluster\x12a\n" +
	"\x10runtime_fraction\x18\x03 \x01(\v26.solo.io.envoy.config.core.v3.RuntimeFractionalPercentR\x0fruntimeFraction\x12?\n" +
	"\rtrace_sampled\x18\x04 \x01(\v2\x1a.google.protobuf.BoolValueR\ftraceSampled:B\x8a\xc8ގ\x04<\n" +
	":solo.io.envoy.api.v2.route.RouteAction.RequestMirrorPolicyJ\x04\b\x02\x10\x03R\vruntime_key\x1a\xfe\n" +
	"\n" +
	"\n" +
	"HashPolicy\x12V\n" +
	"\x06header\x18\x01 \x01(\v2<.solo.io.envoy.config.route.v3.RouteAction.HashPolicy.HeaderH\x00R\x06header\x12V\n" +
	"\x06cookie\x18\x02 \x01(\v2<.solo.io.envoy.config.route.v3.RouteAction.HashPolicy.CookieH\x00R\x06cookie\x12\x81\x01\n" +
	"\x15connection_properties\x18\x03 \x01(\v2J.solo.io.envoy.config.route.v3.RouteAction.HashPolicy.ConnectionPropertiesH\x00R\x14connectionProperties\x12o\n" +
	"\x0fquery_parameter\x18\x05 \x01(\v2D.solo.io.envoy.config.route.v3.RouteAction.HashPolicy.QueryParameterH\x00R\x0equeryParameter\x12f\n" +
	"\ffilter_state\x18\x06 \x01(\v2A.solo.io.envoy.config.route.v3.RouteAction.HashPolicy.FilterStateH\x00R\vfilterState\x12\x1a\n" +
	"\bterminal\x18\x04 \x01(\bR\bterminal\x1a\xd7\x01\n" +
	"\x06Header\x12.\n" +
	"\vheader_name\x18\x01 \x01(\tB\r\xfaB\n" +
	"r\b \x01\xc8\x01\x00\xc0\x01\x01R\n" +
	"headerName\x12[\n" +
	"\rregex_rewrite\x18\x02 \x01(\v26.solo.io.envoy.type.matcher.v3.RegexMatchAndSubstituteR\fregexRewrite:@\x8a\xc8ގ\x04:\n" +
	"8solo.io.envoy.api.v2.route.RouteAction.HashPolicy.Header\x1a\xa8\x01\n" +
	"\x06Cookie\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12+\n" +
	"\x03ttl\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x03ttl\x12\x12\n" +
	"\x04path\x18\x03 \x01(\tR\x04path:@\x8a\xc8ގ\x04:\n" +
	"8solo.io.envoy.api.v2.route.RouteAction.HashPolicy.Cookie\x1a\x83\x01\n" +
	"\x14ConnectionProperties\x12\x1b\n" +
	"\tsource_ip\x18\x01 \x01(\bR\bsourceIp:N\x8a\xc8ގ\x04H\n" +
	"Fsolo.io.envoy.api.v2.route.RouteAction.HashPolicy.ConnectionProperties\x1aw\n" +
	"\x0eQueryParameter\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name:H\x8a\xc8ގ\x04B\n" +
	"@solo.io.envoy.api.v2.route.RouteAction.HashPolicy.QueryParameter\x1ao\n" +
	"\vFilterState\x12\x19\n" +
	"\x03key\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x03key:E\x8a\xc8ގ\x04?\n" +
	"=solo.io.envoy.api.v2.route.RouteAction.HashPolicy.FilterState:9\x8a\xc8ގ\x043\n" +
	"1solo.io.envoy.api.v2.route.RouteAction.HashPolicyB\x17\n" +
	"\x10policy_specifier\x12\x03\xf8B\x01\x1a\x9a\x03\n" +
	"\rUpgradeConfig\x12.\n" +
	"\fupgrade_type\x18\x01 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02R\vupgradeType\x124\n" +
	"\aenabled\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\aenabled\x12m\n" +
	"\x0econnect_config\x18\x03 \x01(\v2F.solo.io.envoy.config.route.v3.RouteAction.UpgradeConfig.ConnectConfigR\rconnectConfig\x1av\n" +
	"\rConnectConfig\x12e\n" +
	"\x15proxy_protocol_config\x18\x01 \x01(\v21.solo.io.envoy.config.core.v3.ProxyProtocolConfigR\x13proxyProtocolConfig:<\x8a\xc8ގ\x046\n" +
	"4solo.io.envoy.api.v2.route.RouteAction.UpgradeConfig\"E\n" +
	...
	"\x18HANDLE_INTERNAL_REDIRECT\x10\x01\x1a\x02\x18\x01:.\x8a\xc8ގ\x04(\n" +
	"&solo.io.envoy.api.v2.route.RouteActionB\x18\n" +
	...
	"\x10\vR\x15request_mirror_policy\"\xdb\v\n" +
	...
	"\vmax_retriesR\n" +
	"numRetries\x12A\n" +
	"\x0fper_try_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\rperTryTimeout\x12_\n" +
	"\x0eretry_priority\x18\x04 \x01(\v28.solo.io.envoy.config.route.v3.RetryPolicy.RetryPriorityR\rretryPriority\x12o\n" +
	"\x14retry_host_predicate\x18\x05 \x03(\v2=.solo.io.envoy.config.route.v3.RetryPolicy.RetryHostPredicateR\x12retryHostPredicate\x12H\n" +
	"!host_selection_retry_max_attempts\x18\x06 \x01(\x03R\x1dhostSelectionRetryMaxAttempts\x124\n" +
	"\x16retriable_status_codes\x18\a \x03(\rR\x14retriableStatusCodes\x12]\n" +
	"\x0eretry_back_off\x18\b \x01(\v27.solo.io.envoy.config.route.v3.RetryPolicy.RetryBackOffR\fretryBackOff\x12Y\n" +
	"\x11retriable_headers\x18\t \x03(\v2,.solo.io.envoy.config.route.v3.HeaderMatcherR\x10retriableHeaders\x12h\n" +
	"\x19retriable_request_headers\x18\n" +
	" \x03(\v2,.solo.io.envoy.config.route.v3.HeaderMatcherR\x17retriableRequestHeaders\x1a\xc2\x01\n" +
	"\rRetryPriority\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x129\n" +
	"\ftyped_config\x18\x03 \x01(\v2\x14.google.protobuf.AnyH\x00R\vtypedConfig:<\x8a\xc8ގ\x046\n" +
	"4solo.io.envoy.api.v2.route.RetryPolicy.RetryPriorityB\r\n" +
	"\vconfig_typeJ\x04\b\x02\x10\x03R\x06config\x1a\xcc\x01\n" +
	"\x12RetryHostPredicate\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x129\n" +
	"\ftyped_config\x18\x03 \x01(\v2\x14.google.protobuf.AnyH\x00R\vtypedConfig:A\x8a\xc8ގ\x04;\n" +
	"9solo.io.envoy.api.v2.route.RetryPolicy.RetryHostPredicateB\r\n" +
	"\vconfig_typeJ\x04\b\x02\x10\x03R\x06config\x1a\xdf\x01\n" +
	"\fRetryBackOff\x12J\n" +
	"\rbase_interval\x18\x01 \x01(\v2\x19.google.protobuf.DurationB\n" +
	"\xfaB\a\xaa\x01\x04\b\x01*\x00R\fbaseInterval\x12F\n" +
	"\fmax_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\vmaxInterval:;\x8a\xc8ގ\x045\n" +
	"3solo.io.envoy.api.v2.route.RetryPolicy.RetryBackOff:.\x8a\xc8ގ\x04(\n" +
	"&solo.io.envoy.api.v2.route.RetryPolicy\"\xad\x02\n" +
	"\vHedgePolicy\x12P\n" +
	"\x10initial_requests\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x01R\x0finitialRequests\x12d\n" +
	"\x19additional_request_chance\x18\x02 \x01(\v2(.solo.io.envoy.type.v3.FractionalPercentR\x17additionalRequestChance\x126\n" +
	"\x18hedge_on_per_try_timeout\x18\x03 \x01(\bR\x14hedgeOnPerTryTimeout:.\x8a\xc8ގ\x04(\n" +
	"&solo.io.envoy.api.v2.route.HedgePolicy\"\x9b\x05\n" +
	...
	"\x0eprefix_rewrite\x18\x05 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02H\x01R\rprefixRewrite\x12q\n" +
	"\rresponse_code\x18\x03 \x01(\x0e2B.solo.io.envoy.config.route.v3.RedirectAction.RedirectResponseCodeB\b\xfaB\x05\x82\x01\x02\x10\x01R\fresponseCode\x12\x1f\n" +
	...
	"\x12PERMANENT_REDIRECT\x10\x04:1\x8a\xc8ގ\x04+\n" +
	")solo.io.envoy.api.v2.route.RedirectActionB\x1a\n" +
	"\x18scheme_rewrite_specifierB\x18\n" +
	"\x16path_rewrite_specifier\"\xb1\x01\n" +
	"\x14DirectResponseAction\x12\"\n" +
	"\x06status\x18\x01 \x01(\rB\n" +
	"\xfaB\a*\x05\x10\xd8\x04(dR\x06status\x12<\n" +
	"\x04body\x18\x02 \x01(\v2(.solo.io.envoy.config.core.v3.DataSourceR\x04body:7\x8a\xc8ގ\x041\n" +
	"/solo.io.envoy.api.v2.route.DirectResponseAction\"\x9a\x01\n" +
	"\tDecorator\x12%\n" +
	"\toperation\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\toperation\x128\n" +
	"\tpropagate\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\tpropagate:,\x8a\xc8ގ\x04&\n" +
	"$solo.io.envoy.api.v2.route.Decorator\"\xfb\x02\n" +
	"\aTracing\x12Q\n" +
	"\x0fclient_sampling\x18\x01 \x01(\v2(.solo.io.envoy.type.v3.FractionalPercentR\x0eclientSampling\x12Q\n" +
	"\x0frandom_sampling\x18\x02 \x01(\v2(.solo.io.envoy.type.v3.FractionalPercentR\x0erandomSampling\x12S\n" +
	"\x10overall_sampling\x18\x03 \x01(\v2(.solo.io.envoy.type.v3.FractionalPercentR\x0foverallSampling\x12I\n" +
	"\vcustom_tags\x18\x04 \x03(\v2(.solo.io.envoy.type.tracing.v3.CustomTagR\n" +
	"customTags:*\x8a\xc8ގ\x04$\n" +
	"\"solo.io.envoy.api.v2.route.Tracing\"\xc5\x01\n" +
	"\x0eVirtualCluster\x12F\n" +
	"\aheaders\x18\x04 \x03(\v2,.solo.io.envoy.config.route.v3.HeaderMatcherR\aheaders\x12\x1b\n" +
	"\x04name\x18\x02 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name:1\x8a\xc8ގ\x04+\n" +
	")solo.io.envoy.api.v2.route.VirtualClusterJ\x04\b\x01\x10\x02J\x04\b\x03\x10\x04R\apatternR\x06method\"\xa8\x13\n" +
	"\tRateLimit\x12;\n" +
	"\x05stage\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02\x18\n" +
	"R\x05stage\x12\x1f\n" +
	"\vdisable_key\x18\x02 \x01(\tR\n" +
	"disableKey\x12S\n" +
	"\aactions\x18\x03 \x03(\v2/.solo.io.envoy.config.route.v3.RateLimit.ActionB\b\xfaB\x05\x92\x01\x02\b\x01R\aactions\x12G\n" +
	"\x05limit\x18\x04 \x01(\v21.solo.io.envoy.config.route.v3.RateLimit.OverrideR\x05limit\x1a\xeb\x0e\n" +
	"\x06Action\x12f\n" +
	"\x0esource_cluster\x18\x01 \x01(\v2=.solo.io.envoy.config.route.v3.RateLimit.Action.SourceClusterH\x00R\rsourceCluster\x12u\n" +
	"\x13destination_cluster\x18\x02 \x01(\v2B.solo.io.envoy.config.route.v3.RateLimit.Action.DestinationClusterH\x00R\x12destinationCluster\x12i\n" +
	"\x0frequest_headers\x18\x03 \x01(\v2>.solo.io.envoy.config.route.v3.RateLimit.Action.RequestHeadersH\x00R\x0erequestHeaders\x12f\n" +
	"\x0eremote_address\x18\x04 \x01(\v2=.solo.io.envoy.config.route.v3.RateLimit.Action.RemoteAddressH\x00R\rremoteAddress\x12]\n" +
	"\vgeneric_key\x18\x05 \x01(\v2:.solo.io.envoy.config.route.v3.RateLimit.Action.GenericKeyH\x00R\n" +
	"genericKey\x12p\n" +
	"\x12header_value_match\x18\x06 \x01(\v2@.solo.io.envoy.config.route.v3.RateLimit.Action.HeaderValueMatchH\x00R\x10headerValueMatch\x12l\n" +
	"\x10dynamic_metadata\x18\a \x01(\v2?.solo.io.envoy.config.route.v3.RateLimit.Action.DynamicMetaDataH\x00R\x0fdynamicMetadata\x1aR\n" +
	"\rSourceCluster:A\x8a\xc8ގ\x04;\n" +
	"9solo.io.envoy.api.v2.route.RateLimit.Action.SourceCluster\x1a\\\n" +
	"\x12DestinationCluster:F\x8a\xc8ގ\x04@\n" +
	">solo.io.envoy.api.v2.route.RateLimit.Action.DestinationCluster\x1a\xda\x01\n" +
	"\x0eRequestHeaders\x12.\n" +
	"\vheader_name\x18\x01 \x01(\tB\r\xfaB\n" +
	"r\b \x01\xc8\x01\x00\xc0\x01\x01R\n" +
	"headerName\x12.\n" +
	"\x0edescriptor_key\x18\x02 \x01(\tB\a\xfaB\x04r\x02 \x01R\rdescriptorKey\x12$\n" +
	"\x0eskip_if_absent\x18\x03 \x01(\bR\fskipIfAbsent:B\x8a\xc8ގ\x04<\n" +
	":solo.io.envoy.api.v2.route.RateLimit.Action.RequestHeaders\x1aR\n" +
	"\rRemoteAddress:A\x8a\xc8ގ\x04;\n" +
	"9solo.io.envoy.api.v2.route.RateLimit.Action.RemoteAddress\x1a\x80\x01\n" +
	"\n" +
	"GenericKey\x122\n" +
	"\x10descriptor_value\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x0fdescriptorValue:>\x8a\xc8ގ\x048\n" +
	"6solo.io.envoy.api.v2.route.RateLimit.Action.GenericKey\x1a\x9d\x02\n" +
	"\x10HeaderValueMatch\x122\n" +
	"\x10descriptor_value\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x0fdescriptorValue\x12=\n" +
	"\fexpect_match\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\vexpectMatch\x12P\n" +
	"\aheaders\x18\x03 \x03(\v2,.solo.io.envoy.config.route.v3.HeaderMatcherB\b\xfaB\x05\x92\x01\x02\b\x01R\aheaders:D\x8a\xc8ގ\x04>\n" +
	"<solo.io.envoy.api.v2.route.RateLimit.Action.HeaderValueMatch\x1a\x9b\x01\n" +
	"\x0fDynamicMetaData\x12.\n" +
	"\x0edescriptor_key\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\rdescriptorKey\x12X\n" +
	"\fmetadata_key\x18\x02 \x01(\v2+.solo.io.envoy.type.metadata.v3.MetadataKeyB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vmetadataKey:3\x8a\xc8ގ\x04-\n" +
	"+solo.io.envoy.api.v2.route.RateLimit.ActionB\x17\n" +
	"\x10action_specifier\x12\x03\xf8B\x01\x1a\x82\x02\n" +
	"\bOverride\x12n\n" +
	"\x10dynamic_metadata\x18\x01 \x01(\v2A.solo.io.envoy.config.route.v3.RateLimit.Override.DynamicMetadataH\x00R\x0fdynamicMetadata\x1ak\n" +
	"\x0fDynamicMetadata\x12X\n" +
	"\fmetadata_key\x18\x01 \x01(\v2+.solo.io.envoy.type.metadata.v3.MetadataKeyB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vmetadataKeyB\x19\n" +
	"\x12override_specifier\x12\x03\xf8B\x01:,\x8a\xc8ގ\x04&\n" +
	"$solo.io.envoy.api.v2.route.RateLimit\"\x85\x04\n" +
	"\rHeaderMatcher\x12!\n" +
	"\x04name\x18\x01 \x01(\tB\r\xfaB\n" +
	"r\b \x01\xc8\x01\x00\xc0\x01\x01R\x04name\x12!\n" +
	"\vexact_match\x18\x04 \x01(\tH\x00R\n" +
	"exactMatch\x12W\n" +
	"\x10safe_regex_match\x18\v \x01(\v2+.solo.io.envoy.type.matcher.v3.RegexMatcherH\x00R\x0esafeRegexMatch\x12D\n" +
	"\vrange_match\x18\x06 \x01(\v2!.solo.io.envoy.type.v3.Int64RangeH\x00R\n" +
	"rangeMatch\x12%\n" +
	...
	"\finvert_match\x18\b \x01(\bR\vinvertMatch:0\x8a\xc8ގ\x04*\n" +
	"(solo.io.envoy.api.v2.route.HeaderMatcherB\x18\n" +
	"\x16header_match_specifierJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x05\x10\x06R\vregex_match\"\xb2\x02\n" +
	"\x15QueryParameterMatcher\x12\x1e\n" +
	"\x04name\x18\x01 \x01(\tB\n" +
	"\xfaB\ar\x05 \x01(\x80\bR\x04name\x12[\n" +
	"\fstring_match\x18\x05 \x01(\v2,.solo.io.envoy.type.matcher.v3.StringMatcherB\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\vstringMatch\x12%\n" +
	"\rpresent_match\x18\x06 \x01(\bH\x00R\fpresentMatch:8\x8a\xc8ގ\x042\n" +
	"0solo.io.envoy.api.v2.route.QueryParameterMatcherB!\n" +
	"\x1fquery_parameter_match_specifierJ\x04\b\x03\x10\x04J\x04\b\x04\x10\x05R\x05valueR\x05regex\"\xc1\x02\n" +
	...
	"\x17redirect_response_codes\x18\x02 \x03(\rB\b\xfaB\x05\x92\x01\x02\x10\x05R\x15redirectResponseCodes\x12R\n" +
	"\n" +
	"predicates\x18\x03 \x03(\v22.solo.io.envoy.config.core.v3.TypedExtensionConfigR\n" +
	"predicates\x12=\n" +
	"\x1ballow_cross_scheme_redirect\x18\x04 \x01(\bR\x18allowCrossSchemeRedirectB\xa7\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
	"+io.envoyproxy.solo.io.envoy.config.route.v3B\x14RouteComponentsProtoP\x01ZLgithub.com/solo-io/gloo/projects/gloo/pkg/api/external/envoy/config/route/v3b\x06proto3"
...
var (
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[2].OneofWrappers = []any{
		(*Route_Route)(nil),
		(*Route_Redirect)(nil),
		(*Route_DirectResponse)(nil),
		(*Route_FilterAction)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[4].OneofWrappers = []any{
		(*RouteMatch_Prefix)(nil),
		(*RouteMatch_Path)(nil),
		(*RouteMatch_SafeRegex)(nil),
		(*RouteMatch_ConnectMatcher_)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[5].OneofWrappers = []any{
		(*CorsPolicy_FilterEnabled)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[6].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[9].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[15].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[16].OneofWrappers = []any{
		(*QueryParameterMatcher_StringMatch)(nil),
		(*QueryParameterMatcher_PresentMatch)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[26].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[34].OneofWrappers = []any{
		(*RetryPolicy_RetryPriority_TypedConfig)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[35].OneofWrappers = []any{
		(*RetryPolicy_RetryHostPredicate_TypedConfig)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[37].OneofWrappers = []any{
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_msgTypes[38].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   47,
			NumExtensions: 0,
			NumServices:   0,
