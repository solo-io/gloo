...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x9d, 0x01, 0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5, 0x04, 0x01, 0xd0, 0xf5, 0x04, 0x01,
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Pipe); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_proto_msgTypes[5].Exporter = func(v any, i int) any {
