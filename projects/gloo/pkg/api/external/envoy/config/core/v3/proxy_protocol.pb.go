...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_proxy_protocol_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_proxy_protocol_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_proxy_protocol_proto_msgTypes[1].Exporter = func(v any, i int) any {
