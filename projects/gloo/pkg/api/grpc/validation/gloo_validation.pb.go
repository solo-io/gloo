...
const file_github_com_solo_io_gloo_projects_gloo_api_grpc_validation_gloo_validation_proto_rawDesc = "" +
	...
	"\x14listener_type_report\"\xa6\x02\n" +
	"\x12HttpListenerReport\x12>\n" +
	"\x06errors\x18\x01 \x03(\v2&.gloo.solo.io.HttpListenerReport.ErrorR\x06errors\x12Q\n" +
	"\x14virtual_host_reports\x18\x02 \x03(\v2\x1f.gloo.solo.io.VirtualHostReportR\x12virtualHostReports\x1a}\n" +
	"\x05Error\x12?\n" +
	...
	"\x04Type\x12\x13\n" +
	"\x0fProcessingError\x10\x00\"\xda\x02\n" +
	"\x11VirtualHostReport\x12=\n" +
	"\x06errors\x18\x01 \x03(\v2%.gloo.solo.io.VirtualHostReport.ErrorR\x06errors\x12>\n" +
	"\rroute_reports\x18\x02 \x03(\v2\x19.gloo.solo.io.RouteReportR\frouteReports\x1a\xc5\x01\n" +
	"\x05Error\x12>\n" +
	...
	"\x10EmptyDomainError\x10\x03\"\x9e\x03\n" +
	"\vRouteReport\x127\n" +
	"\x06errors\x18\x01 \x03(\v2\x1f.gloo.solo.io.RouteReport.ErrorR\x06errors\x12=\n" +
	"\bwarnings\x18\x02 \x03(\v2!.gloo.solo.io.RouteReport.WarningR\bwarnings\x1a\x8f\x01\n" +
	"\x05Error\x128\n" +
	...
	"\x04Type\x12\x1d\n" +
	"\x19InvalidDestinationWarning\x10\x00\"\xe0\x02\n" +
	"\x11TcpListenerReport\x12=\n" +
	"\x06errors\x18\x01 \x03(\v2%.gloo.solo.io.TcpListenerReport.ErrorR\x06errors\x12E\n" +
	"\x10tcp_host_reports\x18\x02 \x03(\v2\x1b.gloo.solo.io.TcpHostReportR\x0etcpHostReports\x1a\xc4\x01\n" +
	"\x05Error\x12>\n" +
	...
	"\x16BindPortNotUniqueError\x10\x01\x12\x12\n" +
	"\x0eSSLConfigError\x10\x02\x12\x13\n" +
	"\x0fProcessingError\x10\x03\"\xdc\x03\n" +
	"\rTcpHostReport\x129\n" +
