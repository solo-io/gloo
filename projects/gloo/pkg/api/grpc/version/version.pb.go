...
func (x *Status) GetOk() *Status_OkStatus {
...
func (x *Status) GetError() *Status_ErrorStatus {
...
type Status_Ok struct {
	Ok *Status_OkStatus `protobuf:"bytes,1,opt,name=ok,proto3,oneof"`
}

type Status_Error struct {
	Error *Status_ErrorStatus `protobuf:"bytes,2,opt,name=error,proto3,oneof"`
}
...
func (*Version) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_rawDescGZIP(), []int{5}
}
...
func (x *Kubernetes_Container) Reset() {
	*x = Kubernetes_Container{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type Status_OkStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *Status_OkStatus) Reset() {
	*x = Status_OkStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Status_OkStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Status_OkStatus) ProtoMessage() {}

func (x *Status_OkStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Status_OkStatus.ProtoReflect.Descriptor instead.
func (*Status_OkStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_rawDescGZIP(), []int{4, 0}
}

type Status_ErrorStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Status_ErrorStatus) Reset() {
	*x = Status_ErrorStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Status_ErrorStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Status_ErrorStatus) ProtoMessage() {}

func (x *Status_ErrorStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Status_ErrorStatus.ProtoReflect.Descriptor instead.
func (*Status_ErrorStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_rawDescGZIP(), []int{4, 1}
}

func (x *Status_ErrorStatus) GetWarnings() []string {
	if x != nil {
		return x.Warnings
	}
	return nil
...
func (x *Status_ErrorStatus) GetErrors() []string {
	if x != nil {
		return x.Errors
	}
	return nil
...
var file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x61, 0x70, 0x69, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
...
var file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_goTypes = []interface{}{
	...
	(*Status)(nil),                   // 5: gloo.solo.io.Status
	(*Version)(nil),                  // 6: gloo.solo.io.Version
	(*Kubernetes_Container)(nil),     // 7: gloo.solo.io.Kubernetes.Container
	(*Status_OkStatus)(nil),          // 8: gloo.solo.io.Status.OkStatus
	(*Status_ErrorStatus)(nil),       // 9: gloo.solo.io.Status.ErrorStatus
}
var file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_depIdxs = []int32{
	...
	7, // 2: gloo.solo.io.Kubernetes.containers:type_name -> gloo.solo.io.Kubernetes.Container
	8, // 3: gloo.solo.io.Status.ok:type_name -> gloo.solo.io.Status.OkStatus
	9, // 4: gloo.solo.io.Status.error:type_name -> gloo.solo.io.Status.ErrorStatus
	3, // 5: gloo.solo.io.Version.client:type_name -> gloo.solo.io.ClientVersion
	1, // 6: gloo.solo.io.Version.server:type_name -> gloo.solo.io.ServerVersion
	4, // 7: gloo.solo.io.Version.kubernetes_cluster:type_name -> gloo.solo.io.KubernetesClusterVersion
	5, // 8: gloo.solo.io.Version.status:type_name -> gloo.solo.io.Status
...
func file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status_OkStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Status_ErrorStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_gloo_projects_gloo_api_grpc_version_version_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*Status_Ok)(nil),
		(*Status_Error)(nil),
	}
	type x struct{}
