...
func (m *Status) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/grpc/version.Status")); err != nil {
		return 0, err
	}
	...
	case *Status_Ok:
		...
		if h, ok := interface{}(m.GetOk()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("Ok")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetOk(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("Ok")); err != nil {
					return 0, err
	...
	case *Status_Error:
		...
		if h, ok := interface{}(m.GetError()).(safe_hasher.SafeHasher); ok {
			...
			if fieldValue, err := hashstructure.Hash(m.GetError(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("Error")); err != nil {
					return 0, err
...
// Hash function
func (m *Status_OkStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/grpc/version.Status_OkStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *Status_ErrorStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/grpc/version.Status_ErrorStatus")); err != nil {
		return 0, err
	}
