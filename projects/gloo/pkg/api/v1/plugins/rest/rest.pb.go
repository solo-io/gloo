...
import transformation_plugins_gloo_solo_io1 "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/transformation"
...
type ServiceSpec struct {
	Transformations map[string]*transformation_plugins_gloo_solo_io.TransformationTemplate `protobuf:"bytes,1,rep,name=transformations" json:"transformations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *ServiceSpec) GetTransformations() map[string]*transformation_plugins_gloo_solo_io.TransformationTemplate {
	if m != nil {
...
type DestinationSpec struct {
	...
	Parameters             *transformation_plugins_gloo_solo_io1.Parameters            `protobuf:"bytes,2,opt,name=parameters" json:"parameters,omitempty"`
	ResponseTransformation *transformation_plugins_gloo_solo_io.TransformationTemplate `protobuf:"bytes,3,opt,name=response_transformation,json=responseTransformation" json:"response_transformation,omitempty"`
}
...
func (m *DestinationSpec) GetParameters() *transformation_plugins_gloo_solo_io1.Parameters {
	if m != nil {
		return m.Parameters
	}
	return nil
...
func (m *DestinationSpec) GetResponseTransformation() *transformation_plugins_gloo_solo_io.TransformationTemplate {
	if m != nil {
...
var fileDescriptorRest = []byte{
	...
	,
}
