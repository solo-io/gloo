...
func (*UpstreamSpec) Descriptor() ([]byte, []int) { return fileDescriptorKubernetes, []int{0} }
...
func init() { proto.RegisterFile("kubernetes/kubernetes.proto", fileDescriptorKubernetes) }

var fileDescriptorKubernetes = []byte{
