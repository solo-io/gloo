...
func (*ExtAuthConfig_OAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f58f3ab230e4111, []int{15, 0}
}
...
func (*ExtAuthConfig_ApiKeyAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f58f3ab230e4111, []int{15, 1}
}
...
func (*ExtAuthConfig_OpaAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f58f3ab230e4111, []int{15, 2}
}
...
func (*ExtAuthConfig_AuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_2f58f3ab230e4111, []int{15, 3}
}
...
var fileDescriptor_2f58f3ab230e4111 = []byte{
	...
	,
}
