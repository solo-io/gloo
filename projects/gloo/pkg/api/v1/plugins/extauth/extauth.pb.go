...
package extauth // import "github.com/solo-io/solo-projects/projects/gloo/pkg/api/v1/plugins/extauth"
...
func (*Settings) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{0}
}
...
type Settings_ExtauthzServerRef struct {
	ExtauthzServerRef *core.ResourceRef `protobuf:"bytes,1,opt,name=extauthz_server_ref,json=extauthzServerRef,oneof"`
}
...
type BasicAuth struct {
	...
	Apr                  *BasicAuth_Apr `protobuf:"bytes,2,opt,name=apr" json:"apr,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (*BasicAuth) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{1}
}
...
type BasicAuth_Apr struct {
	Users                map[string]*BasicAuth_Apr_SaltedHashedPassword `protobuf:"bytes,2,rep,name=users" json:"users,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                                       `json:"-"`
	XXX_unrecognized     []byte                                         `json:"-"`
	XXX_sizecache        int32                                          `json:"-"`
}
...
func (*BasicAuth_Apr) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{1, 0}
}
...
func (dst *BasicAuth_Apr) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BasicAuth_Apr.Merge(dst, src)
}
...
func (*BasicAuth_Apr_SaltedHashedPassword) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{1, 0, 0}
}
...
func (dst *BasicAuth_Apr_SaltedHashedPassword) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BasicAuth_Apr_SaltedHashedPassword.Merge(dst, src)
}
...
type OAuth struct {
	...
	ClientSecretRef *core.ResourceRef `protobuf:"bytes,2,opt,name=client_secret_ref,json=clientSecretRef" json:"client_secret_ref,omitempty"`
...
func (*OAuth) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{2}
}
...
func (*OauthSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{3}
}
...
func (dst *OauthSecret) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OauthSecret.Merge(dst, src)
}
...
func (*VhostExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{4}
}
...
func (dst *VhostExtension) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VhostExtension.Merge(dst, src)
}
...
type VhostExtension_BasicAuth struct {
	BasicAuth *BasicAuth `protobuf:"bytes,1,opt,name=basic_auth,json=basicAuth,oneof"`
}
type VhostExtension_Oauth struct {
	Oauth *OAuth `protobuf:"bytes,2,opt,name=oauth,oneof"`
}
...
func (*RouteExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{5}
}
...
func (dst *RouteExtension) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RouteExtension.Merge(dst, src)
}
...
func (*ExtAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{6}
}
...
func (dst *ExtAuthConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExtAuthConfig.Merge(dst, src)
}
...
type ExtAuthConfig_Oauth struct {
	Oauth *ExtAuthConfig_OAuthConfig `protobuf:"bytes,3,opt,name=oauth,oneof"`
}
type ExtAuthConfig_BasicAuth struct {
	BasicAuth *BasicAuth `protobuf:"bytes,4,opt,name=basic_auth,json=basicAuth,oneof"`
}
...
func (*ExtAuthConfig_OAuthConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_extauth_e0614a61098a4341, []int{6, 0}
}
...
func (dst *ExtAuthConfig_OAuthConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ExtAuthConfig_OAuthConfig.Merge(dst, src)
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/solo-projects/projects/gloo/api/v1/plugins/extauth/extauth.proto", fileDescriptor_extauth_e0614a61098a4341)
}

var fileDescriptor_extauth_e0614a61098a4341 = []byte{
