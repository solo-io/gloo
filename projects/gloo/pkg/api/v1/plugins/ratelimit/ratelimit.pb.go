...
package ratelimit // import "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/ratelimit"
...
func (*UserRateLimit) Descriptor() ([]byte, []int) {
	return fileDescriptor_ratelimit_2b7207b1bd97a3f0, []int{1}
}
func (m *UserRateLimit) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_UserRateLimit.Unmarshal(m, b)
}
...
func (dst *UserRateLimit) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserRateLimit.Merge(dst, src)
}
func (m *UserRateLimit) XXX_Size() int {
	return xxx_messageInfo_UserRateLimit.Size(m)
}
...
func (*Constraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_ratelimit_2b7207b1bd97a3f0, []int{2}
}
...
func (*RateLimitConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_ratelimit_2b7207b1bd97a3f0, []int{3}
}
...
func (*IngressRateLimitConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_ratelimit_2b7207b1bd97a3f0, []int{4}
}
func (m *IngressRateLimitConfig) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_IngressRateLimitConfig.Unmarshal(m, b)
}
func (m *IngressRateLimitConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_IngressRateLimitConfig.Marshal(b, m, deterministic)
}
func (dst *IngressRateLimitConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IngressRateLimitConfig.Merge(dst, src)
}
func (m *IngressRateLimitConfig) XXX_Size() int {
	return xxx_messageInfo_IngressRateLimitConfig.Size(m)
}
func (m *IngressRateLimitConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_IngressRateLimitConfig.DiscardUnknown(m)
}

var xxx_messageInfo_IngressRateLimitConfig proto.InternalMessageInfo
...
var fileDescriptor_ratelimit_2b7207b1bd97a3f0 = []byte{
