...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_proxy_proto_rawDesc = "" +
	...
	"\ftcp_listener\x18\x02 \x01(\v2\x19.gloo.solo.io.TcpListenerR\vtcpListener\"\xd8\x01\n" +
	"\aMatcher\x126\n" +
	"\n" +
	...
	"\aoptions\x18\x03 \x01(\v2(.gloo.solo.io.WeightedDestinationOptionsR\aoptions\"\x97\x04\n" +
