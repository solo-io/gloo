...
func (RedirectAction_RedirectResponseCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorProxy, []int{12, 0}
}
...
func (m *Proxy) GetStatus() core_solo_io2.Status {
	if m != nil {
		return m.Status
	}
...
func (*Matcher) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{5} }
...
func (*HeaderMatcher) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{6} }
...
func (*QueryParameterMatcher) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{7} }
...
func (*RouteAction) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{8} }
...
type Destination struct {
	...
	Upstream core_solo_io1.ResourceRef `protobuf:"bytes,1,opt,name=upstream" json:"upstream"`
...
func (*Destination) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{9} }

func (m *Destination) GetUpstream() core_solo_io1.ResourceRef {
	if m != nil {
		return m.Upstream
	}
	return core_solo_io1.ResourceRef{}
}
...
func (*MultiDestination) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{10} }
...
func (*WeightedDestination) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{11} }
...
func (*RedirectAction) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{12} }
...
func (*DirectResponseAction) Descriptor() ([]byte, []int) { return fileDescriptorProxy, []int{13} }
...
type SslConfig_SecretRef struct {
	SecretRef *core_solo_io1.ResourceRef `protobuf:"bytes,1,opt,name=secret_ref,json=secretRef,oneof"`
}
...
func (m *SslConfig) GetSecretRef() *core_solo_io1.ResourceRef {
...
func _SslConfig_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // ssl_secrets.secret_ref
		...
		msg := new(core_solo_io1.ResourceRef)
		err := b.DecodeMessage(msg)
