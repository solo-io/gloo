...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_transformation_transformation_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_transformation_transformation_proto_goTypes = []any{
	...
	(*TransformationTemplate_SpanTransformer)(nil),      // 18: transformation.options.gloo.solo.io.TransformationTemplate.SpanTransformer
	(*matchers.HeaderMatcher)(nil),                      // 19: matchers.core.gloo.solo.io.HeaderMatcher
	(*matchers.Matcher)(nil),                            // 20: matchers.core.gloo.solo.io.Matcher
	(*wrappers.BoolValue)(nil),                          // 21: google.protobuf.BoolValue
	(*xslt.XsltTransformation)(nil),                     // 22: envoy.config.transformer.xslt.v2.XsltTransformation
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_transformation_transformation_proto_depIdxs = []int32{
	19, // 0: transformation.options.gloo.solo.io.ResponseMatch.matchers:type_name -> matchers.core.gloo.solo.io.HeaderMatcher
	...
	20, // 2: transformation.options.gloo.solo.io.RequestMatch.matcher:type_name -> matchers.core.gloo.solo.io.Matcher
	...
	21, // 12: transformation.options.gloo.solo.io.TransformationStages.log_request_response_info:type_name -> google.protobuf.BoolValue
	21, // 13: transformation.options.gloo.solo.io.TransformationStages.escape_characters:type_name -> google.protobuf.BoolValue
	...
	13, // 15: transformation.options.gloo.solo.io.Transformation.header_body_transform:type_name -> transformation.options.gloo.solo.io.HeaderBodyTransform
	22, // 16: transformation.options.gloo.solo.io.Transformation.xslt_transformation:type_name -> envoy.config.transformer.xslt.v2.XsltTransformation
	23, // 17: transformation.options.gloo.solo.io.Extraction.body:type_name -> google.protobuf.Empty
	24, // 18: transformation.options.gloo.solo.io.Extraction.replacement_text:type_name -> google.protobuf.StringValue
	0,  // 19: transformation.options.gloo.solo.io.Extraction.mode:type_name -> transformation.options.gloo.solo.io.Extraction.Mode
	14, // 20: transformation.options.gloo.solo.io.TransformationTemplate.extractors:type_name -> transformation.options.gloo.solo.io.TransformationTemplate.ExtractorsEntry
	15, // 21: transformation.options.gloo.solo.io.TransformationTemplate.headers:type_name -> transformation.options.gloo.solo.io.TransformationTemplate.HeadersEntry
	16, // 22: transformation.options.gloo.solo.io.TransformationTemplate.headers_to_append:type_name -> transformation.options.gloo.solo.io.TransformationTemplate.HeaderToAppend
	...
	17, // 27: transformation.options.gloo.solo.io.TransformationTemplate.dynamic_metadata_values:type_name -> transformation.options.gloo.solo.io.TransformationTemplate.DynamicMetadataValue
	21, // 28: transformation.options.gloo.solo.io.TransformationTemplate.escape_characters:type_name -> google.protobuf.BoolValue
	18, // 29: transformation.options.gloo.solo.io.TransformationTemplate.span_transformer:type_name -> transformation.options.gloo.solo.io.TransformationTemplate.SpanTransformer
	8,  // 30: transformation.options.gloo.solo.io.TransformationTemplate.ExtractorsEntry.value:type_name -> transformation.options.gloo.solo.io.Extraction
	10, // 31: transformation.options.gloo.solo.io.TransformationTemplate.HeadersEntry.value:type_name -> transformation.options.gloo.solo.io.InjaTemplate
	10, // 32: transformation.options.gloo.solo.io.TransformationTemplate.HeaderToAppend.value:type_name -> transformation.options.gloo.solo.io.InjaTemplate
	10, // 33: transformation.options.gloo.solo.io.TransformationTemplate.DynamicMetadataValue.value:type_name -> transformation.options.gloo.solo.io.InjaTemplate
	10, // 34: transformation.options.gloo.solo.io.TransformationTemplate.SpanTransformer.name:type_name -> transformation.options.gloo.solo.io.InjaTemplate
