...
func (x *TagFilter) GetSpec() isTagFilter_Spec {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *TagFilter) GetKey() string {
	if x != nil {
		if x, ok := x.Spec.(*TagFilter_Key); ok {
			return x.Key
		}
	}
	return ""
...
func (x *TagFilter) GetKvPair() *TagFilter_KvPair {
	if x != nil {
		if x, ok := x.Spec.(*TagFilter_KvPair_); ok {
			return x.KvPair
		}
	}
	return nil
...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDesc = "" +
	"\n" +
	"Jgithub.com/solo-io/gloo/projects/gloo/api/v1/options/aws/ec2/aws_ec2.proto\x12\x1caws_ec2.options.gloo.solo.io\x1a\x12extproto/ext.proto\x1a,github.com/solo-io/solo-kit/api/v1/ref.proto\"\xef\x01\n" +
	"\fUpstreamSpec\x12\x16\n" +
	"\x06region\x18\x01 \x01(\tR\x06region\x128\n" +
	"\n" +
	"secret_ref\x18\x02 \x01(\v2\x19.core.solo.io.ResourceRefR\tsecretRef\x12\x19\n" +
	"\brole_arn\x18\a \x01(\tR\aroleArn\x12A\n" +
	"\afilters\x18\x03 \x03(\v2'.aws_ec2.options.gloo.solo.io.TagFilterR\afilters\x12\x1b\n" +
	"\tpublic_ip\x18\x04 \x01(\bR\bpublicIp\x12\x12\n" +
	"\x04port\x18\x05 \x01(\rR\x04port\"\xa4\x01\n" +
	"\tTagFilter\x12\x12\n" +
	"\x03key\x18\x01 \x01(\tH\x00R\x03key\x12I\n" +
	"\akv_pair\x18\x02 \x01(\v2..aws_ec2.options.gloo.solo.io.TagFilter.KvPairH\x00R\x06kvPair\x1a0\n" +
	"\x06KvPair\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05valueB\x06\n" +
	"\x04specBN\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z@github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/aws/ec2b\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDesc)))
	})
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_aws_ec2_aws_ec2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
