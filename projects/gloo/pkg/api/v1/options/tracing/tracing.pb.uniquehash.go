...
func (m *ListenerTracingSettings) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	if _, err = hasher.Write([]byte("RequestHeadersForTags")); err != nil {
		return 0, err
	}
	for i, v := range m.GetRequestHeadersForTags() {
	...
	if _, err = hasher.Write([]byte("EnvironmentVariablesForTags")); err != nil {
		return 0, err
	}
	for i, v := range m.GetEnvironmentVariablesForTags() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
	...
	if _, err = hasher.Write([]byte("LiteralsForTags")); err != nil {
		return 0, err
	}
	for i, v := range m.GetLiteralsForTags() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
...
func (m *RouteTracingSettings) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	if _, err = hasher.Write([]byte("RouteDescriptor")); err != nil {
		return 0, err
	}
