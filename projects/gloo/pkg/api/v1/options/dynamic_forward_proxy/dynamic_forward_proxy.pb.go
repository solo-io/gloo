...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_options_dynamic_forward_proxy_dynamic_forward_proxy_proto_rawDesc = "" +
	...
	"\n" +
	"ssl_config\x18\x03 \x01(\v2\x1f.gloo.solo.io.UpstreamSslConfigR\tsslConfig\x12M\n" +
	"\x10circuit_breakers\x18\x04 \x01(\v2\".gloo.solo.io.CircuitBreakerConfigR\x0fcircuitBreakers\"i\n" +
