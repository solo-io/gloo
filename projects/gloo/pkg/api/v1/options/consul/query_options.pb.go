...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDesc = "" +
	"\n" +
	"Ogithub.com/solo-io/gloo/projects/gloo/api/v1/options/consul/query_options.proto\x12\x1bconsul.options.gloo.solo.io\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x12extproto/ext.proto\"G\n" +
	"\fQueryOptions\x127\n" +
	"\tuse_cache\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\buseCache*L\n" +
	"\x16ConsulConsistencyModes\x12\x0f\n" +
	"\vDefaultMode\x10\x00\x12\r\n" +
	"\tStaleMode\x10\x01\x12\x12\n" +
	"\x0eConsistentMode\x10\x02BM\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z?github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/consulb\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_consul_query_options_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
