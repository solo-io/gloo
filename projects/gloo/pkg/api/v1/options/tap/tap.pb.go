...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_tap_tap_proto_rawDesc = "" +
	"\n" +
	"Mgithub.com/solo-io/gloo/projects/gloo/api/v1/enterprise/options/tap/tap.proto\x12\x18tap.options.gloo.solo.io\x1a,github.com/solo-io/solo-kit/api/v1/ref.proto\x1a\x17validate/validate.proto\x1a\x1egoogle/protobuf/duration.proto\"G\n" +
	"\x03Tap\x12@\n" +
	"\x05sinks\x18\x01 \x03(\v2\x1e.tap.options.gloo.solo.io.SinkB\n" +
	"\xfaB\a\x92\x01\x04\b\x01\x10\x01R\x05sinks\"\xaf\x01\n" +
	"\x04Sink\x12J\n" +
