...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_options_static_static_proto_rawDesc = "" +
	"\n" +
	"Hgithub.com/solo-io/gloo/projects/gloo/api/v1/options/static/static.proto\x12\x1bstatic.options.gloo.solo.io\x1a\x12extproto/ext.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1aGgithub.com/solo-io/gloo/projects/gloo/api/v1/options/service_spec.proto\x1a\x17validate/validate.proto\"\x88\x02\n" +
	"\fUpstreamSpec\x127\n" +
	...
	"\x10auto_sni_rewrite\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\x0eautoSniRewrite\"\xca\x02\n" +
	"\x04Host\x12\x12\n" +
	...
	"\x13health_check_config\x18\x03 \x01(\v23.static.options.gloo.solo.io.Host.HealthCheckConfigR\x11healthCheckConfig\x1a?\n" +
	"\x11HealthCheckConfig\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x16\n" +
	"\x06method\x18\x02 \x01(\tR\x06methodBM\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z?github.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/staticb\x06proto3"
