...
func (x *GrpcJsonTranscoder) GetProtoDescriptorConfigMap() *GrpcJsonTranscoder_DescriptorConfigMap {
	if x != nil {
		if x, ok := x.DescriptorSet.(*GrpcJsonTranscoder_ProtoDescriptorConfigMap); ok {
...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDesc = "" +
	"\n" +
	"Ngithub.com/solo-io/gloo/projects/gloo/api/v1/options/grpc_json/grpc_json.proto\x12\x1egrpc_json.options.gloo.solo.io\x1a,github.com/solo-io/solo-kit/api/v1/ref.proto\x1a\x12extproto/ext.proto\x1a\x17validate/validate.proto\"\x95\b\n" +
	"\x12GrpcJsonTranscoder\x12+\n" +
	"\x10proto_descriptor\x18\x01 \x01(\tH\x00R\x0fprotoDescriptor\x122\n" +
	"\x14proto_descriptor_bin\x18\x04 \x01(\fH\x00R\x12protoDescriptorBin\x12\x87\x01\n" +
	"\x1bproto_descriptor_config_map\x18\n" +
	" \x01(\v2F.grpc_json.options.gloo.solo.io.GrpcJsonTranscoder.DescriptorConfigMapH\x00R\x18protoDescriptorConfigMap\x12$\n" +
	"\bservices\x18\x02 \x03(\tB\b\xfaB\x05\x92\x01\x02\b\x01R\bservices\x12d\n" +
	"\rprint_options\x18\x03 \x01(\v2?.grpc_json.options.gloo.solo.io.GrpcJsonTranscoder.PrintOptionsR\fprintOptions\x12?\n" +
	...
	"\x1apreserve_proto_field_names\x18\x04 \x01(\bR\x17preserveProtoFieldNames\x1ah\n" +
	"\x13DescriptorConfigMap\x12?\n" +
	"\x0econfig_map_ref\x18\x01 \x01(\v2\x19.core.solo.io.ResourceRefR\fconfigMapRef\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03keyB\x15\n" +
	"\x0edescriptor_set\x12\x03\xf8B\x01BP\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZBgithub.com/solo-io/gloo/projects/gloo/pkg/api/v1/options/grpc_jsonb\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDesc)))
	})
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
