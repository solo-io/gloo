...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_options_retries_retries_proto_rawDesc = "" +
	...
	"\fmax_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\vmaxInterval\"\xc4\x03\n" +
	...
	"\x13previous_priorities\x18\x05 \x01(\v2<.retries.options.gloo.solo.io.RetryPolicy.PreviousPrioritiesH\x00R\x12previousPriorities\x1a]\n" +
