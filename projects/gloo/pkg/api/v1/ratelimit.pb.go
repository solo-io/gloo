...
type Constraint struct {
	...
	RateLimit   *ratelimit_plugins_gloo_solo_io.RateLimit `protobuf:"bytes,3,opt,name=rate_limit,json=rateLimit" json:"rate_limit,omitempty"`
...
func (m *Constraint) GetRateLimit() *ratelimit_plugins_gloo_solo_io.RateLimit {
	if m != nil {
		return m.RateLimit
	}
	return nil
