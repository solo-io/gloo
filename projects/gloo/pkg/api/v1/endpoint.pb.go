...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDesc = "" +
	"\n" +
	";github.com/solo-io/gloo/projects/gloo/api/v1/endpoint.proto\x12\fgloo.solo.io\x1a\x12extproto/ext.proto\x1a1github.com/solo-io/solo-kit/api/v1/metadata.proto\x1a,github.com/solo-io/solo-kit/api/v1/ref.proto\x1a1github.com/solo-io/solo-kit/api/v1/solo-kit.proto\"\x9c\x02\n" +
	"\bEndpoint\x127\n" +
	"\tupstreams\x18\x01 \x03(\v2\x19.core.solo.io.ResourceRefR\tupstreams\x12\x18\n" +
	"\aaddress\x18\x02 \x01(\tR\aaddress\x12\x12\n" +
	"\x04port\x18\x03 \x01(\rR\x04port\x12\x1a\n" +
	"\bhostname\x18\x04 \x01(\tR\bhostname\x12B\n" +
	"\fhealth_check\x18\x05 \x01(\v2\x1f.gloo.solo.io.HealthCheckConfigR\vhealthCheck\x122\n" +
	"\bmetadata\x18\a \x01(\v2\x16.core.solo.io.MetadataR\bmetadata:\x15\x82\xf1\x04\x11\n" +
	"\x02ep\x12\tendpoints(\x01\"/\n" +
	"\x11HealthCheckConfig\x12\x1a\n" +
	"\bhostname\x18\x01 \x01(\tR\bhostnameB>\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z0github.com/solo-io/gloo/projects/gloo/pkg/api/v1b\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_endpoint_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
