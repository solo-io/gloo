...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_failover_proto_rawDesc = "" +
	"\n" +
	";github.com/solo-io/gloo/projects/gloo/api/v1/failover.proto\x12\fgloo.solo.io\x1a\x12extproto/ext.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a:github.com/solo-io/gloo/projects/gloo/api/v1/ssl/ssl.proto\x1a\x17validate/validate.proto\"\xf7\x02\n" +
	"\bFailover\x12a\n" +
	...
	"\x15load_balancing_weight\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x13loadBalancingWeight\"\xbe\x03\n" +
	"\n" +
	"LbEndpoint\x12\x18\n" +
	...
	"\x15load_balancing_weight\x18\x05 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x01R\x13loadBalancingWeight\x1az\n" +
	...
	"\x06method\x18\x04 \x01(\tR\x06method\"Q\n" +
	"\bLocality\x12\x16\n" +
