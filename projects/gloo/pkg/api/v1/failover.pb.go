...
type LbEndpoint struct {
	...
	Metadata      map[string]*_struct.Struct `protobuf:"bytes,6,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LbEndpoint) GetMetadata() map[string]*_struct.Struct {
	if x != nil {
		return x.Metadata
	}
	return nil
