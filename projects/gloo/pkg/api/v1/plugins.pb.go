...
import aws "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/aws"
import azure "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/azure"
import faultinjection "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/faultinjection"
import grpc1 "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/grpc"
import kubernetes "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/kubernetes"
import rest "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/rest"
import static "github.com/solo-io/solo-kit/projects/gloo/pkg/api/v1/plugins/static"
...
func (*ListenerPlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_a1308951090156d5, []int{0}
}
...
func (*VirtualHostPlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_a1308951090156d5, []int{1}
}
...
type RoutePlugins struct {
	...
	Abort                *faultinjection.RouteAbort           `protobuf:"bytes,2,opt,name=abort" json:"abort,omitempty"`
	Delay                *faultinjection.RouteDelay           `protobuf:"bytes,3,opt,name=delay" json:"delay,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                             `json:"-"`
	XXX_unrecognized     []byte                               `json:"-"`
	XXX_sizecache        int32                                `json:"-"`
}
...
func (*RoutePlugins) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_a1308951090156d5, []int{2}
}
...
func (m *RoutePlugins) GetAbort() *faultinjection.RouteAbort {
	if m != nil {
		return m.Abort
	}
	return nil
...
func (m *RoutePlugins) GetDelay() *faultinjection.RouteDelay {
	if m != nil {
		return m.Delay
	}
	return nil
...
func (*DestinationSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_a1308951090156d5, []int{3}
}
...
func (*UpstreamSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_plugins_a1308951090156d5, []int{4}
}
...
func init() { proto.RegisterFile("plugins.proto", fileDescriptor_plugins_a1308951090156d5) }

var fileDescriptor_plugins_a1308951090156d5 = []byte{
	// 519 bytes of a gzipped FileDescriptorProto
	,
}
