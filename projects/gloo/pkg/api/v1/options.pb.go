...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_options_proto_msgTypes[11].Exporter = func(v any, i int) any {
