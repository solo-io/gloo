...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_subset_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x3e, 0xb8, 0xf5,
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_subset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_subset_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Subset); i {
			case 0:
				return &v.state
			case 1:
