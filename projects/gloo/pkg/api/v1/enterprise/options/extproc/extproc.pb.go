...
func (x *RouteSettings) GetOverride() isRouteSettings_Override {
	if x != nil {
		return x.Override
	}
	return nil
...
func (x *RouteSettings) GetDisabled() *wrapperspb.BoolValue {
	if x != nil {
		if x, ok := x.Override.(*RouteSettings_Disabled); ok {
			return x.Disabled
		}
	}
	return nil
...
func (x *RouteSettings) GetOverrides() *Overrides {
	if x != nil {
		if x, ok := x.Override.(*RouteSettings_Overrides); ok {
			return x.Overrides
		}
	}
	return nil
...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDesc = "" +
	...
	"\ffilter_stage\x18\x02 \x01(\v2!.filters.gloo.solo.io.FilterStageR\vfilterStage\x12H\n" +
	"\x12failure_mode_allow\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x10failureModeAllow\x12j\n" +
	"\x0fprocessing_mode\x18\x04 \x01(\v2A.solo.io.envoy.extensions.filters.http.ext_proc.v3.ProcessingModeR\x0eprocessingMode\x129\n" +
	"\n" +
	"async_mode\x18\x05 \x01(\v2\x1a.google.protobuf.BoolValueR\tasyncMode\x12-\n" +
	"\x12request_attributes\x18\x06 \x03(\tR\x11requestAttributes\x12/\n" +
	"\x13response_attributes\x18\a \x03(\tR\x12responseAttributes\x12Q\n" +
	"\x0fmessage_timeout\x18\b \x01(\v2\x19.google.protobuf.DurationB\r\xfaB\n" +
	"\xaa\x01\a\"\x03\b\x90\x1c2\x00R\x0emessageTimeout\x12=\n" +
	"\vstat_prefix\x18\t \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"statPrefix\x12i\n" +
	"\x0emutation_rules\x18\n" +
	" \x01(\v2B.solo.io.envoy.config.common.mutation_rules.v3.HeaderMutationRulesR\rmutationRules\x12X\n" +
	"\x13max_message_timeout\x18\v \x01(\v2\x19.google.protobuf.DurationB\r\xfaB\n" +
	"\xaa\x01\a\"\x03\b\x90\x1c2\x00R\x11maxMessageTimeout\x12U\n" +
	"\x19disable_clear_route_cache\x18\f \x01(\v2\x1a.google.protobuf.BoolValueR\x16disableClearRouteCache\x12X\n" +
	"\rforward_rules\x18\r \x01(\v23.extproc.options.gloo.solo.io.HeaderForwardingRulesR\fforwardRules\x12@\n" +
	...
	"\boverride\"\xec\x02\n" +
	"\vGrpcService\x12H\n" +
	"\x13ext_proc_server_ref\x18\x01 \x01(\v2\x19.core.solo.io.ResourceRefR\x10extProcServerRef\x12:\n" +
	"\tauthority\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\tauthority\x12L\n" +
	"\fretry_policy\x18\x03 \x01(\v2).solo.io.envoy.config.core.v3.RetryPolicyR\vretryPolicy\x123\n" +
	"\atimeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12T\n" +
	"\x10initial_metadata\x18\x05 \x03(\v2).solo.io.envoy.config.core.v3.HeaderValueR\x0finitialMetadata\"\xeb\x03\n" +
	"\tOverrides\x12j\n" +
	"\x0fprocessing_mode\x18\x01 \x01(\v2A.solo.io.envoy.extensions.filters.http.ext_proc.v3.ProcessingModeR\x0eprocessingMode\x129\n" +
	"\n" +
	"async_mode\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\tasyncMode\x12-\n" +
	"\x12request_attributes\x18\x03 \x03(\tR\x11requestAttributes\x12/\n" +
	"\x13response_attributes\x18\x04 \x03(\tR\x12responseAttributes\x12L\n" +
	"\fgrpc_service\x18\x05 \x01(\v2).extproc.options.gloo.solo.io.GrpcServiceR\vgrpcService\x12>\n" +
	"\x1bmetadata_context_namespaces\x18\x06 \x03(\tR\x19metadataContextNamespaces\x12I\n" +
	"!typed_metadata_context_namespaces\x18\a \x03(\tR\x1etypedMetadataContextNamespaces\"\xd3\x01\n" +
	"\x15HeaderForwardingRules\x12Y\n" +
	"\x0fallowed_headers\x18\x01 \x01(\v20.solo.io.envoy.type.matcher.v3.ListStringMatcherR\x0eallowedHeaders\x12_\n" +
	"\x12disallowed_headers\x18\x02 \x01(\v20.solo.io.envoy.type.matcher.v3.ListStringMatcherR\x11disallowedHeadersBY\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZKgithub.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extprocb\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_extproc_extproc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
