...
func (*Embedding_OpenAI) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDescGZIP(), []int{4, 0}
}
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_rawDesc = []byte{
	...
	,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_goTypes = []interface{}{
	...
	(*RouteSettings)(nil),               // 3: ai.options.gloo.solo.io.RouteSettings
	(*FieldDefault)(nil),                // 4: ai.options.gloo.solo.io.FieldDefault
	(*Postgres)(nil),                    // 5: ai.options.gloo.solo.io.Postgres
	(*Embedding)(nil),                   // 6: ai.options.gloo.solo.io.Embedding
	(*SemanticCache)(nil),               // 7: ai.options.gloo.solo.io.SemanticCache
	(*RAG)(nil),                         // 8: ai.options.gloo.solo.io.RAG
	(*RateLimiting)(nil),                // 9: ai.options.gloo.solo.io.RateLimiting
	(*AIPromptEnrichment)(nil),          // 10: ai.options.gloo.solo.io.AIPromptEnrichment
	(*AIPromptGaurd)(nil),               // 11: ai.options.gloo.solo.io.AIPromptGaurd
	(*UpstreamSpec_OpenAI)(nil),         // 12: ai.options.gloo.solo.io.UpstreamSpec.OpenAI
	(*UpstreamSpec_Mistral)(nil),        // 13: ai.options.gloo.solo.io.UpstreamSpec.Mistral
	(*UpstreamSpec_Anthropic)(nil),      // 14: ai.options.gloo.solo.io.UpstreamSpec.Anthropic
	(*UpstreamSpec_Custom)(nil),         // 15: ai.options.gloo.solo.io.UpstreamSpec.Custom
	(*Embedding_OpenAI)(nil),            // 16: ai.options.gloo.solo.io.Embedding.OpenAI
	(*SemanticCache_Redis)(nil),         // 17: ai.options.gloo.solo.io.SemanticCache.Redis
	(*SemanticCache_DataStore)(nil),     // 18: ai.options.gloo.solo.io.SemanticCache.DataStore
	(*RAG_DataStore)(nil),               // 19: ai.options.gloo.solo.io.RAG.DataStore
	(*AIPromptEnrichment_Message)(nil),  // 20: ai.options.gloo.solo.io.AIPromptEnrichment.Message
	(*AIPromptGaurd_Request)(nil),       // 21: ai.options.gloo.solo.io.AIPromptGaurd.Request
	(*AIPromptGaurd_Response)(nil),      // 22: ai.options.gloo.solo.io.AIPromptGaurd.Response
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_depIdxs = []int32{
	12, // 0: ai.options.gloo.solo.io.UpstreamSpec.openai:type_name -> ai.options.gloo.solo.io.UpstreamSpec.OpenAI
	13, // 1: ai.options.gloo.solo.io.UpstreamSpec.mistral:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Mistral
	14, // 2: ai.options.gloo.solo.io.UpstreamSpec.anthropic:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Anthropic
	15, // 3: ai.options.gloo.solo.io.UpstreamSpec.custom:type_name -> ai.options.gloo.solo.io.UpstreamSpec.Custom
	10, // 4: ai.options.gloo.solo.io.RouteSettings.prompt_enrichment:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment
	11, // 5: ai.options.gloo.solo.io.RouteSettings.prompt_guard:type_name -> ai.options.gloo.solo.io.AIPromptGaurd
	9,  // 6: ai.options.gloo.solo.io.RouteSettings.rate_limiting:type_name -> ai.options.gloo.solo.io.RateLimiting
	8,  // 7: ai.options.gloo.solo.io.RouteSettings.rag:type_name -> ai.options.gloo.solo.io.RAG
	7,  // 8: ai.options.gloo.solo.io.RouteSettings.semantic_cache:type_name -> ai.options.gloo.solo.io.SemanticCache
	4,  // 9: ai.options.gloo.solo.io.RouteSettings.defaults:type_name -> ai.options.gloo.solo.io.FieldDefault
	23, // 10: ai.options.gloo.solo.io.FieldDefault.value:type_name -> google.protobuf.Value
	16, // 11: ai.options.gloo.solo.io.Embedding.openai:type_name -> ai.options.gloo.solo.io.Embedding.OpenAI
	18, // 12: ai.options.gloo.solo.io.SemanticCache.datastore:type_name -> ai.options.gloo.solo.io.SemanticCache.DataStore
	6,  // 13: ai.options.gloo.solo.io.SemanticCache.embedding:type_name -> ai.options.gloo.solo.io.Embedding
	19, // 14: ai.options.gloo.solo.io.RAG.datastore:type_name -> ai.options.gloo.solo.io.RAG.DataStore
	6,  // 15: ai.options.gloo.solo.io.RAG.embedding:type_name -> ai.options.gloo.solo.io.Embedding
	20, // 16: ai.options.gloo.solo.io.AIPromptEnrichment.prepend:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment.Message
	20, // 17: ai.options.gloo.solo.io.AIPromptEnrichment.append:type_name -> ai.options.gloo.solo.io.AIPromptEnrichment.Message
	21, // 18: ai.options.gloo.solo.io.AIPromptGaurd.request:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Request
	22, // 19: ai.options.gloo.solo.io.AIPromptGaurd.response:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Response
	17, // 20: ai.options.gloo.solo.io.SemanticCache.DataStore.redis:type_name -> ai.options.gloo.solo.io.SemanticCache.Redis
	5,  // 21: ai.options.gloo.solo.io.RAG.DataStore.postgres:type_name -> ai.options.gloo.solo.io.Postgres
	0,  // 22: ai.options.gloo.solo.io.AIPromptGaurd.Request.builtins:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Request.BuiltIn
	1,  // 23: ai.options.gloo.solo.io.AIPromptGaurd.Response.builtins:type_name -> ai.options.gloo.solo.io.AIPromptGaurd.Response.BuiltIn
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ai_ai_proto_msgTypes[4].OneofWrappers = []interface{}{
