...
readonly ROOT_PKG=github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/graphql/v1beta1
...
do
    PROJECT_INPUT_DIRS_SPACE+="${APIS_PKG}/graphql.gloo.solo.io/v1beta1 "
    PROJECT_INPUT_DIRS_COMMA+="${APIS_PKG}/graphql.gloo.solo.io/v1beta1,"
done
