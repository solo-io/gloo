...
// Hash function
func (m *GatewaySchema_SubschemaConfig) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("graphql.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/graphql/v1alpha1.GatewaySchema_SubschemaConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetTypeMerge()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("TypeMerge")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetTypeMerge(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("TypeMerge")); err != nil {
				return 0, err
...
// Hash function
func (m *GatewaySchema_SubschemaConfig_TypeMergeConfig) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("graphql.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/graphql/v1alpha1.GatewaySchema_SubschemaConfig_TypeMergeConfig")); err != nil {
		return 0, err
	}
