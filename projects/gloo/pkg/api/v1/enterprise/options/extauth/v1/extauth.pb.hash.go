...
func (m *ApiKeyAuth) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetHmac()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("Hmac")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetHmac(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("Hmac")); err != nil {
				return 0, err
...
// of the field name in the hash calculation can lead to hash collisions.
// Prefer the HashUnique function instead.
func (m *ApiKeyHmac) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.ApiKeyHmac")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetSharedSecretRef()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("SharedSecretRef")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetSharedSecretRef(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("SharedSecretRef")); err != nil {
				return 0, err
...
// of the field name in the hash calculation can lead to hash collisions.
// Prefer the HashUnique function instead.
func (m *ApiKeyDigest) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.ApiKeyDigest")); err != nil {
		return 0, err
	}
...
// of the field name in the hash calculation can lead to hash collisions.
// Prefer the HashUnique function instead.
func (m *ApiKeyMatch) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.ApiKeyMatch")); err != nil {
		return 0, err
	}
...
func (m *HeaderMatch) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.HeaderMatch")); err != nil {
		return 0, err
	}
...
// of the field name in the hash calculation can lead to hash collisions.
// Prefer the HashUnique function instead.
func (m *PassThroughHttpTLSConfig) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// of the field name in the hash calculation can lead to hash collisions.
// Prefer the HashUnique function instead.
func (m *PassThroughHttp_ConnectionPool) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1.PassThroughHttp_ConnectionPool")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetMaxConnsPerHost())
	if err != nil {
		return 0, err
	}
