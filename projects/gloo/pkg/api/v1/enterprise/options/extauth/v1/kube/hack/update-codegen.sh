...
readonly ROOT_PKG=github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/options/extauth/v1
...
do
    PROJECT_INPUT_DIRS_SPACE+="${APIS_PKG}/enterprise.gloo.solo.io/v1 "
    PROJECT_INPUT_DIRS_COMMA+="${APIS_PKG}/enterprise.gloo.solo.io/v1,"
done
