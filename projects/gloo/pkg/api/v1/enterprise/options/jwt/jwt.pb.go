...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_jwt_jwt_proto_rawDesc = "" +
	...
	"\x0eafter_ext_auth\x18\x02 \x01(\v2(.jwt.options.gloo.solo.io.RouteExtensionR\fafterExtAuth\"\x87\x02\n" +
	"\x0eVhostExtension\x12U\n" +
	"\tproviders\x18\x04 \x03(\v27.jwt.options.gloo.solo.io.VhostExtension.ProvidersEntryR\tproviders\x12<\n" +
	"\x1ballow_missing_or_failed_jwt\x18\x02 \x01(\bR\x17allowMissingOrFailedJwt\x1a`\n" +
	"\x0eProvidersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x128\n" +
	"\x05value\x18\x02 \x01(\v2\".jwt.options.gloo.solo.io.ProviderR\x05value:\x028\x01\"*\n" +
