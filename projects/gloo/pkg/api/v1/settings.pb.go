...
import (
	...
	ratelimit1 "github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/plugins/ratelimit"
	rbac "github.com/solo-io/gloo/projects/gloo/pkg/api/v1/enterprise/plugins/rbac"
	ratelimit "github.com/solo-io/gloo/projects/gloo/pkg/api/v2/enterprise/plugins/ratelimit"
...
type Settings struct {
	...
	Ratelimit *ratelimit.EnvoySettings `protobuf:"bytes,26,opt,name=ratelimit,proto3" json:"ratelimit,omitempty"`
	// Enterprise-only: Settings for the rate limiting server itself
	RatelimitServer *ratelimit1.Settings `protobuf:"bytes,27,opt,name=ratelimit_server,json=ratelimitServer,proto3" json:"ratelimit_server,omitempty"`
...
func (m *Settings) GetRatelimit() *ratelimit.EnvoySettings {
	if m != nil {
		return m.Ratelimit
	}
	return nil
...
func (m *Settings) GetRatelimitServer() *ratelimit1.Settings {
	if m != nil {
...
var fileDescriptor_bd7533c2495e1752 = []byte{
	...
	,
}
