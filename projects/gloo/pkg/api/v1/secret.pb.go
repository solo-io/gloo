...
func (*Secret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_5aa674cdc0bbfb35, []int{0}
}
...
type Secret_Extension struct {
	Extension *Extension `protobuf:"bytes,4,opt,name=extension,oneof"`
}
...
func (*AwsSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_5aa674cdc0bbfb35, []int{1}
}
...
func (*AzureSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_5aa674cdc0bbfb35, []int{2}
}
...
func (*TlsSecret) Descriptor() ([]byte, []int) {
	return fileDescriptor_secret_5aa674cdc0bbfb35, []int{3}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo/projects/gloo/api/v1/secret.proto", fileDescriptor_secret_5aa674cdc0bbfb35)
}

var fileDescriptor_secret_5aa674cdc0bbfb35 = []byte{
