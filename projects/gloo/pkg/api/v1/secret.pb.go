...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Secret); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[6].Exporter = func(v any, i int) any {
