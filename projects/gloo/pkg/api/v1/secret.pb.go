...
func (x *Secret) GetKind() isSecret_Kind {
	if x != nil {
		return x.Kind
	}
	return nil
...
func (x *Secret) GetAzure() *AzureSecret {
	if x != nil {
		if x, ok := x.Kind.(*Secret_Azure); ok {
			return x.Azure
		}
	}
	return nil
...
func (x *Secret) GetOauth() *v1.OauthSecret {
	if x != nil {
		if x, ok := x.Kind.(*Secret_Oauth); ok {
			return x.Oauth
		}
	}
	return nil
...
func (x *Secret) GetApiKey() *v1.ApiKey {
	if x != nil {
		if x, ok := x.Kind.(*Secret_ApiKey); ok {
			return x.ApiKey
		}
	}
	return nil
...
func (x *Secret) GetHeader() *HeaderSecret {
	if x != nil {
		if x, ok := x.Kind.(*Secret_Header); ok {
			return x.Header
		}
	}
	return nil
...
func (x *Secret) GetCredentials() *AccountCredentialsSecret {
	if x != nil {
		if x, ok := x.Kind.(*Secret_Credentials); ok {
...
func (x *Secret) GetEncryption() *EncryptionKeySecret {
	if x != nil {
		if x, ok := x.Kind.(*Secret_Encryption); ok {
			return x.Encryption
		}
	}
	return nil
...
func (x *Secret) GetExtensions() *Extensions {
	if x != nil {
		if x, ok := x.Kind.(*Secret_Extensions); ok {
			return x.Extensions
		}
	}
	return nil
...
type AzureSecret struct {
	...
	ApiKeys       map[string]string `protobuf:"bytes,1,rep,name=api_keys,json=apiKeys,proto3" json:"api_keys,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDesc = "" +
	"\n" +
	"9github.com/solo-io/gloo/projects/gloo/api/v1/secret.proto\x12\fgloo.solo.io\x1a\x12extproto/ext.proto\x1a=github.com/solo-io/gloo/projects/gloo/api/v1/extensions.proto\x1aXgithub.com/solo-io/gloo/projects/gloo/api/v1/enterprise/options/extauth/v1/extauth.proto\x1a1github.com/solo-io/solo-kit/api/v1/metadata.proto\x1a1github.com/solo-io/solo-kit/api/v1/solo-kit.proto\"\xe2\x04\n" +
	"\x06Secret\x12+\n" +
	"\x03aws\x18\x01 \x01(\v2\x17.gloo.solo.io.AwsSecretH\x00R\x03aws\x121\n" +
	"\x05azure\x18\x02 \x01(\v2\x19.gloo.solo.io.AzureSecretH\x00R\x05azure\x12+\n" +
	"\x03tls\x18\x03 \x01(\v2\x17.gloo.solo.io.TlsSecretH\x00R\x03tls\x12<\n" +
	"\x05oauth\x18\x05 \x01(\v2$.enterprise.gloo.solo.io.OauthSecretH\x00R\x05oauth\x12:\n" +
	"\aapi_key\x18\x06 \x01(\v2\x1f.enterprise.gloo.solo.io.ApiKeyH\x00R\x06apiKey\x124\n" +
	"\x06header\x18\b \x01(\v2\x1a.gloo.solo.io.HeaderSecretH\x00R\x06header\x12J\n" +
	"\vcredentials\x18\t \x01(\v2&.gloo.solo.io.AccountCredentialsSecretH\x00R\vcredentials\x12C\n" +
	"\n" +
	"encryption\x18\n" +
	" \x01(\v2!.gloo.solo.io.EncryptionKeySecretH\x00R\n" +
	"encryption\x12:\n" +
	"\n" +
	"extensions\x18\x04 \x01(\v2\x18.gloo.solo.io.ExtensionsH\x00R\n" +
	"extensions\x122\n" +
	"\bmetadata\x18\a \x01(\v2\x16.core.solo.io.MetadataR\bmetadata:\x12\x82\xf1\x04\x0e\n" +
	"\x03sec\x12\asecretsB\x06\n" +
	"\x04kind\"n\n" +
	"\tAwsSecret\x12\x1d\n" +
	"\n" +
	...
	"\rsession_token\x18\x03 \x01(\tR\fsessionToken\"\x8c\x01\n" +
	"\vAzureSecret\x12A\n" +
	"\bapi_keys\x18\x01 \x03(\v2&.gloo.solo.io.AzureSecret.ApiKeysEntryR\aapiKeys\x1a:\n" +
	"\fApiKeysEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x85\x01\n" +
	"\tTlsSecret\x12\x1d\n" +
	"\n" +
	"cert_chain\x18\x01 \x01(\tR\tcertChain\x12\x1f\n" +
	"\vprivate_key\x18\x02 \x01(\tR\n" +
	"privateKey\x12\x17\n" +
	"\aroot_ca\x18\x03 \x01(\tR\x06rootCa\x12\x1f\n" +
	"\vocsp_staple\x18\x04 \x01(\fR\n" +
	"ocspStaple\"\x8d\x01\n" +
	"\fHeaderSecret\x12A\n" +
	"\aheaders\x18\x01 \x03(\v2'.gloo.solo.io.HeaderSecret.HeadersEntryR\aheaders\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"R\n" +
	"\x18AccountCredentialsSecret\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"'\n" +
	"\x13EncryptionKeySecret\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03keyB>\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z0github.com/solo-io/gloo/projects/gloo/pkg/api/v1b\x06proto3"

var (
	file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDescData []byte
)
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDesc)))
	})
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_goTypes = []any{
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_init() {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_msgTypes[0].OneofWrappers = []any{
		(*Secret_Aws)(nil),
		(*Secret_Azure)(nil),
		(*Secret_Tls)(nil),
		(*Secret_Oauth)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDesc), len(file_github_com_solo_io_gloo_projects_gloo_api_v1_secret_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
