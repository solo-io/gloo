...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_upstream_proto_rawDesc = []byte{
	...
	0x10, 0x0a, 0x08, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x57, 0x0a, 0x13, 0x6e,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x5c, 0x0a, 0x1d, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65,
	0x5f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x6f, 0x6e, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x5f,
	0x72, 0x65, 0x6d, 0x6f, 0x76, 0x61, 0x6c, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x42, 0x6f, 0x6f, 0x6c, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x19, 0x69, 0x67, 0x6e, 0x6f, 0x72,
	0x65, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x4f, 0x6e, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x6d,
	0x6f, 0x76, 0x61, 0x6c, 0x22, 0x54, 0x0a, 0x18, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x50,
	...
	0x50, 0x52, 0x4f, 0x54, 0x4f, 0x43, 0x4f, 0x4c, 0x10, 0x01, 0x3a, 0x17, 0x82, 0xf1, 0x04, 0x04,
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_upstream_proto_goTypes = []interface{}{
	...
	nil,                                    // 3: gloo.solo.io.DiscoveryMetadata.LabelsEntry
	...
	(*kubernetes.UpstreamSpec)(nil),        // 11: kubernetes.options.gloo.solo.io.UpstreamSpec
	(*static.UpstreamSpec)(nil),            // 12: static.options.gloo.solo.io.UpstreamSpec
	(*pipe.UpstreamSpec)(nil),              // 13: pipe.options.gloo.solo.io.UpstreamSpec
	(*aws.UpstreamSpec)(nil),               // 14: aws.options.gloo.solo.io.UpstreamSpec
	(*azure.UpstreamSpec)(nil),             // 15: azure.options.gloo.solo.io.UpstreamSpec
	(*consul.UpstreamSpec)(nil),            // 16: consul.options.gloo.solo.io.UpstreamSpec
	(*ec2.UpstreamSpec)(nil),               // 17: aws_ec2.options.gloo.solo.io.UpstreamSpec
	(*Failover)(nil),                       // 18: gloo.solo.io.Failover
	(*ConnectionConfig)(nil),               // 19: gloo.solo.io.ConnectionConfig
...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_upstream_proto_depIdxs = []int32{
	4,  // 0: gloo.solo.io.Upstream.namespaced_statuses:type_name -> core.solo.io.NamespacedStatuses
	5,  // 1: gloo.solo.io.Upstream.metadata:type_name -> core.solo.io.Metadata
	2,  // 2: gloo.solo.io.Upstream.discovery_metadata:type_name -> gloo.solo.io.DiscoveryMetadata
	6,  // 3: gloo.solo.io.Upstream.ssl_config:type_name -> gloo.solo.io.UpstreamSslConfig
	7,  // 4: gloo.solo.io.Upstream.circuit_breakers:type_name -> gloo.solo.io.CircuitBreakerConfig
	8,  // 5: gloo.solo.io.Upstream.load_balancer_config:type_name -> gloo.solo.io.LoadBalancerConfig
	9,  // 6: gloo.solo.io.Upstream.health_checks:type_name -> solo.io.envoy.api.v2.core.HealthCheck
	10, // 7: gloo.solo.io.Upstream.outlier_detection:type_name -> solo.io.envoy.api.v2.cluster.OutlierDetection
	11, // 8: gloo.solo.io.Upstream.kube:type_name -> kubernetes.options.gloo.solo.io.UpstreamSpec
	12, // 9: gloo.solo.io.Upstream.static:type_name -> static.options.gloo.solo.io.UpstreamSpec
	13, // 10: gloo.solo.io.Upstream.pipe:type_name -> pipe.options.gloo.solo.io.UpstreamSpec
	14, // 11: gloo.solo.io.Upstream.aws:type_name -> aws.options.gloo.solo.io.UpstreamSpec
	15, // 12: gloo.solo.io.Upstream.azure:type_name -> azure.options.gloo.solo.io.UpstreamSpec
	16, // 13: gloo.solo.io.Upstream.consul:type_name -> consul.options.gloo.solo.io.UpstreamSpec
	17, // 14: gloo.solo.io.Upstream.aws_ec2:type_name -> aws_ec2.options.gloo.solo.io.UpstreamSpec
	18, // 15: gloo.solo.io.Upstream.failover:type_name -> gloo.solo.io.Failover
	19, // 16: gloo.solo.io.Upstream.connection_config:type_name -> gloo.solo.io.ConnectionConfig
	0,  // 17: gloo.solo.io.Upstream.protocol_selection:type_name -> gloo.solo.io.Upstream.ClusterProtocolSelection
	20, // 18: gloo.solo.io.Upstream.use_http2:type_name -> google.protobuf.BoolValue
	...
	20, // 22: gloo.solo.io.Upstream.override_stream_error_on_invalid_http_message:type_name -> google.protobuf.BoolValue
	22, // 23: gloo.solo.io.Upstream.http_proxy_hostname:type_name -> google.protobuf.StringValue
	6,  // 24: gloo.solo.io.Upstream.http_connect_ssl_config:type_name -> gloo.solo.io.UpstreamSslConfig
	20, // 25: gloo.solo.io.Upstream.ignore_health_on_host_removal:type_name -> google.protobuf.BoolValue
	3,  // 26: gloo.solo.io.DiscoveryMetadata.labels:type_name -> gloo.solo.io.DiscoveryMetadata.LabelsEntry
