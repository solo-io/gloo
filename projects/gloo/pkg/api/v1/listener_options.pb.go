...
var file_github_com_solo_io_gloo_projects_gloo_api_v1_listener_options_proto_goTypes = []interface{}{
...
func file_github_com_solo_io_gloo_projects_gloo_api_v1_listener_options_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_v1_listener_options_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_listener_options_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_v1_listener_options_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
