...
func NewApiEmitter(proxyClient ProxyClient, artifactClient ArtifactClient, endpointClient EndpointClient, secretClient SecretClient, upstreamClient UpstreamClient) ApiEmitter {
	return NewApiEmitterWithEmit(proxyClient, artifactClient, endpointClient, secretClient, upstreamClient, make(chan struct{}))
}

func NewApiEmitterWithEmit(proxyClient ProxyClient, artifactClient ArtifactClient, endpointClient EndpointClient, secretClient SecretClient, upstreamClient UpstreamClient, emit <-chan struct{}) ApiEmitter {
	return &apiEmitter{
		proxy:     proxyClient,
		artifact:  artifactClient,
		endpoint:  endpointClient,
