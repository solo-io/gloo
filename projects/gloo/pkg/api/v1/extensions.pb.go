...
func (*Extensions) Descriptor() ([]byte, []int) {
	return fileDescriptor_extensions_6ae302c2830faefa, []int{0}
}
...
type Extension struct {
	Config               *types.Struct `protobuf:"bytes,1,opt,name=config" json:"config,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*Extension) Descriptor() ([]byte, []int) {
	return fileDescriptor_extensions_6ae302c2830faefa, []int{1}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/gloo/projects/gloo/api/v1/extensions.proto", fileDescriptor_extensions_6ae302c2830faefa)
}

var fileDescriptor_extensions_6ae302c2830faefa = []byte{
