...
// GlooEdgeProxyValues are the current and historical ProxyTypeKey values of Proxies generated by the
// Gloo Edge translator. "gloo-gateway-translator" was removed in 1.17 and "gateway" in 1.12; they are kept
// so Proxies written by older versions are still recognized as Edge-owned.
var GlooEdgeProxyValues = []string{GlooEdgeProxyValue, "gloo-gateway-translator", "gateway"}
