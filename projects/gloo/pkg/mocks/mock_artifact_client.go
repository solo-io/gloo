...
func (m *MockArtifactClient) RegisterNamespace(arg0 string) error {
	m.ctrl.T.Helper()
...
func (mr *MockArtifactClientMockRecorder) RegisterNamespace(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RegisterNamespace", reflect.TypeOf((*MockArtifactClient)(nil).RegisterNamespace), arg0)
}
