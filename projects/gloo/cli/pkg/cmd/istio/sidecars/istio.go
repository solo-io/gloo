...
func generateIstioSidecar(version, jwtPolicy, istioMetaMeshID, istioMetaClusterID, istioDiscoveryAddress, istioTrustDomain string) *corev1.Container {
	sidecar := &corev1.Container{
		...
		Args: []string{
			...
			"--dnsRefreshRate",
			"300s",
			fmt.Sprintf("--trust-domain=%s", istioTrustDomain),
