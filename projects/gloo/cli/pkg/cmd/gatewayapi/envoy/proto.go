...
//go:generate sh -c "echo 'package envoy\n\nimport (' >> filter_types.gen.go"
//go:generate sh -c "go list github.com/envoyproxy/go-control-plane/envoy/... | xargs -I{} echo '\t_ \"{}\"' >> filter_types.gen.go"
//go:generate sh -c "go list istio.io/api/envoy/... | xargs -I{} echo '\t_ \"{}\"' >> filter_types.gen.go"
//go:generate sh -c "echo ')' >> filter_types.gen.go"
