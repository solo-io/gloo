...
func (m *WAFPolicySpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *WAFPolicyStatus) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *WAFPolicyReport) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *WAFPolicySpec_Config) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("DisableCoreRuleSet")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("CustomRuleSets")); err != nil {
		return 0, err
	}
	for i, v := range m.GetCustomRuleSets() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
	...
	case *WAFPolicySpec_Config_CoreRuleSetSettingsString:
		...
		if _, err = hasher.Write([]byte("CoreRuleSetSettingsString")); err != nil {
			return 0, err
		}
	...
	case *WAFPolicySpec_Config_CoreRuleSetSettingsPath:
		...
		if _, err = hasher.Write([]byte("CoreRuleSetSettingsPath")); err != nil {
			return 0, err
		}
