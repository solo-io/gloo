...
func (m *AccessLogPolicySpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *AccessLogPolicyStatus) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *AccessLogPolicyReport) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *AccessLogPolicySpec_Config) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("IncludedRequestHeaders")); err != nil {
		return 0, err
	}
	for i, v := range m.GetIncludedRequestHeaders() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
	...
	if _, err = hasher.Write([]byte("IncludedResponseHeaders")); err != nil {
		return 0, err
	}
	for i, v := range m.GetIncludedResponseHeaders() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
	...
	if _, err = hasher.Write([]byte("IncludedResponseTrailers")); err != nil {
		return 0, err
	}
	for i, v := range m.GetIncludedResponseTrailers() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
	...
	if _, err = hasher.Write([]byte("IncludedFilterStateObjects")); err != nil {
		return 0, err
	}
	for i, v := range m.GetIncludedFilterStateObjects() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *AccessLogPolicySpec_Config_Filter) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	case *AccessLogPolicySpec_Config_Filter_StatusCodeMatcher:
		...
		if h, ok := interface{}(m.GetStatusCodeMatcher()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("StatusCodeMatcher")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetStatusCodeMatcher(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("StatusCodeMatcher")); err != nil {
					return 0, err
	...
	case *AccessLogPolicySpec_Config_Filter_HeaderMatcher:
		...
		if h, ok := interface{}(m.GetHeaderMatcher()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("HeaderMatcher")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetHeaderMatcher(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("HeaderMatcher")); err != nil {
					return 0, err
