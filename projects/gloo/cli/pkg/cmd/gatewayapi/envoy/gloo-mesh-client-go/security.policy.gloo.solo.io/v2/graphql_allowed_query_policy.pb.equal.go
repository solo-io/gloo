...
// Equal function
func (m *GraphQLAllowedQueryPolicySpec) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}
	...
	if !ok {
		that2, ok := that.(GraphQLAllowedQueryPolicySpec)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *GraphQLAllowedQueryPolicyStatus) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*GraphQLAllowedQueryPolicyStatus)
	if !ok {
		that2, ok := that.(GraphQLAllowedQueryPolicyStatus)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *GraphQLAllowedQueryPolicyReport) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*GraphQLAllowedQueryPolicyReport)
	if !ok {
		that2, ok := that.(GraphQLAllowedQueryPolicyReport)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *GraphQLAllowedQueryPolicySpec_Config) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*GraphQLAllowedQueryPolicySpec_Config)
	if !ok {
		that2, ok := that.(GraphQLAllowedQueryPolicySpec_Config)
		if ok {
			target = &that2
		} else {
			return false
