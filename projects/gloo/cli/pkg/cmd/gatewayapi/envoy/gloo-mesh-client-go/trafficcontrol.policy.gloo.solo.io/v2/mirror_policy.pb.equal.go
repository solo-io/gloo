...
// Equal function
func (m *MirrorPolicySpec) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*MirrorPolicySpec)
	if !ok {
		that2, ok := that.(MirrorPolicySpec)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *MirrorPolicyStatus) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}
	...
	if !ok {
		that2, ok := that.(MirrorPolicyStatus)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *MirrorPolicyReport) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*MirrorPolicyReport)
	if !ok {
		that2, ok := that.(MirrorPolicyReport)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *MirrorPolicySpec_Config) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*MirrorPolicySpec_Config)
	if !ok {
		that2, ok := that.(MirrorPolicySpec_Config)
		if ok {
			target = &that2
		} else {
			return false
