...
type GetProxy struct {
	...
	// Namespace represents the namespace to search for the Proxy.
	// An empty string is interpreted as all namespaces
	Namespace string
	...
	// All is true if the GetProxy request should consider all Proxy resources, in all namespaces
	All bool
}
