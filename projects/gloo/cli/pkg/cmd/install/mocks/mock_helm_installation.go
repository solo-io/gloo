...
//
//	mockgen -destination mocks/mock_helm_installation.go -package mocks github.com/solo-io/gloo/projects/gloo/cli/pkg/cmd/install HelmInstallation
//
...
func (m *MockHelmInstallation) Run(arg0 *chart.Chart, arg1 map[string]any) (*release.Release, error) {
	m.ctrl.T.Helper()
...
func (mr *MockHelmInstallationMockRecorder) Run(arg0, arg1 any) *gomock.Call {
