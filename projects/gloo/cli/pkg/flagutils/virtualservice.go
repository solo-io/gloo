...
func addVirtualServiceFlagsOIDC(set *pflag.FlagSet, oidc *options.OIDCAuth) {
	...
	set.StringVar(&oidc.ClientSecretRef.Name, "oidc-auth-client-name", "", "name of the 'client secret' secret")
	set.StringVar(&oidc.ClientSecretRef.Namespace, "oidc-auth-client-namespace", "", "namespace of the 'client secret' secret")
