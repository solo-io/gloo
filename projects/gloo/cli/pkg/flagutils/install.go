...
func AddGlooInstallFlags(set *pflag.FlagSet, install *options.Install) {
	...
	set.StringVar(&install.Gloo.Version, "version", "", "version to install (e.g. 1.4.0, defaults to latest)")
...
func AddFederationInstallFlags(set *pflag.FlagSet, install *options.Install) {
	...
	set.StringVar(&install.Federation.Version, "version", "", "version to install (e.g. 0.0.6, defaults to latest)")
