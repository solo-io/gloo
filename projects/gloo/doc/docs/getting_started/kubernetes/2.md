...
The [function spec](../../v1/github.com/solo-io/solo-projects/projects/gloo/api/v1/upstream.proto.sk.md) you see on the functions listed above belongs to the transformation plugin. This powerful
