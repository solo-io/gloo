...
Description: Plugin-specific configuration that lives on listeners
...
Description: Plugin-specific configuration that lives on virtual hosts
...
Description: Plugin-specific configuration that lives on routes
...
Description: Each upstream in Gloo has a type. Supported types include `static`, `kubernetes`, `aws`, `consul`, and more.
