...
protoc -I=${IN} ${PROTOC_FLAGS} github.com/solo-io/solo-kit/projects/gloo/api/v1/plugins/{service_spec,transformation}.proto

for plugin in azure aws kubernetes rest; do
