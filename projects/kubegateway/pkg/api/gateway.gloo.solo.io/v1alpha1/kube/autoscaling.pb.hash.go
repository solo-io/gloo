...
func (m *Autoscaling) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("kube.gateway.gloo.solo.io.github.com/solo-io/gloo/projects/kubegateway/pkg/api/gateway.gloo.solo.io/v1alpha1/kube.Autoscaling")); err != nil {
		return 0, err
	}
...
func (m *HorizontalPodAutoscaler) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("kube.gateway.gloo.solo.io.github.com/solo-io/gloo/projects/kubegateway/pkg/api/gateway.gloo.solo.io/v1alpha1/kube.HorizontalPodAutoscaler")); err != nil {
		return 0, err
	}
