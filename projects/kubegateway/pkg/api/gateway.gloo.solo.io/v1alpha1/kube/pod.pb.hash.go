...
func (m *Pod) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("kube.gateway.gloo.solo.io.github.com/solo-io/gloo/projects/kubegateway/pkg/api/gateway.gloo.solo.io/v1alpha1/kube.Pod")); err != nil {
		return 0, err
	}
