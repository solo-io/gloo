...
func RateLimitConfig(opts *options.Options) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			defer conn.Close()
			client := rpc_edge_v1.NewRatelimitResourceApiClient(conn)
			rateLimitConfigs, err := client.ListRateLimitConfigs(opts.Ctx, &rpc_edge_v1.ListRateLimitConfigsRequest{})
			if err != nil {
				return err
			}
