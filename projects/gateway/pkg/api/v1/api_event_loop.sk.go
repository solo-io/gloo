...
var (
	mApiSnapshotTimeSec     = stats.Float64("api.gateway.solo.io/sync/time_sec", "The time taken for a given sync", "1")
	mApiSnapshotTimeSecView = &view.View{
		Name:        "api.gateway.solo.io/sync/time_sec",
		...
		for {
			...
			case snapshot, ok := <-watch:
				...
				stats.RecordWithTags(
					...
					mApiSnapshotTimeSec.M(time.Now().Sub(startTime).Seconds()),
				)
				span.End()
