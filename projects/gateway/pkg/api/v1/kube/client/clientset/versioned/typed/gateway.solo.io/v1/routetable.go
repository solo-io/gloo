...
type RouteTableInterface interface {
	...
	Apply(ctx context.Context, routeTable *gatewaysoloiov1.RouteTableApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RouteTable, err error)
	ApplyStatus(ctx context.Context, routeTable *gatewaysoloiov1.RouteTableApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RouteTable, err error)
	RouteTableExpansion
}
...
func (c *routeTables) Apply(ctx context.Context, routeTable *gatewaysoloiov1.RouteTableApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RouteTable, err error) {
	if routeTable == nil {
...
func (c *routeTables) ApplyStatus(ctx context.Context, routeTable *gatewaysoloiov1.RouteTableApplyConfiguration, opts metav1.ApplyOptions) (result *v1.RouteTable, err error) {
	if routeTable == nil {
		return nil, fmt.Errorf("routeTable provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
