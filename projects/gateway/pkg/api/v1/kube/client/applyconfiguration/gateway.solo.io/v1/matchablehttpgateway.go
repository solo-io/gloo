...
// MatchableHttpGatewayApplyConfiguration represents an declarative configuration of the MatchableHttpGateway type for use
// with apply.
type MatchableHttpGatewayApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *apiv1.MatchableHttpGateway `json:"spec,omitempty"`
	Status                           *core.NamespacedStatuses    `json:"status,omitempty"`
}

// MatchableHttpGateway constructs an declarative configuration of the MatchableHttpGateway type for use with
// apply.
func MatchableHttpGateway(name, namespace string) *MatchableHttpGatewayApplyConfiguration {
	b := &MatchableHttpGatewayApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("MatchableHttpGateway")
...
func (b *MatchableHttpGatewayApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
