...
// RouteOptionApplyConfiguration represents an declarative configuration of the RouteOption type for use
// with apply.
type RouteOptionApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *apiv1.RouteOption       `json:"spec,omitempty"`
	Status                           *core.NamespacedStatuses `json:"status,omitempty"`
}

// RouteOption constructs an declarative configuration of the RouteOption type for use with
// apply.
func RouteOption(name, namespace string) *RouteOptionApplyConfiguration {
	b := &RouteOptionApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("RouteOption")
...
func (b *RouteOptionApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
