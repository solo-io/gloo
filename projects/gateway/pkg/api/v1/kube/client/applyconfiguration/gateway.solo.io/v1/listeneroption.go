...
// ListenerOptionApplyConfiguration represents an declarative configuration of the ListenerOption type for use
// with apply.
type ListenerOptionApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *apiv1.ListenerOption `json:"spec,omitempty"`
}

// ListenerOption constructs an declarative configuration of the ListenerOption type for use with
// apply.
func ListenerOption(name, namespace string) *ListenerOptionApplyConfiguration {
	b := &ListenerOptionApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("ListenerOption")
...
func (b *ListenerOptionApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
