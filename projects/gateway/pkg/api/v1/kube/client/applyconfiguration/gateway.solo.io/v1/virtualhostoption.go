...
// VirtualHostOptionApplyConfiguration represents an declarative configuration of the VirtualHostOption type for use
// with apply.
type VirtualHostOptionApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *apiv1.VirtualHostOption `json:"spec,omitempty"`
	Status                           *core.NamespacedStatuses `json:"status,omitempty"`
}

// VirtualHostOption constructs an declarative configuration of the VirtualHostOption type for use with
// apply.
func VirtualHostOption(name, namespace string) *VirtualHostOptionApplyConfiguration {
	b := &VirtualHostOptionApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("VirtualHostOption")
...
func (b *VirtualHostOptionApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
