...
// HttpListenerOptionApplyConfiguration represents an declarative configuration of the HttpListenerOption type for use
// with apply.
type HttpListenerOptionApplyConfiguration struct {
	v1.TypeMetaApplyConfiguration    `json:",inline"`
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *apiv1.HttpListenerOption `json:"spec,omitempty"`
}

// HttpListenerOption constructs an declarative configuration of the HttpListenerOption type for use with
// apply.
func HttpListenerOption(name, namespace string) *HttpListenerOptionApplyConfiguration {
	b := &HttpListenerOptionApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("HttpListenerOption")
...
func (b *HttpListenerOptionApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
