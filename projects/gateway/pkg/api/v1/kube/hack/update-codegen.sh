...
readonly ROOT_PKG=github.com/solo-io/gloo/projects/gateway/pkg/api/v1
...
do
    PROJECT_INPUT_DIRS_SPACE+="${APIS_PKG}/gateway.solo.io/v1 "
    PROJECT_INPUT_DIRS_COMMA+="${APIS_PKG}/gateway.solo.io/v1,"
done
