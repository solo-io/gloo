...
import (
	...
	gatewaysoloiov2v2 "github.com/solo-io/gloo/projects/gateway/pkg/api/v2/kube/apis/gateway.solo.io.v2/v2"
	versioned "github.com/solo-io/gloo/projects/gateway/pkg/api/v2/kube/client/clientset/versioned"
	internalinterfaces "github.com/solo-io/gloo/projects/gateway/pkg/api/v2/kube/client/informers/externalversions/internalinterfaces"
	v2 "github.com/solo-io/gloo/projects/gateway/pkg/api/v2/kube/client/listers/gateway.solo.io.v2/v2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GatewayV2().Gateways(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GatewayV2().Gateways(namespace).Watch(options)
			},
		},
		&gatewaysoloiov2v2.Gateway{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&gatewaysoloiov2v2.Gateway{}, f.defaultInformer)
}

func (f *gatewayInformer) Lister() v2.GatewayLister {
	return v2.NewGatewayLister(f.Informer().GetIndexer())
}
