...
import (
	...
	scheme "github.com/solo-io/gloo/projects/gateway/pkg/api/v2/kube/client/clientset/versioned/scheme"
...
type GatewayInterface interface {
	Create(*v2.Gateway) (*v2.Gateway, error)
	Update(*v2.Gateway) (*v2.Gateway, error)
	UpdateStatus(*v2.Gateway) (*v2.Gateway, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v2.Gateway, error)
	List(opts v1.ListOptions) (*v2.GatewayList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.Gateway, err error)
	GatewayExpansion
}
...
func newGateways(c *GatewayV2Client, namespace string) *gateways {
	return &gateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gateways) Get(name string, options v1.GetOptions) (result *v2.Gateway, err error) {
	result = &v2.Gateway{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) List(opts v1.ListOptions) (result *v2.GatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v2.GatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Create(gateway *v2.Gateway) (result *v2.Gateway, err error) {
	result = &v2.Gateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Update(gateway *v2.Gateway) (result *v2.Gateway, err error) {
	result = &v2.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) UpdateStatus(gateway *v2.Gateway) (result *v2.Gateway, err error) {
	result = &v2.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.Gateway, err error) {
	result = &v2.Gateway{}
