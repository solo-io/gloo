...
var _ = Describe("V2Emitter", func() {
	...
	BeforeEach(func() {
		...
		virtualServiceClientFactory := &factory.KubeResourceClientFactory{
			Crd:         gateway_solo_io.VirtualServiceCrd,
			Cfg:         cfg,
	...
	It("tracks snapshots on changes to any resource", func() {
		...
		*/
		...
		virtualService1a, err := virtualServiceClient.Write(gateway_solo_io.NewVirtualService(namespace1, name1), clients.WriteOpts{Ctx: ctx})
		Expect(err).NotTo(HaveOccurred())
