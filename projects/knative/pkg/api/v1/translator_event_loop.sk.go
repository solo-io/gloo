...
var (
	mTranslatorSnapshotTimeSec     = stats.Float64("translator.knative.gloo.solo.io/sync/time_sec", "The time taken for a given sync", "1")
	mTranslatorSnapshotTimeSecView = &view.View{
		Name:        "translator.knative.gloo.solo.io/sync/time_sec",
