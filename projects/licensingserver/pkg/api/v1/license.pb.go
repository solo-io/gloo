...
package v1 // import "github.com/solo-io/solo-projects/projects/licensingserver/pkg/api/v1"
...
func (LicenseKey_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_license_40a8bebb5a8ededd, []int{2, 0}
}
...
func (*ValidateKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_40a8bebb5a8ededd, []int{0}
}
...
func (*ValidateKeyReponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_40a8bebb5a8ededd, []int{1}
}
...
func (*LicenseKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_license_40a8bebb5a8ededd, []int{2}
}
...
func init() {
	proto.RegisterFile("github.com/solo-io/solo-projects/projects/licensingserver/api/v1/license.proto", fileDescriptor_license_40a8bebb5a8ededd)
}

var fileDescriptor_license_40a8bebb5a8ededd = []byte{
