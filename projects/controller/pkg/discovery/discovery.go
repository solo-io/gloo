...
//go:generate mockgen -destination mocks/mock_discovery.go -package mocks github.com/solo-io/gloo/projects/controllerrollerroller/pkg/discovery DiscoveryPlugin
