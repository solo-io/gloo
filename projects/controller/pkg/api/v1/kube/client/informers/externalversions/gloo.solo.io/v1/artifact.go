...
import (
	...
	internalinterfaces "github.com/solo-io/gloo/projects/controller/pkg/api/v1/kube/client/informers/externalversions/internalinterfaces"
	v1 "github.com/solo-io/gloo/projects/controller/pkg/api/v1/kube/client/listers/gloo.solo.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.GlooV1().Artifacts(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlooV1().Artifacts(namespace).Watch(context.TODO(), options)
			},
		},
