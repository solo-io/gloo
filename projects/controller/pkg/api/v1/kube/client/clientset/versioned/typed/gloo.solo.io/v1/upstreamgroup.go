...
type upstreamGroups struct {
	*gentype.ClientWithList[*v1.UpstreamGroup, *v1.UpstreamGroupList]
}
...
func newUpstreamGroups(c *GlooV1Client, namespace string) *upstreamGroups {
	return &upstreamGroups{
		gentype.NewClientWithList[*v1.UpstreamGroup, *v1.UpstreamGroupList](
			"upstreamgroups",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *v1.UpstreamGroup { return &v1.UpstreamGroup{} },
			func() *v1.UpstreamGroupList { return &v1.UpstreamGroupList{} }),
	}
}
