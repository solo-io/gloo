...
func (m *UpstreamSpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gcp.options.gloo.solo.io.github.com/solo-io/gloo/projects/controller/pkg/api/v1/enterprise/options/gcp.UpstreamSpec")); err != nil {
		return 0, err
	}
