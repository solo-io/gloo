...
func (m *Upstream) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1.Upstream")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("HealthChecks")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("ProtocolSelection")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("HttpConnectHeaders")); err != nil {
		return 0, err
	}
	for i, v := range m.GetHttpConnectHeaders() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
...
func (m *DiscoveryMetadata) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1.DiscoveryMetadata")); err != nil {
		return 0, err
	}
...
func (m *HeaderValue) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1.HeaderValue")); err != nil {
		return 0, err
	}
...
func (m *PreconnectPolicy) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1.PreconnectPolicy")); err != nil {
		return 0, err
	}
