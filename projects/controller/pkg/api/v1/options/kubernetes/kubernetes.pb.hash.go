...
func (m *UpstreamSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("kubernetes.options.gloo.solo.io.github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/kubernetes.UpstreamSpec")); err != nil {
		return 0, err
	}
