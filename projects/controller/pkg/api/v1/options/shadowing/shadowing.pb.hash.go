...
func (m *RouteShadowing) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("shadowing.options.gloo.solo.io.github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/shadowing.RouteShadowing")); err != nil {
		return 0, err
	}
