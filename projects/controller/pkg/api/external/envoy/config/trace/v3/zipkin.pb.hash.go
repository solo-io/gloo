...
func (m *ZipkinConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.trace.v3.github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/external/envoy/config/trace/v3.ZipkinConfig")); err != nil {
		return 0, err
	}
