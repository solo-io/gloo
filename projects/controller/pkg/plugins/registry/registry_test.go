...
import (
	...
	v2 "github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/external/envoy/config/filter/http/gzip/v2"
	v3 "github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/external/envoy/extensions/filters/http/buffer/v3"
	v32 "github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/external/envoy/extensions/filters/http/csrf/v3"
	...
	"github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1/options/dynamic_forward_proxy"
	"github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1/options/grpc_json"
	"github.com/solo-io/gloo/projects/controllerrollerroller/pkg/api/v1/options/grpc_web"
