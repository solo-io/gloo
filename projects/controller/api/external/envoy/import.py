...
def import_and_copy(f):
    ...
    for i in get_sorted_imports(envoy_path, f):
        ...
        if os.path.exists(path):
            ...
            option = 'option go_package = "github.com/solo-io/gloo/projects/controller/pkg/api/external/'+folder+'";'
            if os.getenv("COPY"):
                f = os.system
            else:
            ...
            basedir = gopath+"/src/github.com/solo-io/gloo/projects/controller/api/external/"
            ...
            f("echo 'option (extproto.clone_all) = true;' >> " + dest)
...
def main():
    if len(sys.argv) != 2:
        ...
        print("for example, this will copy route_components.proto and its dependencies to $GOPATH/src/github.com/solo-io/gloo/projects/controller/api/external from ~/sources/envoy/api:")
