...
#----------------------------------------------------------------------------------
# glooctl fed extension
#----------------------------------------------------------------------------------
CLI_EXTENSIONS_DIR=projects/glooctl-extensions
FED_CLI_EXTENSION_DIR=$(CLI_EXTENSIONS_DIR)/fed
...
$(OUTPUT_DIR)/glooctl-fed-linux-amd64: $(SOURCES)
	CGO_ENABLED=0 GOARCH=amd64 GOOS=linux go build -ldflags=$(LDFLAGS) -gcflags=$(GCFLAGS) -o $@ $(FED_CLI_EXTENSION_DIR)/cmd/main.go
...
$(OUTPUT_DIR)/glooctl-fed-darwin-amd64: $(SOURCES)
	CGO_ENABLED=0 GOARCH=amd64 GOOS=darwin go build -ldflags=$(LDFLAGS) -gcflags=$(GCFLAGS) -o $@ $(FED_CLI_EXTENSION_DIR)/cmd/main.go
...
$(OUTPUT_DIR)/glooctl-fed-windows-amd64.exe: $(SOURCES)
	CGO_ENABLED=0 GOARCH=amd64 GOOS=windows go build -ldflags=$(LDFLAGS) -gcflags=$(GCFLAGS) -o $@ $(FED_CLI_EXTENSION_DIR)/cmd/main.go
...
install-fed-cli:
	go build -ldflags=$(LDFLAGS) -gcflags=$(GCFLAGS) -o ${GOPATH}/bin/glooctl-fed $(FED_CLI_EXTENSION_DIR)/cmd/main.go



##----------------------------------------------------------------------------------
## Release glooctl extensions
##----------------------------------------------------------------------------------
