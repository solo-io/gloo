...
// RefIsServiceEntry checks if the BackendObjectReference is a ServiceEntry
func RefIsServiceEntry(ref gwv1.BackendObjectReference) bool {
	return (ref.Kind != nil && *ref.Kind == "ServiceEntry") && (ref.Group != nil && *ref.Group == istionetworking.GroupName)
}
