...
// Regression tests for https://github.com/solo-io/solo-projects/issues/9168 on the kube gateway path.
...
func translateTestProxyWithCtx(ctx context.Context, s *ProxySyncer) *XdsSnapWrapper {
	return s.translateProxy(
		...
		krt.NewStaticCollection[*corev1.ConfigMap](nil),
		krt.NewStaticCollection[EndpointResources](nil),
		krt.NewStaticCollection[RedactedSecret](nil),
		krt.NewStaticCollection[krtcollections.UpstreamWrapper](nil),
		krt.NewStaticCollection[*extauthkubev1.AuthConfig](nil),
		krt.NewStaticCollection[*rlkubev1a1.RateLimitConfig](nil),
	)
}
