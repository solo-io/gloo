...
func (m *Service) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("kube.gateway.gloo.solo.io.github.com/solo-io/gloo/projects/gateway2/pkg/api/gateway.gloo.solo.io/v1alpha1/kube.Service")); err != nil {
		return 0, err
	}
