...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_rawDesc = []byte{
	...
	0x59, 0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5, 0x04, 0x01, 0x5a, 0x4f, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x67, 0x6c,
	0x6f, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x32, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x61, 0x74,
...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_goTypes = []interface{}{
	...
	(*kube.Pod)(nil),                  // 11: kube.gateway.gloo.solo.io.Pod
	(*kube.Service)(nil),              // 12: kube.gateway.gloo.solo.io.Service
	(*kube.Autoscaling)(nil),          // 13: kube.gateway.gloo.solo.io.Autoscaling
...
var file_github_com_solo_io_gloo_projects_gateway2_api_v1alpha1_gateway_parameters_proto_depIdxs = []int32{
	...
	6,  // 3: gateway.gloo.solo.io.KubernetesProxyConfig.sds_container:type_name -> gateway.gloo.solo.io.SdsContainer
	11, // 4: gateway.gloo.solo.io.KubernetesProxyConfig.pod_template:type_name -> kube.gateway.gloo.solo.io.Pod
	12, // 5: gateway.gloo.solo.io.KubernetesProxyConfig.service:type_name -> kube.gateway.gloo.solo.io.Service
	13, // 6: gateway.gloo.solo.io.KubernetesProxyConfig.autoscaling:type_name -> kube.gateway.gloo.solo.io.Autoscaling
	...
	19, // 15: gateway.gloo.solo.io.IstioIntegration.enabled:type_name -> google.protobuf.BoolValue
	8,  // 16: gateway.gloo.solo.io.IstioIntegration.istio_container:type_name -> gateway.gloo.solo.io.IstioContainer
	18, // 17: gateway.gloo.solo.io.IstioIntegration.istio_discovery_address:type_name -> google.protobuf.StringValue
	18, // 18: gateway.gloo.solo.io.IstioIntegration.istio_meta_mesh_id:type_name -> google.protobuf.StringValue
	18, // 19: gateway.gloo.solo.io.IstioIntegration.istio_meta_cluster_id:type_name -> google.protobuf.StringValue
	15, // 20: gateway.gloo.solo.io.SdsContainer.image:type_name -> kube.gateway.gloo.solo.io.Image
	16, // 21: gateway.gloo.solo.io.SdsContainer.security_context:type_name -> k8s.io.api.core.v1.SecurityContext
	17, // 22: gateway.gloo.solo.io.SdsContainer.resources:type_name -> kube.gateway.gloo.solo.io.ResourceRequirements
	7,  // 23: gateway.gloo.solo.io.SdsContainer.bootstrap:type_name -> gateway.gloo.solo.io.SdsBootstrap
	18, // 24: gateway.gloo.solo.io.SdsBootstrap.log_level:type_name -> google.protobuf.StringValue
	15, // 25: gateway.gloo.solo.io.IstioContainer.image:type_name -> kube.gateway.gloo.solo.io.Image
	16, // 26: gateway.gloo.solo.io.IstioContainer.security_context:type_name -> k8s.io.api.core.v1.SecurityContext
	17, // 27: gateway.gloo.solo.io.IstioContainer.resources:type_name -> kube.gateway.gloo.solo.io.ResourceRequirements
	18, // 28: gateway.gloo.solo.io.IstioContainer.log_level:type_name -> google.protobuf.StringValue
