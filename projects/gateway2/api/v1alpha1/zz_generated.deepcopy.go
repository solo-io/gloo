...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlooMtls) DeepCopyInto(out *GlooMtls) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlooMtls.
func (in *GlooMtls) DeepCopy() *GlooMtls {
	if in == nil {
		return nil
	}
	out := new(GlooMtls)
...
func (in *KubernetesProxyConfig) DeepCopyInto(out *KubernetesProxyConfig) {
	*out = *in
	...
	if in.GlooMtls != nil {
		in, out := &in.GlooMtls, &out.GlooMtls
		*out = new(GlooMtls)
		**out = **in
	}
}
