...
func (ec *executionContext) _Schema(ctx context.Context, sel ast.SelectionSet, obj *models.Schema) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "resolverMap":
			out.Values[i] = ec._Schema_resolverMap(ctx, field, obj)
		case "inlineSchema":
...
func (ec *executionContext) _Schema_resolverMap(ctx context.Context, field graphql.CollectedField, obj *models.Schema) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Schema"
	rctx.Args = nil
	rctx.Field = field
...
func UnmarshalInputSchema(v interface{}) (models.InputSchema, error) {
	...
	for k, v := range asMap {
		...
		case "resolverMap":
			var err error
			it.ResolverMap, err = UnmarshalInputResourceRef(v)
			if err != nil {
				return it, err
			}
		case "inlineSchema":
