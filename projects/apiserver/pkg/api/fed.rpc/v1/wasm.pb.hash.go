...
func (m *WasmFilter) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.WasmFilter")); err != nil {
		return 0, err
	}
...
func (m *ListWasmFiltersRequest) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.ListWasmFiltersRequest")); err != nil {
		return 0, err
	}
...
func (m *ListWasmFiltersResponse) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.ListWasmFiltersResponse")); err != nil {
		return 0, err
	}
...
func (m *DescribeWasmFilterRequest) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.DescribeWasmFilterRequest")); err != nil {
		return 0, err
	}
...
func (m *DescribeWasmFilterResponse) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.DescribeWasmFilterResponse")); err != nil {
		return 0, err
	}
...
func (m *WasmFilter_Location) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.WasmFilter_Location")); err != nil {
		return 0, err
	}
