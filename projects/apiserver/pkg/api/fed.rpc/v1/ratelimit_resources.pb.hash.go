...
func (m *RateLimitConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.RateLimitConfig")); err != nil {
		return 0, err
	}
...
func (m *ListRateLimitConfigsRequest) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.ListRateLimitConfigsRequest")); err != nil {
		return 0, err
	}
...
func (m *ListRateLimitConfigsResponse) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.ListRateLimitConfigsResponse")); err != nil {
		return 0, err
	}
...
func (m *GetRateLimitConfigYamlRequest) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.GetRateLimitConfigYamlRequest")); err != nil {
		return 0, err
	}
...
func (m *GetRateLimitConfigYamlResponse) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.rpc.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/fed.rpc/v1.GetRateLimitConfigYamlResponse")); err != nil {
		return 0, err
	}
