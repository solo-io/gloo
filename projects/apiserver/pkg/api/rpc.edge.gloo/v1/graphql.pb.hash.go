...
// Hash function
func (m *GraphqlApiSummary) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GraphqlApiSummary")); err != nil {
		return 0, err
	}
	...
	case *GraphqlApiSummary_Executable:
		...
		if h, ok := interface{}(m.GetExecutable()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("Executable")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetExecutable(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("Executable")); err != nil {
					return 0, err
	...
	case *GraphqlApiSummary_Stitched:
		...
		if h, ok := interface{}(m.GetStitched()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("Stitched")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetStitched(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("Stitched")); err != nil {
					return 0, err
...
// Hash function
func (m *GetStitchedSchemaDefinitionRequest) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GetStitchedSchemaDefinitionRequest")); err != nil {
		return 0, err
	}

	if h, ok := interface{}(m.GetStitchedSchemaApiRef()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("StitchedSchemaApiRef")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetStitchedSchemaApiRef(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("StitchedSchemaApiRef")); err != nil {
				return 0, err
...
// Hash function
func (m *GetStitchedSchemaDefinitionResponse) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GetStitchedSchemaDefinitionResponse")); err != nil {
		return 0, err
	}

	if _, err = hasher.Write([]byte(m.GetStitchedSchemaSdl())); err != nil {
		return 0, err
	}
...
// Hash function
func (m *GetSchemaDiffRequest) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GetSchemaDiffRequest")); err != nil {
		return 0, err
	}

	if h, ok := interface{}(m.GetDiffInput()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("DiffInput")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetDiffInput(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("DiffInput")); err != nil {
				return 0, err
...
// Hash function
func (m *GetSchemaDiffResponse) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GetSchemaDiffResponse")); err != nil {
		return 0, err
	}

	if h, ok := interface{}(m.GetDiffOutput()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("DiffOutput")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetDiffOutput(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("DiffOutput")); err != nil {
				return 0, err
...
// Hash function
func (m *GraphqlApiSummary_ExecutableSchemaSummary) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GraphqlApiSummary_ExecutableSchemaSummary")); err != nil {
		return 0, err
	}

	err = binary.Write(hasher, binary.LittleEndian, m.GetNumResolvers())
	if err != nil {
		return 0, err
	}
...
// Hash function
func (m *GraphqlApiSummary_StitchedSchemaSummary) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GraphqlApiSummary_StitchedSchemaSummary")); err != nil {
		return 0, err
	}

	err = binary.Write(hasher, binary.LittleEndian, m.GetNumSubschemas())
	if err != nil {
		return 0, err
	}
