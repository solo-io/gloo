...
func (m *SubRouteTableRow) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.SubRouteTableRow")); err != nil {
		return 0, err
	}
...
func (m *GetVirtualServiceRoutesRequest) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GetVirtualServiceRoutesRequest")); err != nil {
		return 0, err
	}
...
func (m *GetVirtualServiceRoutesResponse) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rpc.edge.gloo.solo.io.github.com/solo-io/solo-projects/projects/apiserver/pkg/api/rpc.edge.gloo/v1.GetVirtualServiceRoutesResponse")); err != nil {
		return 0, err
	}
