...
func ToMetadata(objectMeta metav1.ObjectMeta) *rpc_v1.ObjectMeta {
	return &rpc_v1.ObjectMeta{
...
func ToObjectMeta(commonMeta rpc_v1.ObjectMeta) metav1.ObjectMeta {
