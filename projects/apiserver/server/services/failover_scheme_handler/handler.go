...
) rpc_fed_v1.FailoverSchemeApiServer {
...
func (k *failoverSchemeHandler) GetFailoverScheme(ctx context.Context, request *rpc_fed_v1.GetFailoverSchemeRequest) (*rpc_fed_v1.GetFailoverSchemeResponse, error) {
	...
	for _, failover := range failovers.Items {
		if failover.Spec.GetPrimary().Equal(request.GetUpstreamRef()) {
			return &rpc_fed_v1.GetFailoverSchemeResponse{
...
func (k *failoverSchemeHandler) GetFailoverSchemeYaml(ctx context.Context, request *rpc_fed_v1.GetFailoverSchemeYamlRequest) (*rpc_fed_v1.GetFailoverSchemeYamlResponse, error) {
	...
	return &rpc_fed_v1.GetFailoverSchemeYamlResponse{
...
func BuildRpcFailoverScheme(failoverScheme fedv1.FailoverScheme) *rpc_fed_v1.FailoverScheme {
	return &rpc_fed_v1.FailoverScheme{
