...
func (obj *FederatedUpstream) NeedsReconcile(placementStatus *mc_types.PlacementStatus) bool {
...
// This implementation is not ideal, as it relies on using the Status of the resource, which should
// be a read-only field. Instead, we could compare the resource hash to the last observed hash
func (obj *FederatedUpstreamGroup) NeedsReconcile(placementStatus *mc_types.PlacementStatus) bool {
...
// This implementation is not ideal, as it relies on using the Status of the resource, which should
// be a read-only field. Instead, we could compare the resource hash to the last observed hash
func (obj *FederatedSettings) NeedsReconcile(placementStatus *mc_types.PlacementStatus) bool {
