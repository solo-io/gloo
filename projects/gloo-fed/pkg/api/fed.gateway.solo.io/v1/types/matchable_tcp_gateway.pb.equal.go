...
// Equal function
func (m *FederatedMatchableTcpGatewaySpec) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}
	...
	if !ok {
		that2, ok := that.(FederatedMatchableTcpGatewaySpec)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *FederatedMatchableTcpGatewayStatus) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*FederatedMatchableTcpGatewayStatus)
	if !ok {
		that2, ok := that.(FederatedMatchableTcpGatewayStatus)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *FederatedMatchableTcpGatewaySpec_Template) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}
	...
	if !ok {
		that2, ok := that.(FederatedMatchableTcpGatewaySpec_Template)
		if ok {
			target = &that2
		} else {
			return false
