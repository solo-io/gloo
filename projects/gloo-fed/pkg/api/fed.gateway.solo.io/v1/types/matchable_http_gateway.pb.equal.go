...
// Equal function
func (m *FederatedMatchableHttpGatewaySpec) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}
	...
	if !ok {
		that2, ok := that.(FederatedMatchableHttpGatewaySpec)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *FederatedMatchableHttpGatewayStatus) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*FederatedMatchableHttpGatewayStatus)
	if !ok {
		that2, ok := that.(FederatedMatchableHttpGatewayStatus)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *FederatedMatchableHttpGatewaySpec_Template) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}
	...
	if !ok {
		that2, ok := that.(FederatedMatchableHttpGatewaySpec_Template)
		if ok {
			target = &that2
		} else {
			return false
