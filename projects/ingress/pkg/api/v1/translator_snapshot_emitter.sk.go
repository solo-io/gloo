...
func NewTranslatorEmitter(upstreamClient gloo_solo_io.UpstreamClient, kubeServiceClient KubeServiceClient, ingressClient IngressClient, resourceNamespaceLister resources.ResourceNamespaceLister) TranslatorEmitter {
	return NewTranslatorEmitterWithEmit(upstreamClient, kubeServiceClient, ingressClient, resourceNamespaceLister, make(chan struct{}))
}

func NewTranslatorEmitterWithEmit(upstreamClient gloo_solo_io.UpstreamClient, kubeServiceClient KubeServiceClient, ingressClient IngressClient, resourceNamespaceLister resources.ResourceNamespaceLister, emit <-chan struct{}) TranslatorEmitter {
