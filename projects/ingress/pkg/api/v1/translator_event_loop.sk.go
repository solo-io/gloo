...
var (
	mTranslatorSnapshotTimeSec     = stats.Float64("translator.ingress.solo.io/sync/time_sec", "The time taken for a given sync", "1")
	mTranslatorSnapshotTimeSecView = &view.View{
		Name:        "translator.ingress.solo.io/sync/time_sec",
