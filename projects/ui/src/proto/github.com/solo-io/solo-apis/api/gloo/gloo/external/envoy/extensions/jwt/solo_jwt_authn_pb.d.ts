...
// file: github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/jwt/solo_jwt_authn.proto
...
export class JwtWithStage extends jspb.Message {
  hasJwtAuthn(): boolean;
  clearJwtAuthn(): void;
  getJwtAuthn(): github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication | undefined;
  setJwtAuthn(value?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication): void;
...
export namespace JwtWithStage {
  export type AsObject = {
    jwtAuthn?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication.AsObject,
    stage: number,
  }
}
