...
goog.exportSymbol('proto.gloo.solo.io.GlooOptions.IstioOptions', null, global);
...
goog.exportSymbol('proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions', null, global);
...
goog.exportSymbol('proto.gloo.solo.io.SettingsSpec.SecretOptions', null, global);
goog.exportSymbol('proto.gloo.solo.io.SettingsSpec.SecretOptions.Source', null, global);
...
proto.gloo.solo.io.SettingsSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    secretOptions: (f = msg.getSecretOptions()) && proto.gloo.solo.io.SettingsSpec.SecretOptions.toObject(includeInstance, f),
...
proto.gloo.solo.io.SettingsSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 38:
      var value = new proto.gloo.solo.io.SettingsSpec.SecretOptions;
      reader.readMessage(value,proto.gloo.solo.io.SettingsSpec.SecretOptions.deserializeBinaryFromReader);
      msg.setSecretOptions(value);
      break;
    case 9:
...
proto.gloo.solo.io.SettingsSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSecretOptions();
  if (f != null) {
    writer.writeMessage(
      38,
      f,
      proto.gloo.solo.io.SettingsSpec.SecretOptions.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.gloo.solo.io.SettingsSpec.SecretOptions.repeatedFields_, null);
};
goog.inherits(proto.gloo.solo.io.SettingsSpec.SecretOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.SettingsSpec.SecretOptions.displayName = 'proto.gloo.solo.io.SettingsSpec.SecretOptions';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.SettingsSpec.SecretOptions.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    sourcesList: jspb.Message.toObjectList(msg.getSourcesList(),
    proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gloo.solo.io.SettingsSpec.SecretOptions}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.SettingsSpec.SecretOptions;
  return proto.gloo.solo.io.SettingsSpec.SecretOptions.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.SettingsSpec.SecretOptions}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.gloo.solo.io.SettingsSpec.SecretOptions.Source;
      reader.readMessage(value,proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.SettingsSpec.SecretOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.oneofGroups_);
};
goog.inherits(proto.gloo.solo.io.SettingsSpec.SecretOptions.Source, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.displayName = 'proto.gloo.solo.io.SettingsSpec.SecretOptions.Source';
}
/**
 * Oneof group definitions for this message. Each group defines the field
 * numbers belonging to that group. When of these fields' value is set, all
 ...
 * @const
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.oneofGroups_ = [[1,2,3]];

/**
 * @enum {number}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.SourceCase = {
  SOURCE_NOT_SET: 0,
  KUBERNETES: 1,
  VAULT: 2,
  DIRECTORY: 3
...
/**
 * @return {proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.SourceCase}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.getSourceCase = function() {
  return /** @type {proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.SourceCase} */(jspb.Message.computeOneofCase(this, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.toObject = function(includeInstance, msg) {
  var f, obj = {
    kubernetes: (f = msg.getKubernetes()) && proto.gloo.solo.io.SettingsSpec.KubernetesSecrets.toObject(includeInstance, f),
    vault: (f = msg.getVault()) && proto.gloo.solo.io.SettingsSpec.VaultSecrets.toObject(includeInstance, f),
    directory: (f = msg.getDirectory()) && proto.gloo.solo.io.SettingsSpec.Directory.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.SettingsSpec.SecretOptions.Source;
  return proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKubernetes();
  if (f != null) {
    writer.writeMessage(
...
/**
 * optional KubernetesSecrets kubernetes = 1;
 * @return {?proto.gloo.solo.io.SettingsSpec.KubernetesSecrets}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.getKubernetes = function() {
  return /** @type{?proto.gloo.solo.io.SettingsSpec.KubernetesSecrets} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.SettingsSpec.KubernetesSecrets, 1));
};


/** @param {?proto.gloo.solo.io.SettingsSpec.KubernetesSecrets|undefined} value */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.setKubernetes = function(value) {
  jspb.Message.setOneofWrapperField(this, 1, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.oneofGroups_[0], value);
};


proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.clearKubernetes = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.hasKubernetes = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional VaultSecrets vault = 2;
 * @return {?proto.gloo.solo.io.SettingsSpec.VaultSecrets}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.getVault = function() {
  return /** @type{?proto.gloo.solo.io.SettingsSpec.VaultSecrets} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.SettingsSpec.VaultSecrets, 2));
};


/** @param {?proto.gloo.solo.io.SettingsSpec.VaultSecrets|undefined} value */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.setVault = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.oneofGroups_[0], value);
};


proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.clearVault = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.hasVault = function() {
 ...
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.getDirectory = function() {
  return /** @type{?proto.gloo.solo.io.SettingsSpec.Directory} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.SettingsSpec.Directory, 3));
};


/** @param {?proto.gloo.solo.io.SettingsSpec.Directory|undefined} value */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.setDirectory = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.oneofGroups_[0], value);
};


proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.clearDirectory = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.Source.prototype.hasDirectory = function() {
 ...
 * @return {!Array<!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source>}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.prototype.getSourcesList = function() {
  return /** @type{!Array<!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source, 1));
};


/** @param {!Array<!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source>} value */
proto.gloo.solo.io.SettingsSpec.SecretOptions.prototype.setSourcesList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source=} opt_value
 * @param {number=} opt_index
 * @return {!proto.gloo.solo.io.SettingsSpec.SecretOptions.Source}
 */
proto.gloo.solo.io.SettingsSpec.SecretOptions.prototype.addSources = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.gloo.solo.io.SettingsSpec.SecretOptions.Source, opt_index);
};


proto.gloo.solo.io.SettingsSpec.SecretOptions.prototype.clearSourcesList = function() {
  this.setSourcesList([]);
};
...
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    fdsOptions: (f = msg.getFdsOptions()) && proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.toObject(includeInstance, f)
  };
...
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions;
      reader.readMessage(value,proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.deserializeBinaryFromReader);
      msg.setFdsOptions(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getFdsOptions();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.displayName = 'proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions';
}
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    graphqlEnabled: (f = msg.getGraphqlEnabled()) && google_protobuf_wrappers_pb.BoolValue.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions;
  return proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getGraphqlEnabled();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
...
/**
 * optional google.protobuf.BoolValue graphql_enabled = 1;
 * @return {?proto.google.protobuf.BoolValue}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.prototype.getGraphqlEnabled = function() {
  return /** @type{?proto.google.protobuf.BoolValue} */ (
    jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.BoolValue, 1));
};
...
/** @param {?proto.google.protobuf.BoolValue|undefined} value */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.prototype.setGraphqlEnabled = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.prototype.clearGraphqlEnabled = function() {
  this.setGraphqlEnabled(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions.prototype.hasGraphqlEnabled = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
/**
 * optional FdsOptions fds_options = 3;
 * @return {?proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.prototype.getFdsOptions = function() {
  return /** @type{?proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions, 3));
};


/** @param {?proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptions|undefined} value */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.prototype.setFdsOptions = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.prototype.clearFdsOptions = function() {
  this.setFdsOptions(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.SettingsSpec.DiscoveryOptions.prototype.hasFdsOptions = function() {
  return jspb.Message.getField(this, 3) != null;
};
...
/**
 * optional SecretOptions secret_options = 38;
 * @return {?proto.gloo.solo.io.SettingsSpec.SecretOptions}
 */
proto.gloo.solo.io.SettingsSpec.prototype.getSecretOptions = function() {
  return /** @type{?proto.gloo.solo.io.SettingsSpec.SecretOptions} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.SettingsSpec.SecretOptions, 38));
};


/** @param {?proto.gloo.solo.io.SettingsSpec.SecretOptions|undefined} value */
proto.gloo.solo.io.SettingsSpec.prototype.setSecretOptions = function(value) {
  jspb.Message.setWrapperField(this, 38, value);
};


proto.gloo.solo.io.SettingsSpec.prototype.clearSecretOptions = function() {
  this.setSecretOptions(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.SettingsSpec.prototype.hasSecretOptions = function() {
...
proto.gloo.solo.io.GlooOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    istioOptions: (f = msg.getIstioOptions()) && proto.gloo.solo.io.GlooOptions.IstioOptions.toObject(includeInstance, f)
  };
...
proto.gloo.solo.io.GlooOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 17:
      ...
      break;
    case 18:
      var value = new proto.gloo.solo.io.GlooOptions.IstioOptions;
      reader.readMessage(value,proto.gloo.solo.io.GlooOptions.IstioOptions.deserializeBinaryFromReader);
      msg.setIstioOptions(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.gloo.solo.io.GlooOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getIstioOptions();
  if (f != null) {
    writer.writeMessage(
      18,
      f,
      proto.gloo.solo.io.GlooOptions.IstioOptions.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.gloo.solo.io.GlooOptions.IstioOptions = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gloo.solo.io.GlooOptions.IstioOptions, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.GlooOptions.IstioOptions.displayName = 'proto.gloo.solo.io.GlooOptions.IstioOptions';
}
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.GlooOptions.IstioOptions.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.GlooOptions.IstioOptions} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gloo.solo.io.GlooOptions.IstioOptions}
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.GlooOptions.IstioOptions;
  return proto.gloo.solo.io.GlooOptions.IstioOptions.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.GlooOptions.IstioOptions} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.GlooOptions.IstioOptions}
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.GlooOptions.IstioOptions.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.GlooOptions.IstioOptions} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * optional google.protobuf.BoolValue append_x_forwarded_host = 1;
 * @return {?proto.google.protobuf.BoolValue}
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.prototype.getAppendXForwardedHost = function() {
  return /** @type{?proto.google.protobuf.BoolValue} */ (
    jspb.Message.getWrapperField(this, google_protobuf_wrappers_pb.BoolValue, 1));
};
...
/** @param {?proto.google.protobuf.BoolValue|undefined} value */
proto.gloo.solo.io.GlooOptions.IstioOptions.prototype.setAppendXForwardedHost = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.gloo.solo.io.GlooOptions.IstioOptions.prototype.clearAppendXForwardedHost = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.GlooOptions.IstioOptions.prototype.hasAppendXForwardedHost = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
/**
 * optional IstioOptions istio_options = 18;
 * @return {?proto.gloo.solo.io.GlooOptions.IstioOptions}
 */
proto.gloo.solo.io.GlooOptions.prototype.getIstioOptions = function() {
  return /** @type{?proto.gloo.solo.io.GlooOptions.IstioOptions} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.GlooOptions.IstioOptions, 18));
};


/** @param {?proto.gloo.solo.io.GlooOptions.IstioOptions|undefined} value */
proto.gloo.solo.io.GlooOptions.prototype.setIstioOptions = function(value) {
  jspb.Message.setWrapperField(this, 18, value);
};


proto.gloo.solo.io.GlooOptions.prototype.clearIstioOptions = function() {
  this.setIstioOptions(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.GlooOptions.prototype.hasIstioOptions = function() {
  return jspb.Message.getField(this, 18) != null;
};
