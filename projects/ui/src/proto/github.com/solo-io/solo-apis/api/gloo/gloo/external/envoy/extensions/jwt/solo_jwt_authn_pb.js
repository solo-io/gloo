...
proto.envoy.config.filter.http.solo_jwt_authn.v2.JwtWithStage.toObject = function(includeInstance, msg) {
  var f, obj = {
    jwtAuthn: (f = msg.getJwtAuthn()) && github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication.toObject(includeInstance, f),
...
proto.envoy.config.filter.http.solo_jwt_authn.v2.JwtWithStage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication.deserializeBinaryFromReader);
...
proto.envoy.config.filter.http.solo_jwt_authn.v2.JwtWithStage.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication.serializeBinaryToWriter
    );
  }
  f = message.getStage();
  if (f !== 0) {
...
proto.envoy.config.filter.http.solo_jwt_authn.v2.JwtWithStage.prototype.getJwtAuthn = function() {
  return /** @type{?proto.solo.io.envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_filters_http_jwt_authn_v3_config_pb.JwtAuthentication, 1));
};
