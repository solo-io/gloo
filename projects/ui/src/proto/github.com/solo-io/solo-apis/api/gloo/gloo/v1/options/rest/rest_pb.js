...
proto.rest.options.gloo.solo.io.DestinationSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    parameters: (f = msg.getParameters()) && github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters.toObject(includeInstance, f),
    responseTransformation: (f = msg.getResponseTransformation()) && github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate.toObject(includeInstance, f)
  };
...
proto.rest.options.gloo.solo.io.DestinationSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters.deserializeBinaryFromReader);
...
proto.rest.options.gloo.solo.io.DestinationSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters.serializeBinaryToWriter
    );
  }
...
proto.rest.options.gloo.solo.io.DestinationSpec.prototype.getParameters = function() {
  return /** @type{?proto.transformation.options.gloo.solo.io.Parameters} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters, 2));
};
...
proto.rest.options.gloo.solo.io.DestinationSpec.prototype.getResponseTransformation = function() {
  return /** @type{?proto.envoy.api.v2.filter.http.TransformationTemplate} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate, 3));
};
