...
proto.gloo.solo.io.ConnectionConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    commonHttpProtocolOptions: (f = msg.getCommonHttpProtocolOptions()) && github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.HttpProtocolOptions.toObject(includeInstance, f),
    http1ProtocolOptions: (f = msg.getHttp1ProtocolOptions()) && github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.Http1ProtocolOptions.toObject(includeInstance, f)
  };
...
proto.gloo.solo.io.ConnectionConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.HttpProtocolOptions;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.HttpProtocolOptions.deserializeBinaryFromReader);
      msg.setCommonHttpProtocolOptions(value);
      break;
    case 6:
      var value = new github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.Http1ProtocolOptions;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.Http1ProtocolOptions.deserializeBinaryFromReader);
...
proto.gloo.solo.io.ConnectionConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.HttpProtocolOptions.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.Http1ProtocolOptions.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional protocol.options.gloo.solo.io.HttpProtocolOptions common_http_protocol_options = 5;
...
proto.gloo.solo.io.ConnectionConfig.prototype.getCommonHttpProtocolOptions = function() {
  return /** @type{?proto.protocol.options.gloo.solo.io.HttpProtocolOptions} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.HttpProtocolOptions, 5));
};


/** @param {?proto.protocol.options.gloo.solo.io.HttpProtocolOptions|undefined} value */
...
/**
 * optional protocol.options.gloo.solo.io.Http1ProtocolOptions http1_protocol_options = 6;
...
proto.gloo.solo.io.ConnectionConfig.prototype.getHttp1ProtocolOptions = function() {
  return /** @type{?proto.protocol.options.gloo.solo.io.Http1ProtocolOptions} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_protocol_protocol_pb.Http1ProtocolOptions, 6));
};


/** @param {?proto.protocol.options.gloo.solo.io.Http1ProtocolOptions|undefined} value */
