...
goog.exportSymbol('proto.gloo.solo.io.AccountCredentialsSecret', null, global);
goog.exportSymbol('proto.gloo.solo.io.AwsSecret', null, global);
goog.exportSymbol('proto.gloo.solo.io.AzureSecret', null, global);
goog.exportSymbol('proto.gloo.solo.io.EncryptionKeySecret', null, global);
 ...
 * @const
 */
proto.gloo.solo.io.Secret.oneofGroups_ = [[1,2,3,5,6,8,9,10,4]];
...
proto.gloo.solo.io.Secret.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    credentials: (f = msg.getCredentials()) && proto.gloo.solo.io.AccountCredentialsSecret.toObject(includeInstance, f),
    encryption: (f = msg.getEncryption()) && proto.gloo.solo.io.EncryptionKeySecret.toObject(includeInstance, f),
...
proto.gloo.solo.io.Secret.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 9:
      var value = new proto.gloo.solo.io.AccountCredentialsSecret;
      reader.readMessage(value,proto.gloo.solo.io.AccountCredentialsSecret.deserializeBinaryFromReader);
      msg.setCredentials(value);
      break;
    case 10:
      var value = new proto.gloo.solo.io.EncryptionKeySecret;
      reader.readMessage(value,proto.gloo.solo.io.EncryptionKeySecret.deserializeBinaryFromReader);
...
proto.gloo.solo.io.Secret.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.gloo.solo.io.AccountCredentialsSecret.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.gloo.solo.io.EncryptionKeySecret.serializeBinaryToWriter
    );
  }
...
/**
 * optional AccountCredentialsSecret credentials = 9;
 * @return {?proto.gloo.solo.io.AccountCredentialsSecret}
 */
proto.gloo.solo.io.Secret.prototype.getCredentials = function() {
  return /** @type{?proto.gloo.solo.io.AccountCredentialsSecret} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.AccountCredentialsSecret, 9));
};


/** @param {?proto.gloo.solo.io.AccountCredentialsSecret|undefined} value */
proto.gloo.solo.io.Secret.prototype.setCredentials = function(value) {
  jspb.Message.setOneofWrapperField(this, 9, proto.gloo.solo.io.Secret.oneofGroups_[0], value);
};


proto.gloo.solo.io.Secret.prototype.clearCredentials = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.Secret.prototype.hasCredentials = function() {
  return jspb.Message.getField(this, 9) != null;
};


/**
 * optional EncryptionKeySecret encryption = 10;
 * @return {?proto.gloo.solo.io.EncryptionKeySecret}
 */
proto.gloo.solo.io.Secret.prototype.getEncryption = function() {
  return /** @type{?proto.gloo.solo.io.EncryptionKeySecret} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.EncryptionKeySecret, 10));
};


/** @param {?proto.gloo.solo.io.EncryptionKeySecret|undefined} value */
proto.gloo.solo.io.Secret.prototype.setEncryption = function(value) {
  jspb.Message.setOneofWrapperField(this, 10, proto.gloo.solo.io.Secret.oneofGroups_[0], value);
};


proto.gloo.solo.io.Secret.prototype.clearEncryption = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.Secret.prototype.hasEncryption = function() {
 ...
 * @constructor
 */
proto.gloo.solo.io.AccountCredentialsSecret = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gloo.solo.io.AccountCredentialsSecret, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.AccountCredentialsSecret.displayName = 'proto.gloo.solo.io.AccountCredentialsSecret';
}
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.AccountCredentialsSecret.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.AccountCredentialsSecret.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.AccountCredentialsSecret} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.AccountCredentialsSecret.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.gloo.solo.io.AccountCredentialsSecret}
 */
proto.gloo.solo.io.AccountCredentialsSecret.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.AccountCredentialsSecret;
  return proto.gloo.solo.io.AccountCredentialsSecret.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.AccountCredentialsSecret} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.AccountCredentialsSecret}
 */
proto.gloo.solo.io.AccountCredentialsSecret.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.AccountCredentialsSecret.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.AccountCredentialsSecret.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.AccountCredentialsSecret} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.AccountCredentialsSecret.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.gloo.solo.io.AccountCredentialsSecret.prototype.getUsername = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.gloo.solo.io.AccountCredentialsSecret.prototype.setUsername = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.gloo.solo.io.AccountCredentialsSecret.prototype.getPassword = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.gloo.solo.io.AccountCredentialsSecret.prototype.setPassword = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @constructor
 */
proto.gloo.solo.io.EncryptionKeySecret = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gloo.solo.io.EncryptionKeySecret, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.EncryptionKeySecret.displayName = 'proto.gloo.solo.io.EncryptionKeySecret';
}
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.EncryptionKeySecret.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.EncryptionKeySecret.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.EncryptionKeySecret} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.EncryptionKeySecret.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.gloo.solo.io.EncryptionKeySecret}
 */
proto.gloo.solo.io.EncryptionKeySecret.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.EncryptionKeySecret;
  return proto.gloo.solo.io.EncryptionKeySecret.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.EncryptionKeySecret} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.EncryptionKeySecret}
 */
proto.gloo.solo.io.EncryptionKeySecret.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.EncryptionKeySecret.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.EncryptionKeySecret.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.EncryptionKeySecret} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.EncryptionKeySecret.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.gloo.solo.io.EncryptionKeySecret.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.gloo.solo.io.EncryptionKeySecret.prototype.setKey = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
