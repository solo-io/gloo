...
/**
 * optional google.protobuf.BoolValue auto_sni_rewrite = 6;
 * @return {?proto.google.protobuf.BoolValue}
 */
proto.static.options.gloo.solo.io.UpstreamSpec.prototype.getAutoSniRewrite = function() {
...
proto.static.options.gloo.solo.io.UpstreamSpec.prototype.setAutoSniRewrite = function(value) {
  jspb.Message.setWrapperField(this, 6, value);
};


proto.static.options.gloo.solo.io.UpstreamSpec.prototype.clearAutoSniRewrite = function() {
  this.setAutoSniRewrite(undefined);
};
 ...
 * @return {!boolean}
 */
proto.static.options.gloo.solo.io.UpstreamSpec.prototype.hasAutoSniRewrite = function() {
...
proto.static.options.gloo.solo.io.Host.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value,proto.static.options.gloo.solo.io.Host.HealthCheckConfig.deserializeBinaryFromReader);
...
proto.static.options.gloo.solo.io.Host.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.static.options.gloo.solo.io.Host.HealthCheckConfig.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.static.options.gloo.solo.io.Host.HealthCheckConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.static.options.gloo.solo.io.Host.HealthCheckConfig.displayName = 'proto.static.options.gloo.solo.io.Host.HealthCheckConfig';
}
 ...
 * @return {!Object}
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.static.options.gloo.solo.io.Host.HealthCheckConfig.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.static.options.gloo.solo.io.Host.HealthCheckConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.static.options.gloo.solo.io.Host.HealthCheckConfig}
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.static.options.gloo.solo.io.Host.HealthCheckConfig;
  return proto.static.options.gloo.solo.io.Host.HealthCheckConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.static.options.gloo.solo.io.Host.HealthCheckConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.static.options.gloo.solo.io.Host.HealthCheckConfig}
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.static.options.gloo.solo.io.Host.HealthCheckConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.static.options.gloo.solo.io.Host.HealthCheckConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPath();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.static.options.gloo.solo.io.Host.HealthCheckConfig.prototype.getPath = function() {
...
/**
 * optional string sni_addr = 4;
 * @return {string}
 */
proto.static.options.gloo.solo.io.Host.prototype.getSniAddr = function() {
 ...
 * @return {?proto.static.options.gloo.solo.io.Host.HealthCheckConfig}
 */
proto.static.options.gloo.solo.io.Host.prototype.getHealthCheckConfig = function() {
  return /** @type{?proto.static.options.gloo.solo.io.Host.HealthCheckConfig} */ (
    jspb.Message.getWrapperField(this, proto.static.options.gloo.solo.io.Host.HealthCheckConfig, 3));
};


/** @param {?proto.static.options.gloo.solo.io.Host.HealthCheckConfig|undefined} value */
proto.static.options.gloo.solo.io.Host.prototype.setHealthCheckConfig = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.static.options.gloo.solo.io.Host.prototype.clearHealthCheckConfig = function() {
 ...
 * @return {!boolean}
 */
proto.static.options.gloo.solo.io.Host.prototype.hasHealthCheckConfig = function() {
