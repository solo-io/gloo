...
// file: github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/api/v2/route/route.proto
...
export class HeaderMatcher extends jspb.Message {
  ...
  getRangeMatch(): github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_range_pb.Int64Range | undefined;
  setRangeMatch(value?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_range_pb.Int64Range): void;
...
export namespace HeaderMatcher {
  export type AsObject = {
    ...
    exactMatch: string,
    regexMatch: string,
    rangeMatch?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_range_pb.Int64Range.AsObject,
