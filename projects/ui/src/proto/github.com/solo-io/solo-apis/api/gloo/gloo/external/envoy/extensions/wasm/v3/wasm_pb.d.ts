...
// file: github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/wasm/v3/wasm.proto
...
export class VmConfig extends jspb.Message {
  ...
  hasCode(): boolean;
  clearCode(): void;
  getCode(): github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.AsyncDataSource | undefined;
  setCode(value?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.AsyncDataSource): void;
...
export namespace VmConfig {
  export type AsObject = {
    vmId: string,
    runtime: string,
    code?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.AsyncDataSource.AsObject,
