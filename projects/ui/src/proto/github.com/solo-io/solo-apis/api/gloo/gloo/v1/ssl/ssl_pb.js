...
goog.exportSymbol('proto.gloo.solo.io.SslConfig.OcspStaplePolicy', null, global);
...
proto.gloo.solo.io.SslConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ocspStaplePolicy: jspb.Message.getFieldWithDefault(msg, 11, 0)
  };
...
proto.gloo.solo.io.SslConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = /** @type {!proto.gloo.solo.io.SslConfig.OcspStaplePolicy} */ (reader.readEnum());
      msg.setOcspStaplePolicy(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @enum {number}
 */
proto.gloo.solo.io.SslConfig.OcspStaplePolicy = {
  LENIENT_STAPLING: 0,
  STRICT_STAPLING: 1,
  MUST_STAPLE: 2
};
...
/**
 * optional OcspStaplePolicy ocsp_staple_policy = 11;
 * @return {!proto.gloo.solo.io.SslConfig.OcspStaplePolicy}
 */
proto.gloo.solo.io.SslConfig.prototype.getOcspStaplePolicy = function() {
  return /** @type {!proto.gloo.solo.io.SslConfig.OcspStaplePolicy} */ (jspb.Message.getFieldWithDefault(this, 11, 0));
};


/** @param {!proto.gloo.solo.io.SslConfig.OcspStaplePolicy} value */
proto.gloo.solo.io.SslConfig.prototype.setOcspStaplePolicy = function(value) {
...
proto.gloo.solo.io.SSLFiles.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ocspStaple: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
/**
 * optional string ocsp_staple = 4;
 * @return {string}
 */
proto.gloo.solo.io.SSLFiles.prototype.getOcspStaple = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.gloo.solo.io.SSLFiles.prototype.setOcspStaple = function(value) {
