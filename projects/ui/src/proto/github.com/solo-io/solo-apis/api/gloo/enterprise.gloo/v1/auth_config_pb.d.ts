...
export namespace ExtAuthConfig {
  ...
  export class OidcAuthorizationCodeConfig extends jspb.Message {
    ...
    hasAccessToken(): boolean;
    clearAccessToken(): void;
    getAccessToken(): ExtAuthConfig.OidcAuthorizationCodeConfig.AccessToken | undefined;
    setAccessToken(value?: ExtAuthConfig.OidcAuthorizationCodeConfig.AccessToken): void;
  ...
  export namespace OidcAuthorizationCodeConfig {
    ...
    export class AccessToken extends jspb.Message {
      clearClaimsToHeadersList(): void;
      getClaimsToHeadersList(): Array<ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader>;
      setClaimsToHeadersList(value: Array<ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader>): void;
      addClaimsToHeaders(value?: ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader, index?: number): ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader;
