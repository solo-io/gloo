...
goog.exportSymbol('proto.consul.options.gloo.solo.io.UpstreamSpec.ConsulConsistencyModes', null, global);
...
proto.consul.options.gloo.solo.io.UpstreamSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 9:
      var value = /** @type {!proto.consul.options.gloo.solo.io.UpstreamSpec.ConsulConsistencyModes} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.consul.options.gloo.solo.io.UpstreamSpec.ConsulConsistencyModes = {
  CONSISTENTMODE: 0,
  DEFAULTMODE: 2,
  STALEMODE: 1
};
 ...
 * @return {!proto.consul.options.gloo.solo.io.UpstreamSpec.ConsulConsistencyModes}
 */
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.getConsistencymode = function() {
  return /** @type {!proto.consul.options.gloo.solo.io.UpstreamSpec.ConsulConsistencyModes} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};


/** @param {!proto.consul.options.gloo.solo.io.UpstreamSpec.ConsulConsistencyModes} value */
