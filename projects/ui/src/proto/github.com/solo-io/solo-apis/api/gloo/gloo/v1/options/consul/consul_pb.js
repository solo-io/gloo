...
proto.consul.options.gloo.solo.io.UpstreamSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    consistencymode: jspb.Message.getFieldWithDefault(msg, 9, 0),
...
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.getServiceSpec = function() {
  return /** @type{?proto.options.gloo.solo.io.ServiceSpec} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_service_spec_pb.ServiceSpec, 3));
};
...
/**
 * optional ConsulConsistencyModes consistencyMode = 9;
 * @return {!proto.consul.options.gloo.solo.io.ConsulConsistencyModes}
 */
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.getConsistencymode = function() {
  return /** @type {!proto.consul.options.gloo.solo.io.ConsulConsistencyModes} */ (jspb.Message.getFieldWithDefault(this, 9, 0));
};


/** @param {!proto.consul.options.gloo.solo.io.ConsulConsistencyModes} value */
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.setConsistencymode = function(value) {
  jspb.Message.setProto3EnumField(this, 9, value);
};


/**
 * optional QueryOptions query_options = 10;
 * @return {?proto.consul.options.gloo.solo.io.QueryOptions}
 */
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.getQueryOptions = function() {
  return /** @type{?proto.consul.options.gloo.solo.io.QueryOptions} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_v1_options_consul_query_options_pb.QueryOptions, 10));
};


/** @param {?proto.consul.options.gloo.solo.io.QueryOptions|undefined} value */
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.setQueryOptions = function(value) {
  jspb.Message.setWrapperField(this, 10, value);
};


proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.clearQueryOptions = function() {
 ...
 * @return {!boolean}
 */
proto.consul.options.gloo.solo.io.UpstreamSpec.prototype.hasQueryOptions = function() {
