...
// file: github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/type/tracing/v3/custom_tag.proto
...
export namespace CustomTag {
  ...
  export class Metadata extends jspb.Message {
    hasKind(): boolean;
    clearKind(): void;
    getKind(): github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_metadata_v3_metadata_pb.MetadataKind | undefined;
    setKind(value?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_metadata_v3_metadata_pb.MetadataKind): void;
  ...
  export namespace Metadata {
    export type AsObject = {
      kind?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_metadata_v3_metadata_pb.MetadataKind.AsObject,
