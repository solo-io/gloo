...
goog.exportSymbol('proto.dlp.options.gloo.solo.io.KeyValueAction', null, global);
...
proto.dlp.options.gloo.solo.io.Action.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    keyValueAction: (f = msg.getKeyValueAction()) && proto.dlp.options.gloo.solo.io.KeyValueAction.toObject(includeInstance, f),
...
proto.dlp.options.gloo.solo.io.Action.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 4:
      var value = new proto.dlp.options.gloo.solo.io.KeyValueAction;
      reader.readMessage(value,proto.dlp.options.gloo.solo.io.KeyValueAction.deserializeBinaryFromReader);
      msg.setKeyValueAction(value);
      break;
    case 3:
...
proto.dlp.options.gloo.solo.io.Action.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getKeyValueAction();
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.dlp.options.gloo.solo.io.KeyValueAction.serializeBinaryToWriter
    );
  }
  f = message.getShadow();
  if (f) {
...
/**
 * optional KeyValueAction key_value_action = 4;
 * @return {?proto.dlp.options.gloo.solo.io.KeyValueAction}
 */
proto.dlp.options.gloo.solo.io.Action.prototype.getKeyValueAction = function() {
  return /** @type{?proto.dlp.options.gloo.solo.io.KeyValueAction} */ (
    jspb.Message.getWrapperField(this, proto.dlp.options.gloo.solo.io.KeyValueAction, 4));
};


/** @param {?proto.dlp.options.gloo.solo.io.KeyValueAction|undefined} value */
proto.dlp.options.gloo.solo.io.Action.prototype.setKeyValueAction = function(value) {
  jspb.Message.setWrapperField(this, 4, value);
};


proto.dlp.options.gloo.solo.io.Action.prototype.clearKeyValueAction = function() {
  this.setKeyValueAction(undefined);
};
 ...
 * @return {!boolean}
 */
proto.dlp.options.gloo.solo.io.Action.prototype.hasKeyValueAction = function() {
 ...
 * @constructor
 */
proto.dlp.options.gloo.solo.io.KeyValueAction = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.dlp.options.gloo.solo.io.KeyValueAction, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.dlp.options.gloo.solo.io.KeyValueAction.displayName = 'proto.dlp.options.gloo.solo.io.KeyValueAction';
}
 ...
 * @return {!Object}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.toObject = function(opt_includeInstance) {
  return proto.dlp.options.gloo.solo.io.KeyValueAction.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.dlp.options.gloo.solo.io.KeyValueAction} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, ""),
    maskChar: jspb.Message.getFieldWithDefault(msg, 2, ""),
    percent: (f = msg.getPercent()) && github_com_solo$io_solo$kit_api_external_envoy_type_percent_pb.Percent.toObject(includeInstance, f),
    keyToMask: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
 ...
 * @return {!proto.dlp.options.gloo.solo.io.KeyValueAction}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.dlp.options.gloo.solo.io.KeyValueAction;
  return proto.dlp.options.gloo.solo.io.KeyValueAction.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.dlp.options.gloo.solo.io.KeyValueAction} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.dlp.options.gloo.solo.io.KeyValueAction}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.dlp.options.gloo.solo.io.KeyValueAction.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.dlp.options.gloo.solo.io.KeyValueAction} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.setName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string mask_char = 2;
 * @return {string}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.getMaskChar = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.setMaskChar = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional solo.io.envoy.type.Percent percent = 3;
 * @return {?proto.solo.io.envoy.type.Percent}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.getPercent = function() {
  return /** @type{?proto.solo.io.envoy.type.Percent} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$kit_api_external_envoy_type_percent_pb.Percent, 3));
};


/** @param {?proto.solo.io.envoy.type.Percent|undefined} value */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.setPercent = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.clearPercent = function() {
  this.setPercent(undefined);
};
 ...
 * @return {!boolean}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.hasPercent = function() {
  return jspb.Message.getField(this, 3) != null;
};


/**
 * optional string key_to_mask = 4;
 * @return {string}
 */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.getKeyToMask = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};


/** @param {string} value */
proto.dlp.options.gloo.solo.io.KeyValueAction.prototype.setKeyToMask = function(value) {
