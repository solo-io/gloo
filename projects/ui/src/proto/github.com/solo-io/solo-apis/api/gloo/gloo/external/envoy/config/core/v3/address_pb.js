...
var github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_config_core_v3_socket_option_pb = require('../../../../../../../../../../../github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/core/v3/socket_option_pb.js');
...
proto.solo.io.envoy.config.core.v3.BindConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_config_core_v3_socket_option_pb.SocketOption.toObject, includeInstance)
  };
...
proto.solo.io.envoy.config.core.v3.BindConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_config_core_v3_socket_option_pb.SocketOption;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_config_core_v3_socket_option_pb.SocketOption.deserializeBinaryFromReader);
...
proto.solo.io.envoy.config.core.v3.BindConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_config_core_v3_socket_option_pb.SocketOption.serializeBinaryToWriter
    );
  }
};
...
proto.solo.io.envoy.config.core.v3.BindConfig.prototype.getSocketOptionsList = function() {
  return /** @type{!Array<!proto.solo.io.envoy.config.core.v3.SocketOption>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_config_core_v3_socket_option_pb.SocketOption, 3));
};
