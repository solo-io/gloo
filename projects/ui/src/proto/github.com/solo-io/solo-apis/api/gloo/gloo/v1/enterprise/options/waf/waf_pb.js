...
proto.waf.options.gloo.solo.io.Settings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      reader.readMessage(value,github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_waf_waf_pb.AuditLogging.deserializeBinaryFromReader);
...
proto.waf.options.gloo.solo.io.Settings.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_waf_waf_pb.AuditLogging.serializeBinaryToWriter
    );
  }
...
proto.waf.options.gloo.solo.io.Settings.prototype.getRuleSetsList = function() {
  return /** @type{!Array<!proto.envoy.config.filter.http.modsecurity.v2.RuleSet>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_waf_waf_pb.RuleSet, 4));
};
...
proto.waf.options.gloo.solo.io.Settings.prototype.getAuditLogging = function() {
  return /** @type{?proto.envoy.config.filter.http.modsecurity.v2.AuditLogging} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_gloo_gloo_external_envoy_extensions_waf_waf_pb.AuditLogging, 5));
};
