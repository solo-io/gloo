...
goog.exportSymbol('proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher', null, global);
 ...
 * @const
 */
proto.matchers.core.gloo.solo.io.Matcher.oneofGroups_ = [[1,2,3,9]];
...
proto.matchers.core.gloo.solo.io.Matcher.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    connectMatcher: (f = msg.getConnectMatcher()) && proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.toObject(includeInstance, f),
...
proto.matchers.core.gloo.solo.io.Matcher.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 9:
      var value = new proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher;
      reader.readMessage(value,proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.deserializeBinaryFromReader);
...
proto.matchers.core.gloo.solo.io.Matcher.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.serializeBinaryToWriter
    );
  }
 ...
 * @constructor
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.displayName = 'proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher';
}
 ...
 * @return {!Object}
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.prototype.toObject = function(opt_includeInstance) {
  return proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher}
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher;
  return proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher}
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
...
/**
 * optional ConnectMatcher connect_matcher = 9;
 * @return {?proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher}
 */
proto.matchers.core.gloo.solo.io.Matcher.prototype.getConnectMatcher = function() {
  return /** @type{?proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher} */ (
    jspb.Message.getWrapperField(this, proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher, 9));
};


/** @param {?proto.matchers.core.gloo.solo.io.Matcher.ConnectMatcher|undefined} value */
proto.matchers.core.gloo.solo.io.Matcher.prototype.setConnectMatcher = function(value) {
  jspb.Message.setOneofWrapperField(this, 9, proto.matchers.core.gloo.solo.io.Matcher.oneofGroups_[0], value);
};


proto.matchers.core.gloo.solo.io.Matcher.prototype.clearConnectMatcher = function() {
 ...
 * @return {!boolean}
 */
proto.matchers.core.gloo.solo.io.Matcher.prototype.hasConnectMatcher = function() {
