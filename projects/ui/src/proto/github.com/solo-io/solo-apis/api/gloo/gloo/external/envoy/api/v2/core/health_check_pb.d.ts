...
// file: github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/api/v2/core/health_check.proto
...
export namespace HealthCheck {
  ...
  export class HttpHealthCheck extends jspb.Message {
    ...
    getExpectedStatusesList(): Array<github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_range_pb.Int64Range>;
    ...
    getMethod(): github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.RequestMethodMap[keyof github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.RequestMethodMap];
    setMethod(value: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.RequestMethodMap[keyof github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.RequestMethodMap]): void;
  ...
  export namespace HttpHealthCheck {
    export type AsObject = {
      ...
      method: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.RequestMethodMap[keyof github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_base_pb.RequestMethodMap],
    }
  }
