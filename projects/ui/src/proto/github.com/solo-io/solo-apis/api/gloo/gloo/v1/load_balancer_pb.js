...
goog.exportSymbol('proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig', null, global);
...
proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.toObject = function(includeInstance, msg) {
  var f, obj = {
    slowStartConfig: (f = msg.getSlowStartConfig()) && proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.toObject(includeInstance, f)
  };
...
proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig;
      reader.readMessage(value,proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.deserializeBinaryFromReader);
      msg.setSlowStartConfig(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSlowStartConfig();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional SlowStartConfig slow_start_config = 1;
 * @return {?proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig}
 */
proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.prototype.getSlowStartConfig = function() {
  return /** @type{?proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig, 1));
};


/** @param {?proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig|undefined} value */
proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.prototype.setSlowStartConfig = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.prototype.clearSlowStartConfig = function() {
  this.setSlowStartConfig(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.LoadBalancerConfig.RoundRobin.prototype.hasSlowStartConfig = function() {
...
/**
 * optional SlowStartConfig slow_start_config = 2;
 * @return {?proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig}
 */
proto.gloo.solo.io.LoadBalancerConfig.LeastRequest.prototype.getSlowStartConfig = function() {
  return /** @type{?proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig} */ (
    jspb.Message.getWrapperField(this, proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig, 2));
};


/** @param {?proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig|undefined} value */
proto.gloo.solo.io.LoadBalancerConfig.LeastRequest.prototype.setSlowStartConfig = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.gloo.solo.io.LoadBalancerConfig.LeastRequest.prototype.clearSlowStartConfig = function() {
  this.setSlowStartConfig(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.LoadBalancerConfig.LeastRequest.prototype.hasSlowStartConfig = function() {
 ...
 * @constructor
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.displayName = 'proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig';
}
 ...
 * @return {!Object}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    slowStartWindow: (f = msg.getSlowStartWindow()) && google_protobuf_duration_pb.Duration.toObject(includeInstance, f),
    aggression: (f = msg.getAggression()) && google_protobuf_wrappers_pb.DoubleValue.toObject(includeInstance, f),
    minWeightPercent: (f = msg.getMinWeightPercent()) && google_protobuf_wrappers_pb.DoubleValue.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig;
  return proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSlowStartWindow();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
...
/**
 * optional google.protobuf.Duration slow_start_window = 1;
 * @return {?proto.google.protobuf.Duration}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.getSlowStartWindow = function() {
...
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.setSlowStartWindow = function(value) {
  jspb.Message.setWrapperField(this, 1, value);
};


proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.clearSlowStartWindow = function() {
  this.setSlowStartWindow(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.hasSlowStartWindow = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional google.protobuf.DoubleValue aggression = 2;
 * @return {?proto.google.protobuf.DoubleValue}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.getAggression = function() {
...
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.setAggression = function(value) {
  jspb.Message.setWrapperField(this, 2, value);
};


proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.clearAggression = function() {
  this.setAggression(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.hasAggression = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional google.protobuf.DoubleValue min_weight_percent = 3;
 * @return {?proto.google.protobuf.DoubleValue}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.getMinWeightPercent = function() {
  return /** @type{?proto.google.protobuf.DoubleValue} */ (
...
/** @param {?proto.google.protobuf.DoubleValue|undefined} value */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.setMinWeightPercent = function(value) {
  jspb.Message.setWrapperField(this, 3, value);
};


proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.clearMinWeightPercent = function() {
  this.setMinWeightPercent(undefined);
};
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.LoadBalancerConfig.SlowStartConfig.prototype.hasMinWeightPercent = function() {
