...
// file: github.com/solo-io/solo-apis/api/gloo/gloo/v1/options/rest/rest.proto
...
export class ServiceSpec extends jspb.Message {
  getTransformationsMap(): jspb.Map<string, github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate>;
...
export namespace ServiceSpec {
  export type AsObject = {
    transformationsMap: Array<[string, github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate.AsObject]>,
...
export class DestinationSpec extends jspb.Message {
  ...
  getParameters(): github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters | undefined;
  setParameters(value?: github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters): void;

  hasResponseTransformation(): boolean;
  clearResponseTransformation(): void;
  getResponseTransformation(): github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate | undefined;
  setResponseTransformation(value?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate): void;
...
export namespace DestinationSpec {
  export type AsObject = {
    functionName: string,
    parameters?: github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_transformation_parameters_pb.Parameters.AsObject,
    responseTransformation?: github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_transformation_transformation_pb.TransformationTemplate.AsObject,
  }
}
