...
GraphqlConfigApi.GetStitchedSchemaDefinition = {
  methodName: "GetStitchedSchemaDefinition",
  service: GraphqlConfigApi,
  requestStream: false,
  responseStream: false,
  requestType: github_com_solo_io_solo_projects_projects_apiserver_api_rpc_edge_gloo_v1_graphql_pb.GetStitchedSchemaDefinitionRequest,
...
GraphqlConfigApiClient.prototype.getStitchedSchemaDefinition = function getStitchedSchemaDefinition(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
