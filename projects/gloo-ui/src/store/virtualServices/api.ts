...
import { IngressRateLimit, RateLimit } from 'proto/github.com/solo-io/gloo/projects/gloo/api/v1/enterprise/plugins/ratelimit/ratelimit_pb';
...
import { DestinationSpec, RoutePlugins } from 'proto/github.com/solo-io/gloo/projects/gloo/api/v1/plugins_pb';
import { Destination, HeaderMatcher, Matcher, QueryParameterMatcher, RouteAction } from 'proto/github.com/solo-io/gloo/projects/gloo/api/v1/proxy_pb';
import { CallCredentials, SDSConfig, SslConfig, SSLFiles, SslParameters } from 'proto/github.com/solo-io/gloo/projects/gloo/api/v1/ssl_pb';
import { ResourceRef } from 'proto/github.com/solo-io/solo-kit/api/v1/ref_pb';
import { EditedResourceYaml } from 'proto/github.com/solo-io/solo-projects/projects/grpcserver/api/v1/types_pb';
import { CreateRouteRequest, CreateRouteResponse, CreateVirtualServiceRequest, CreateVirtualServiceResponse, DeleteRouteRequest, DeleteRouteResponse, DeleteVirtualServiceRequest, DeleteVirtualServiceResponse, ExtAuthInput, GetVirtualServiceRequest, GetVirtualServiceResponse, IngressRateLimitValue, ListVirtualServicesRequest, ListVirtualServicesResponse, RepeatedRoutes, RepeatedStrings, RouteInput, ShiftRoutesRequest, ShiftRoutesResponse, SslConfigValue, SwapRoutesRequest, SwapRoutesResponse, UpdateVirtualServiceRequest, UpdateVirtualServiceResponse, UpdateVirtualServiceYamlRequest, VirtualServiceInputV2 } from 'proto/github.com/solo-io/solo-projects/projects/grpcserver/api/v1/virtualservice_pb';
