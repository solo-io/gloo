...
// file: envoy/extensions/transformation/transformation.proto

import * as jspb from "google-protobuf";
import * as gogoproto_gogo_pb from "../../../gogoproto/gogo_pb";
import * as google_protobuf_empty_pb from "google-protobuf/google/protobuf/empty_pb";
import * as validate_validate_pb from "../../../validate/validate_pb";
import * as envoy_config_route_v3_route_components_pb from "../../../envoy/config/route/v3/route_components_pb";
...
export class TransformationRule extends jspb.Message {
  hasMatch(): boolean;
  clearMatch(): void;
  getMatch(): envoy_config_route_v3_route_components_pb.RouteMatch | undefined;
  setMatch(value?: envoy_config_route_v3_route_components_pb.RouteMatch): void;
...
export namespace TransformationRule {
  export type AsObject = {
    match?: envoy_config_route_v3_route_components_pb.RouteMatch.AsObject,
...
export class ResponseMatcher extends jspb.Message {
  ...
  getHeadersList(): Array<envoy_config_route_v3_route_components_pb.HeaderMatcher>;
  setHeadersList(value: Array<envoy_config_route_v3_route_components_pb.HeaderMatcher>): void;
  addHeaders(value?: envoy_config_route_v3_route_components_pb.HeaderMatcher, index?: number): envoy_config_route_v3_route_components_pb.HeaderMatcher;

  hasResponseCodeDetails(): boolean;
  clearResponseCodeDetails(): void;
  getResponseCodeDetails(): envoy_type_matcher_v3_string_pb.StringMatcher | undefined;
  setResponseCodeDetails(value?: envoy_type_matcher_v3_string_pb.StringMatcher): void;
...
export namespace ResponseMatcher {
  export type AsObject = {
    headersList: Array<envoy_config_route_v3_route_components_pb.HeaderMatcher.AsObject>,
    responseCodeDetails?: envoy_type_matcher_v3_string_pb.StringMatcher.AsObject,
  }
}
