...
// file: envoy/config/route/v3/route_components.proto

import * as jspb from "google-protobuf";
import * as envoy_config_core_v3_base_pb from "../../../../envoy/config/core/v3/base_pb";
import * as envoy_config_core_v3_extension_pb from "../../../../envoy/config/core/v3/extension_pb";
import * as envoy_config_core_v3_proxy_protocol_pb from "../../../../envoy/config/core/v3/proxy_protocol_pb";
...
import * as envoy_type_tracing_v3_custom_tag_pb from "../../../../envoy/type/tracing/v3/custom_tag_pb";
...
export class VirtualHost extends jspb.Message {
  ...
  getResponseHeadersToAddList(): Array<envoy_config_core_v3_base_pb.HeaderValueOption>;
  setResponseHeadersToAddList(value: Array<envoy_config_core_v3_base_pb.HeaderValueOption>): void;
  addResponseHeadersToAdd(value?: envoy_config_core_v3_base_pb.HeaderValueOption, index?: number): envoy_config_core_v3_base_pb.HeaderValueOption;
...
export namespace VirtualHost {
  export type AsObject = {
    ...
    responseHeadersToAddList: Array<envoy_config_core_v3_base_pb.HeaderValueOption.AsObject>,
...
export class Route extends jspb.Message {
  ...
  hasMetadata(): boolean;
  clearMetadata(): void;
  getMetadata(): envoy_config_core_v3_base_pb.Metadata | undefined;
  setMetadata(value?: envoy_config_core_v3_base_pb.Metadata): void;
...
export namespace Route {
  export type AsObject = {
    ...
    metadata?: envoy_config_core_v3_base_pb.Metadata.AsObject,
...
export namespace WeightedCluster {
  ...
  export class ClusterWeight extends jspb.Message {
    ...
    getMetadataMatch(): envoy_config_core_v3_base_pb.Metadata | undefined;
    setMetadataMatch(value?: envoy_config_core_v3_base_pb.Metadata): void;
  ...
  export namespace ClusterWeight {
    export type AsObject = {
      ...
      metadataMatch?: envoy_config_core_v3_base_pb.Metadata.AsObject,
      requestHeadersToAddList: Array<envoy_config_core_v3_base_pb.HeaderValueOption.AsObject>,
      requestHeadersToRemoveList: Array<string>,
      responseHeadersToAddList: Array<envoy_config_core_v3_base_pb.HeaderValueOption.AsObject>,
      responseHeadersToRemoveList: Array<string>,
...
export class RouteMatch extends jspb.Message {
  ...
  getRuntimeFraction(): envoy_config_core_v3_base_pb.RuntimeFractionalPercent | undefined;
  setRuntimeFraction(value?: envoy_config_core_v3_base_pb.RuntimeFractionalPercent): void;
...
export namespace RouteMatch {
  export type AsObject = {
    ...
    runtimeFraction?: envoy_config_core_v3_base_pb.RuntimeFractionalPercent.AsObject,
...
export class CorsPolicy extends jspb.Message {
  ...
  getAllowOriginStringMatchList(): Array<envoy_type_matcher_v3_string_pb.StringMatcher>;
  setAllowOriginStringMatchList(value: Array<envoy_type_matcher_v3_string_pb.StringMatcher>): void;
  addAllowOriginStringMatch(value?: envoy_type_matcher_v3_string_pb.StringMatcher, index?: number): envoy_type_matcher_v3_string_pb.StringMatcher;
  ...
  getShadowEnabled(): envoy_config_core_v3_base_pb.RuntimeFractionalPercent | undefined;
  setShadowEnabled(value?: envoy_config_core_v3_base_pb.RuntimeFractionalPercent): void;
...
export namespace CorsPolicy {
  export type AsObject = {
    allowOriginStringMatchList: Array<envoy_type_matcher_v3_string_pb.StringMatcher.AsObject>,
    allowMethods: string,
    allowHeaders: string,
    ...
    shadowEnabled?: envoy_config_core_v3_base_pb.RuntimeFractionalPercent.AsObject,
  }
...
export class RouteAction extends jspb.Message {
  ...
  getRegexRewrite(): envoy_type_matcher_v3_regex_pb.RegexMatchAndSubstitute | undefined;
  setRegexRewrite(value?: envoy_type_matcher_v3_regex_pb.RegexMatchAndSubstitute): void;
  ...
  getPriority(): envoy_config_core_v3_base_pb.RoutingPriorityMap[keyof envoy_config_core_v3_base_pb.RoutingPriorityMap];
  setPriority(value: envoy_config_core_v3_base_pb.RoutingPriorityMap[keyof envoy_config_core_v3_base_pb.RoutingPriorityMap]): void;
...
export namespace RouteAction {
  export type AsObject = {
    ...
    regexRewrite?: envoy_type_matcher_v3_regex_pb.RegexMatchAndSubstitute.AsObject,
    ...
    priority: envoy_config_core_v3_base_pb.RoutingPriorityMap[keyof envoy_config_core_v3_base_pb.RoutingPriorityMap],
    rateLimitsList: Array<RateLimit.AsObject>,
  ...
  export namespace UpgradeConfig {
    ...
    export class ConnectConfig extends jspb.Message {
      ...
      getProxyProtocolConfig(): envoy_config_core_v3_proxy_protocol_pb.ProxyProtocolConfig | undefined;
      setProxyProtocolConfig(value?: envoy_config_core_v3_proxy_protocol_pb.ProxyProtocolConfig): void;
    ...
    export namespace ConnectConfig {
      export type AsObject = {
        proxyProtocolConfig?: envoy_config_core_v3_proxy_protocol_pb.ProxyProtocolConfig.AsObject,
      }
    }
  }
...
export class HedgePolicy extends jspb.Message {
  ...
  getAdditionalRequestChance(): envoy_type_v3_percent_pb.FractionalPercent | undefined;
  setAdditionalRequestChance(value?: envoy_type_v3_percent_pb.FractionalPercent): void;
...
export namespace HedgePolicy {
  export type AsObject = {
    ...
    additionalRequestChance?: envoy_type_v3_percent_pb.FractionalPercent.AsObject,
...
export class DirectResponseAction extends jspb.Message {
  ...
  hasBody(): boolean;
  clearBody(): void;
  getBody(): envoy_config_core_v3_base_pb.DataSource | undefined;
  setBody(value?: envoy_config_core_v3_base_pb.DataSource): void;
...
export namespace DirectResponseAction {
  export type AsObject = {
    status: number,
    body?: envoy_config_core_v3_base_pb.DataSource.AsObject,
  }
}
...
export class Tracing extends jspb.Message {
  ...
  getClientSampling(): envoy_type_v3_percent_pb.FractionalPercent | undefined;
  setClientSampling(value?: envoy_type_v3_percent_pb.FractionalPercent): void;

  hasRandomSampling(): boolean;
  clearRandomSampling(): void;
  getRandomSampling(): envoy_type_v3_percent_pb.FractionalPercent | undefined;
  setRandomSampling(value?: envoy_type_v3_percent_pb.FractionalPercent): void;

  hasOverallSampling(): boolean;
  clearOverallSampling(): void;
  getOverallSampling(): envoy_type_v3_percent_pb.FractionalPercent | undefined;
  setOverallSampling(value?: envoy_type_v3_percent_pb.FractionalPercent): void;

  clearCustomTagsList(): void;
  getCustomTagsList(): Array<envoy_type_tracing_v3_custom_tag_pb.CustomTag>;
  setCustomTagsList(value: Array<envoy_type_tracing_v3_custom_tag_pb.CustomTag>): void;
  addCustomTags(value?: envoy_type_tracing_v3_custom_tag_pb.CustomTag, index?: number): envoy_type_tracing_v3_custom_tag_pb.CustomTag;
...
export namespace Tracing {
  export type AsObject = {
    clientSampling?: envoy_type_v3_percent_pb.FractionalPercent.AsObject,
    randomSampling?: envoy_type_v3_percent_pb.FractionalPercent.AsObject,
    overallSampling?: envoy_type_v3_percent_pb.FractionalPercent.AsObject,
    customTagsList: Array<envoy_type_tracing_v3_custom_tag_pb.CustomTag.AsObject>,
  }
}
...
export class HeaderMatcher extends jspb.Message {
  ...
  getSafeRegexMatch(): envoy_type_matcher_v3_regex_pb.RegexMatcher | undefined;
  setSafeRegexMatch(value?: envoy_type_matcher_v3_regex_pb.RegexMatcher): void;

  hasRangeMatch(): boolean;
  clearRangeMatch(): void;
  getRangeMatch(): envoy_type_v3_range_pb.Int64Range | undefined;
  setRangeMatch(value?: envoy_type_v3_range_pb.Int64Range): void;
...
export namespace HeaderMatcher {
  export type AsObject = {
    name: string,
    exactMatch: string,
    safeRegexMatch?: envoy_type_matcher_v3_regex_pb.RegexMatcher.AsObject,
    rangeMatch?: envoy_type_v3_range_pb.Int64Range.AsObject,
...
export class InternalRedirectPolicy extends jspb.Message {
  ...
  getPredicatesList(): Array<envoy_config_core_v3_extension_pb.TypedExtensionConfig>;
  setPredicatesList(value: Array<envoy_config_core_v3_extension_pb.TypedExtensionConfig>): void;
  addPredicates(value?: envoy_config_core_v3_extension_pb.TypedExtensionConfig, index?: number): envoy_config_core_v3_extension_pb.TypedExtensionConfig;
...
export namespace InternalRedirectPolicy {
  export type AsObject = {
    ...
    predicatesList: Array<envoy_config_core_v3_extension_pb.TypedExtensionConfig.AsObject>,
