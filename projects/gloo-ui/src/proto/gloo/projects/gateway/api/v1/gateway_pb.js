...
proto.gateway.solo.io.Gateway.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    options: (f = msg.getOptions()) && gloo_projects_gloo_api_v1_options_pb.ListenerOptions.toObject(includeInstance, f),
...
proto.gateway.solo.io.Gateway.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new gloo_projects_gloo_api_v1_options_pb.ListenerOptions;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_pb.ListenerOptions.deserializeBinaryFromReader);
...
proto.gateway.solo.io.Gateway.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      gloo_projects_gloo_api_v1_options_pb.ListenerOptions.serializeBinaryToWriter
    );
  }
  f = message.getStatus();
  if (f != null) {
...
proto.gateway.solo.io.Gateway.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.ListenerOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.ListenerOptions, 5));
};
...
proto.gateway.solo.io.HttpGateway.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    solo$kit_api_v1_ref_pb.ResourceRef.toObject, includeInstance),
    ...
    options: (f = msg.getOptions()) && gloo_projects_gloo_api_v1_options_pb.HttpListenerOptions.toObject(includeInstance, f)
  };
...
proto.gateway.solo.io.HttpGateway.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 8:
      var value = new gloo_projects_gloo_api_v1_options_pb.HttpListenerOptions;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_pb.HttpListenerOptions.deserializeBinaryFromReader);
      msg.setOptions(value);
      break;
    default:
      reader.skipField();
...
proto.gateway.solo.io.HttpGateway.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      gloo_projects_gloo_api_v1_options_pb.HttpListenerOptions.serializeBinaryToWriter
    );
  }
};
...
proto.gateway.solo.io.HttpGateway.prototype.getVirtualServicesList = function() {
  return /** @type{!Array<!proto.core.solo.io.ResourceRef>} */ (
    jspb.Message.getRepeatedWrapperField(this, solo$kit_api_v1_ref_pb.ResourceRef, 1));
};
...
proto.gateway.solo.io.HttpGateway.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.HttpListenerOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.HttpListenerOptions, 8));
};
...
proto.gateway.solo.io.TcpGateway.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    gloo_projects_gloo_api_v1_proxy_pb.TcpHost.toObject, includeInstance),
    options: (f = msg.getOptions()) && gloo_projects_gloo_api_v1_options_pb.TcpListenerOptions.toObject(includeInstance, f)
  };
...
proto.gateway.solo.io.TcpGateway.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gloo_api_v1_proxy_pb.TcpHost;
      reader.readMessage(value,gloo_projects_gloo_api_v1_proxy_pb.TcpHost.deserializeBinaryFromReader);
      msg.addTcpHosts(value);
      break;
    case 8:
      var value = new gloo_projects_gloo_api_v1_options_pb.TcpListenerOptions;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_pb.TcpListenerOptions.deserializeBinaryFromReader);
      msg.setOptions(value);
      break;
    default:
      reader.skipField();
...
proto.gateway.solo.io.TcpGateway.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      gloo_projects_gloo_api_v1_proxy_pb.TcpHost.serializeBinaryToWriter
    );
  }
  f = message.getOptions();
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      gloo_projects_gloo_api_v1_options_pb.TcpListenerOptions.serializeBinaryToWriter
    );
  }
};
...
proto.gateway.solo.io.TcpGateway.prototype.getTcpHostsList = function() {
  return /** @type{!Array<!proto.gloo.solo.io.TcpHost>} */ (
    jspb.Message.getRepeatedWrapperField(this, gloo_projects_gloo_api_v1_proxy_pb.TcpHost, 1));
};
...
proto.gateway.solo.io.TcpGateway.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.TcpListenerOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.TcpListenerOptions, 8));
};
