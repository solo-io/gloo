...
var gloo_projects_gloo_api_v1_subset_pb = require('../../../../../gloo/projects/gloo/api/v1/subset_pb.js');
...
proto.gloo.solo.io.Listener.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    gloo_projects_gloo_api_v1_ssl_pb.SslConfig.toObject, includeInstance),
...
proto.gloo.solo.io.Listener.prototype.getSslConfigurationsList = function() {
  return /** @type{!Array<!proto.gloo.solo.io.SslConfig>} */ (
    jspb.Message.getRepeatedWrapperField(this, gloo_projects_gloo_api_v1_ssl_pb.SslConfig, 6));
};
...
proto.gloo.solo.io.Listener.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.ListenerOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.ListenerOptions, 8));
};
...
proto.gloo.solo.io.TcpHost.prototype.getSslConfig = function() {
  return /** @type{?proto.gloo.solo.io.SslConfig} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_ssl_pb.SslConfig, 3));
};
...
proto.gloo.solo.io.HttpListener.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.HttpListenerOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.HttpListenerOptions, 2));
};
...
proto.gloo.solo.io.Route.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.RouteOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.RouteOptions, 5));
};
...
proto.gloo.solo.io.Destination.toObject = function(includeInstance, msg) {
  var f, obj = {
    upstream: (f = msg.getUpstream()) && solo$kit_api_v1_ref_pb.ResourceRef.toObject(includeInstance, f),
    ...
    destinationSpec: (f = msg.getDestinationSpec()) && gloo_projects_gloo_api_v1_options_pb.DestinationSpec.toObject(includeInstance, f),
    subset: (f = msg.getSubset()) && gloo_projects_gloo_api_v1_subset_pb.Subset.toObject(includeInstance, f)
  };
...
proto.gloo.solo.io.Destination.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 12:
      ...
      break;
    case 2:
      var value = new gloo_projects_gloo_api_v1_options_pb.DestinationSpec;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_pb.DestinationSpec.deserializeBinaryFromReader);
      msg.setDestinationSpec(value);
      break;
    case 3:
      var value = new gloo_projects_gloo_api_v1_subset_pb.Subset;
      reader.readMessage(value,gloo_projects_gloo_api_v1_subset_pb.Subset.deserializeBinaryFromReader);
      msg.setSubset(value);
      break;
    default:
      reader.skipField();
...
proto.gloo.solo.io.Destination.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      gloo_projects_gloo_api_v1_options_pb.DestinationSpec.serializeBinaryToWriter
    );
  }
  f = message.getSubset();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      gloo_projects_gloo_api_v1_subset_pb.Subset.serializeBinaryToWriter
    );
  }
};
...
proto.gloo.solo.io.Destination.prototype.getUpstream = function() {
  return /** @type{?proto.core.solo.io.ResourceRef} */ (
    jspb.Message.getWrapperField(this, solo$kit_api_v1_ref_pb.ResourceRef, 10));
};
...
proto.gloo.solo.io.Destination.prototype.getDestinationSpec = function() {
  return /** @type{?proto.gloo.solo.io.DestinationSpec} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.DestinationSpec, 2));
};
...
proto.gloo.solo.io.Destination.prototype.getSubset = function() {
  return /** @type{?proto.gloo.solo.io.Subset} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_subset_pb.Subset, 3));
};
...
proto.gloo.solo.io.WeightedDestination.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    options: (f = msg.getOptions()) && gloo_projects_gloo_api_v1_options_pb.WeightedDestinationOptions.toObject(includeInstance, f)
  };
...
proto.gloo.solo.io.WeightedDestination.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new gloo_projects_gloo_api_v1_options_pb.WeightedDestinationOptions;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_pb.WeightedDestinationOptions.deserializeBinaryFromReader);
      msg.setOptions(value);
      break;
    default:
      reader.skipField();
...
proto.gloo.solo.io.WeightedDestination.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      gloo_projects_gloo_api_v1_options_pb.WeightedDestinationOptions.serializeBinaryToWriter
    );
  }
};
...
proto.gloo.solo.io.WeightedDestination.prototype.getOptions = function() {
  return /** @type{?proto.gloo.solo.io.WeightedDestinationOptions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_pb.WeightedDestinationOptions, 3));
};
