...
proto.enterprise.gloo.solo.io.ExtAuthExtension.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    configRef: (f = msg.getConfigRef()) && solo$kit_api_v1_ref_pb.ResourceRef.toObject(includeInstance, f),
...
proto.enterprise.gloo.solo.io.Settings.toObject = function(includeInstance, msg) {
  var f, obj = {
    extauthzServerRef: (f = msg.getExtauthzServerRef()) && solo$kit_api_v1_ref_pb.ResourceRef.toObject(includeInstance, f),
...
proto.enterprise.gloo.solo.io.ApiKeyAuth.prototype.getApiKeySecretRefsList = function() {
  return /** @type{!Array<!proto.core.solo.io.ResourceRef>} */ (
    jspb.Message.getRepeatedWrapperField(this, solo$kit_api_v1_ref_pb.ResourceRef, 2));
};
