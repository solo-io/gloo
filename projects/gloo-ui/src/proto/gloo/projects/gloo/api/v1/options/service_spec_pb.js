...
proto.options.gloo.solo.io.ServiceSpec.toObject = function(includeInstance, msg) {
  var f, obj = {
    rest: (f = msg.getRest()) && gloo_projects_gloo_api_v1_options_rest_rest_pb.ServiceSpec.toObject(includeInstance, f),
    grpc: (f = msg.getGrpc()) && gloo_projects_gloo_api_v1_options_grpc_grpc_pb.ServiceSpec.toObject(includeInstance, f)
  };
...
proto.options.gloo.solo.io.ServiceSpec.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gloo_api_v1_options_rest_rest_pb.ServiceSpec;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_rest_rest_pb.ServiceSpec.deserializeBinaryFromReader);
      msg.setRest(value);
      break;
    case 2:
      var value = new gloo_projects_gloo_api_v1_options_grpc_grpc_pb.ServiceSpec;
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_grpc_grpc_pb.ServiceSpec.deserializeBinaryFromReader);
      msg.setGrpc(value);
      break;
    default:
      reader.skipField();
...
proto.options.gloo.solo.io.ServiceSpec.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      gloo_projects_gloo_api_v1_options_rest_rest_pb.ServiceSpec.serializeBinaryToWriter
    );
  }
  f = message.getGrpc();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      gloo_projects_gloo_api_v1_options_grpc_grpc_pb.ServiceSpec.serializeBinaryToWriter
    );
  }
};
...
proto.options.gloo.solo.io.ServiceSpec.prototype.getRest = function() {
  return /** @type{?proto.rest.options.gloo.solo.io.ServiceSpec} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_rest_rest_pb.ServiceSpec, 1));
};
...
proto.options.gloo.solo.io.ServiceSpec.prototype.getGrpc = function() {
  return /** @type{?proto.grpc.options.gloo.solo.io.ServiceSpec} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_grpc_grpc_pb.ServiceSpec, 2));
};
