...
// file: gloo/projects/gloo/api/v1/options/transformation/transformation.proto
...
export class ResponseMatch extends jspb.Message {
  ...
  getMatchersList(): Array<gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher>;
  setMatchersList(value: Array<gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher>): void;
  addMatchers(value?: gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher, index?: number): gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher;
  ...
  getResponseTransformation(): gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation | undefined;
  setResponseTransformation(value?: gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation): void;
...
export namespace ResponseMatch {
  export type AsObject = {
    matchersList: Array<gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher.AsObject>,
    responseCodeDetails: string,
    responseTransformation?: gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.AsObject,
  }
}
...
export class RequestMatch extends jspb.Message {
  hasMatcher(): boolean;
  clearMatcher(): void;
  getMatcher(): gloo_projects_gloo_api_v1_core_matchers_matchers_pb.Matcher | undefined;
  setMatcher(value?: gloo_projects_gloo_api_v1_core_matchers_matchers_pb.Matcher): void;
  ...
  getRequestTransformation(): gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation | undefined;
  setRequestTransformation(value?: gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation): void;
...
export namespace RequestMatch {
  export type AsObject = {
    matcher?: gloo_projects_gloo_api_v1_core_matchers_matchers_pb.Matcher.AsObject,
    clearRouteCache: boolean,
    requestTransformation?: gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.AsObject,
    responseTransformation?: gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.AsObject,
  }
}
