...
proto.gloo.solo.io.Settings.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ratelimit: (f = msg.getRatelimit()) && gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.ServiceSettings.toObject(includeInstance, f),
    ...
    rbac: (f = msg.getRbac()) && gloo_projects_gloo_api_v1_enterprise_options_rbac_rbac_pb.Settings.toObject(includeInstance, f),
...
proto.gloo.solo.io.Settings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 26:
      var value = new gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.ServiceSettings;
      reader.readMessage(value,gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.ServiceSettings.deserializeBinaryFromReader);
    ...
    case 27:
      ...
      break;
    case 28:
      var value = new gloo_projects_gloo_api_v1_enterprise_options_rbac_rbac_pb.Settings;
      reader.readMessage(value,gloo_projects_gloo_api_v1_enterprise_options_rbac_rbac_pb.Settings.deserializeBinaryFromReader);
      msg.setRbac(value);
      break;
    case 29:
...
proto.gloo.solo.io.Settings.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      26,
      f,
      gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.ServiceSettings.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      28,
      f,
      gloo_projects_gloo_api_v1_enterprise_options_rbac_rbac_pb.Settings.serializeBinaryToWriter
    );
  }
...
proto.gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    rootca: (f = msg.getRootca()) && solo$kit_api_v1_ref_pb.ResourceRef.toObject(includeInstance, f),
...
proto.gloo.solo.io.Settings.ConsulUpstreamDiscoveryConfiguration.prototype.getRootca = function() {
  return /** @type{?proto.core.solo.io.ResourceRef} */ (
    jspb.Message.getWrapperField(this, solo$kit_api_v1_ref_pb.ResourceRef, 18));
};
...
proto.gloo.solo.io.Settings.prototype.getExtensions = function() {
  return /** @type{?proto.gloo.solo.io.Extensions} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_extensions_pb.Extensions, 16));
};
...
proto.gloo.solo.io.Settings.prototype.getRatelimit = function() {
  return /** @type{?proto.ratelimit.options.gloo.solo.io.ServiceSettings} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.ServiceSettings, 26));
};
...
proto.gloo.solo.io.Settings.prototype.getRatelimitServer = function() {
  return /** @type{?proto.ratelimit.options.gloo.solo.io.Settings} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.Settings, 27));
};
...
proto.gloo.solo.io.Settings.prototype.getRbac = function() {
  return /** @type{?proto.rbac.options.gloo.solo.io.Settings} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_rbac_rbac_pb.Settings, 28));
};
...
proto.gloo.solo.io.Settings.prototype.getExtauth = function() {
  return /** @type{?proto.enterprise.gloo.solo.io.Settings} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.Settings, 29));
};
...
proto.gloo.solo.io.Settings.prototype.getMetadata = function() {
  return /** @type{?proto.core.solo.io.Metadata} */ (
    jspb.Message.getWrapperField(this, solo$kit_api_v1_metadata_pb.Metadata, 14));
};
...
proto.gloo.solo.io.Settings.prototype.getStatus = function() {
  return /** @type{?proto.core.solo.io.Status} */ (
    jspb.Message.getWrapperField(this, solo$kit_api_v1_status_pb.Status, 15));
};
...
proto.gloo.solo.io.GlooOptions.prototype.getCircuitBreakers = function() {
  return /** @type{?proto.gloo.solo.io.CircuitBreakerConfig} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_circuit_breaker_pb.CircuitBreakerConfig, 3));
};
