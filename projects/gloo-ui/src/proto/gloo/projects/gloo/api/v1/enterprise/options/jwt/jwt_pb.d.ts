...
// file: gloo/projects/gloo/api/v1/enterprise/options/jwt/jwt.proto
...
export class RemoteJwks extends jspb.Message {
  ...
  getUpstreamRef(): solo_kit_api_v1_ref_pb.ResourceRef | undefined;
  setUpstreamRef(value?: solo_kit_api_v1_ref_pb.ResourceRef): void;
...
export namespace RemoteJwks {
  export type AsObject = {
    url: string,
    upstreamRef?: solo_kit_api_v1_ref_pb.ResourceRef.AsObject,
