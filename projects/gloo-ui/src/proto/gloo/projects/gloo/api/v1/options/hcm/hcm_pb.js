...
proto.hcm.options.gloo.solo.io.HttpConnectionManagerSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 17:
      ...
      reader.readMessage(value,gloo_projects_gloo_api_v1_options_tracing_tracing_pb.ListenerTracingSettings.deserializeBinaryFromReader);
...
proto.hcm.options.gloo.solo.io.HttpConnectionManagerSettings.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      17,
      f,
      gloo_projects_gloo_api_v1_options_tracing_tracing_pb.ListenerTracingSettings.serializeBinaryToWriter
    );
  }
...
proto.hcm.options.gloo.solo.io.HttpConnectionManagerSettings.prototype.getTracing = function() {
  return /** @type{?proto.tracing.options.gloo.solo.io.ListenerTracingSettings} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_options_tracing_tracing_pb.ListenerTracingSettings, 17));
};
