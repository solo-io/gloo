...
/**
 * optional envoy.config.filter.http.gzip.v2.Gzip gzip = 8;
 * @return {?proto.envoy.config.filter.http.gzip.v2.Gzip}
 */
proto.gloo.solo.io.HttpListenerOptions.prototype.getGzip = function() {
  return /** @type{?proto.envoy.config.filter.http.gzip.v2.Gzip} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_external_envoy_config_filter_http_gzip_v2_gzip_pb.Gzip, 8));
};


/** @param {?proto.envoy.config.filter.http.gzip.v2.Gzip|undefined} value */
...
/**
 * optional envoy.extensions.filters.http.buffer.v3.Buffer buffer = 12;
...
proto.gloo.solo.io.HttpListenerOptions.prototype.getBuffer = function() {
  return /** @type{?proto.envoy.extensions.filters.http.buffer.v3.Buffer} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_pb.Buffer, 12));
};
...
proto.gloo.solo.io.VirtualHostOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    rateLimitConfigs: (f = msg.getRateLimitConfigs()) && gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs.toObject(includeInstance, f),
    waf: (f = msg.getWaf()) && gloo_projects_gloo_api_v1_enterprise_options_waf_waf_pb.Settings.toObject(includeInstance, f),
...
proto.gloo.solo.io.VirtualHostOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 70:
      ...
      break;
    case 71:
      var value = new gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs;
      reader.readMessage(value,gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs.deserializeBinaryFromReader);
...
proto.gloo.solo.io.VirtualHostOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      71,
      f,
      gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs.serializeBinaryToWriter
    );
  }
  f = message.getWaf();
  if (f != null) {
...
proto.gloo.solo.io.VirtualHostOptions.prototype.getRatelimit = function() {
  return /** @type{?proto.ratelimit.options.gloo.solo.io.RateLimitVhostExtension} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitVhostExtension, 70));
};
...
proto.gloo.solo.io.VirtualHostOptions.prototype.getRateLimitConfigs = function() {
  return /** @type{?proto.ratelimit.options.gloo.solo.io.RateLimitConfigRefs} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs, 71));
};
...
/**
 * optional envoy.extensions.filters.http.buffer.v3.BufferPerRoute buffer_per_route = 14;
...
proto.gloo.solo.io.VirtualHostOptions.prototype.getBufferPerRoute = function() {
  return /** @type{?proto.envoy.extensions.filters.http.buffer.v3.BufferPerRoute} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_pb.BufferPerRoute, 14));
};


/** @param {?proto.envoy.extensions.filters.http.buffer.v3.BufferPerRoute|undefined} value */
...
proto.gloo.solo.io.RouteOptions.prototype.getRatelimit = function() {
  return /** @type{?proto.ratelimit.options.gloo.solo.io.RateLimitRouteExtension} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitRouteExtension, 140));
};
...
proto.gloo.solo.io.RouteOptions.prototype.getRateLimitConfigs = function() {
  return /** @type{?proto.ratelimit.options.gloo.solo.io.RateLimitConfigRefs} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs, 141));
};
...
/**
 * optional envoy.extensions.filters.http.buffer.v3.BufferPerRoute buffer_per_route = 22;
 * @return {?proto.envoy.extensions.filters.http.buffer.v3.BufferPerRoute}
 */
proto.gloo.solo.io.RouteOptions.prototype.getBufferPerRoute = function() {
  return /** @type{?proto.envoy.extensions.filters.http.buffer.v3.BufferPerRoute} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_pb.BufferPerRoute, 22));
};
...
/**
 * optional envoy.extensions.filters.http.buffer.v3.BufferPerRoute buffer_per_route = 5;
 * @return {?proto.envoy.extensions.filters.http.buffer.v3.BufferPerRoute}
 */
proto.gloo.solo.io.WeightedDestinationOptions.prototype.getBufferPerRoute = function() {
  return /** @type{?proto.envoy.extensions.filters.http.buffer.v3.BufferPerRoute} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_external_envoy_extensions_filters_http_buffer_v3_buffer_pb.BufferPerRoute, 5));
};
