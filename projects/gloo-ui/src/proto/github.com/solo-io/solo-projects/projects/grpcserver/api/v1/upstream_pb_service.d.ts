...
type UpstreamApiUpdateUpstreamYaml = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstream_pb.UpdateUpstreamYamlRequest;
  readonly responseType: typeof github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstream_pb.UpdateUpstreamResponse;
};
...
export class UpstreamApiClient {
  ...
  updateUpstreamYaml(
    requestMessage: github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstream_pb.UpdateUpstreamYamlRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstream_pb.UpdateUpstreamResponse|null) => void
  ): UnaryResponse;
  updateUpstreamYaml(
