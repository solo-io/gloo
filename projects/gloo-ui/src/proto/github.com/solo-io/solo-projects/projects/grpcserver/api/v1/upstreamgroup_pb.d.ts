...
export class UpstreamGroupDetails extends jspb.Message {
  ...
  getUpstreamGroup(): github_com_solo_io_gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup | undefined;
  setUpstreamGroup(value?: github_com_solo_io_gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup): void;
...
export namespace UpstreamGroupDetails {
  export type AsObject = {
    upstreamGroup?: github_com_solo_io_gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup.AsObject,
