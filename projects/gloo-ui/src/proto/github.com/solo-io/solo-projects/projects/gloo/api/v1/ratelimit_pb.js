...
proto.glooe.solo.io.RateLimitConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_solo$io_solo$projects_projects_gloo_api_v1_plugins_ratelimit_ratelimit_pb.Descriptor.toObject, includeInstance)
  };
...
proto.glooe.solo.io.RateLimitConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new github_com_solo$io_solo$projects_projects_gloo_api_v1_plugins_ratelimit_ratelimit_pb.Descriptor;
      reader.readMessage(value,github_com_solo$io_solo$projects_projects_gloo_api_v1_plugins_ratelimit_ratelimit_pb.Descriptor.deserializeBinaryFromReader);
...
proto.glooe.solo.io.RateLimitConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      github_com_solo$io_solo$projects_projects_gloo_api_v1_plugins_ratelimit_ratelimit_pb.Descriptor.serializeBinaryToWriter
    );
  }
};
...
proto.glooe.solo.io.RateLimitConfig.prototype.getDescriptorsList = function() {
  return /** @type{!Array<!proto.ratelimit.plugins.gloo.solo.io.Descriptor>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$projects_projects_gloo_api_v1_plugins_ratelimit_ratelimit_pb.Descriptor, 2));
};
