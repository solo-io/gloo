...
type ConfigApiUpdateSettingsYaml = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof github_com_solo_io_solo_projects_projects_grpcserver_api_v1_config_pb.UpdateSettingsYamlRequest;
  readonly responseType: typeof github_com_solo_io_solo_projects_projects_grpcserver_api_v1_config_pb.UpdateSettingsResponse;
};
...
export class ConfigApiClient {
  ...
  updateSettingsYaml(
    requestMessage: github_com_solo_io_solo_projects_projects_grpcserver_api_v1_config_pb.UpdateSettingsYamlRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: github_com_solo_io_solo_projects_projects_grpcserver_api_v1_config_pb.UpdateSettingsResponse|null) => void
  ): UnaryResponse;
  updateSettingsYaml(
