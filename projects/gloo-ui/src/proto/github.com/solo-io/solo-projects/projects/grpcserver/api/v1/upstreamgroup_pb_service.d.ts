...
type UpstreamGroupApiUpdateUpstreamGroupYaml = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstreamgroup_pb.UpdateUpstreamGroupYamlRequest;
  readonly responseType: typeof github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstreamgroup_pb.UpdateUpstreamGroupResponse;
};
...
export class UpstreamGroupApiClient {
  ...
  updateUpstreamGroupYaml(
    requestMessage: github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstreamgroup_pb.UpdateUpstreamGroupYamlRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: github_com_solo_io_solo_projects_projects_grpcserver_api_v1_upstreamgroup_pb.UpdateUpstreamGroupResponse|null) => void
  ): UnaryResponse;
  updateUpstreamGroupYaml(
