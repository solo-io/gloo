...
// file: github.com/solo-io/solo-kit/api/external/envoy/api/v2/discovery.proto
...
export class DiscoveryRequest extends jspb.Message {
  ...
  hasNode(): boolean;
  clearNode(): void;
  getNode(): github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_pb.Node | undefined;
  setNode(value?: github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_pb.Node): void;
...
export namespace DiscoveryRequest {
  export type AsObject = {
    versionInfo: string,
    node?: github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_pb.Node.AsObject,
...
export class DiscoveryResponse extends jspb.Message {
  ...
  getControlPlane(): github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_pb.ControlPlane | undefined;
  setControlPlane(value?: github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_pb.ControlPlane): void;
...
export namespace DiscoveryResponse {
  export type AsObject = {
    ...
    typeUrl: string,
    nonce: string,
    controlPlane?: github_com_solo_io_solo_kit_api_external_envoy_api_v2_core_base_pb.ControlPlane.AsObject,
  }
}
