...
proto.waf.options.gloo.solo.io.Settings.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    auditLogging: (f = msg.getAuditLogging()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_waf_waf_pb.AuditLogging.toObject(includeInstance, f),
...
proto.waf.options.gloo.solo.io.Settings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_waf_waf_pb.AuditLogging;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_waf_waf_pb.AuditLogging.deserializeBinaryFromReader);
...
proto.waf.options.gloo.solo.io.Settings.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_waf_waf_pb.AuditLogging.serializeBinaryToWriter
    );
  }
...
proto.waf.options.gloo.solo.io.Settings.prototype.getRuleSetsList = function() {
  return /** @type{!Array<!proto.envoy.config.filter.http.modsecurity.v2.RuleSet>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_waf_waf_pb.RuleSet, 4));
};
...
proto.waf.options.gloo.solo.io.Settings.prototype.getAuditLogging = function() {
  return /** @type{?proto.envoy.config.filter.http.modsecurity.v2.AuditLogging} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_waf_waf_pb.AuditLogging, 5));
};
