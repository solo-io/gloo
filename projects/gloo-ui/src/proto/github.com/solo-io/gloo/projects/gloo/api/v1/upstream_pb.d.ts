...
export class Upstream extends jspb.Message {
  ...
  hasFailover(): boolean;
  clearFailover(): void;
  getFailover(): github_com_solo_io_gloo_projects_gloo_api_v1_failover_pb.Failover | undefined;
  setFailover(value?: github_com_solo_io_gloo_projects_gloo_api_v1_failover_pb.Failover): void;
