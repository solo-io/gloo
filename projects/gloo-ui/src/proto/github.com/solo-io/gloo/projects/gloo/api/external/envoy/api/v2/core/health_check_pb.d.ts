...
export namespace HealthCheck {
  ...
  export class HttpHealthCheck extends jspb.Message {
    ...
    getExpectedStatusesList(): Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_range_pb.Int64Range>;
    setExpectedStatusesList(value: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_range_pb.Int64Range>): void;
    addExpectedStatuses(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_range_pb.Int64Range, index?: number): github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_range_pb.Int64Range;
  ...
  export namespace HttpHealthCheck {
    export type AsObject = {
      ...
      useHttp2: boolean,
      expectedStatusesList: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_range_pb.Int64Range.AsObject>,
    }
  }
