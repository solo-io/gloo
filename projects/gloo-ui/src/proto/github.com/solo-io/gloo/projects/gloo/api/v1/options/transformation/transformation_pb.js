...
proto.transformation.options.gloo.solo.io.ResponseMatch.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_solo$io_gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher.toObject, includeInstance),
    responseCodeDetails: jspb.Message.getFieldWithDefault(msg, 2, ""),
    responseTransformation: (f = msg.getResponseTransformation()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.toObject(includeInstance, f)
  };
...
proto.transformation.options.gloo.solo.io.ResponseMatch.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher.deserializeBinaryFromReader);
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.deserializeBinaryFromReader);
...
proto.transformation.options.gloo.solo.io.ResponseMatch.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      github_com_solo$io_gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.serializeBinaryToWriter
    );
  }
};
...
proto.transformation.options.gloo.solo.io.ResponseMatch.prototype.getMatchersList = function() {
  return /** @type{!Array<!proto.matchers.core.gloo.solo.io.HeaderMatcher>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_v1_core_matchers_matchers_pb.HeaderMatcher, 1));
};
...
proto.transformation.options.gloo.solo.io.ResponseMatch.prototype.getResponseTransformation = function() {
  return /** @type{?proto.envoy.api.v2.filter.http.Transformation} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation, 3));
};
...
proto.transformation.options.gloo.solo.io.RequestMatch.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requestTransformation: (f = msg.getRequestTransformation()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.toObject(includeInstance, f),
    responseTransformation: (f = msg.getResponseTransformation()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation.toObject(includeInstance, f)
  };
...
proto.transformation.options.gloo.solo.io.RequestMatch.prototype.getResponseTransformation = function() {
  return /** @type{?proto.envoy.api.v2.filter.http.Transformation} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation, 4));
};
...
proto.transformation.options.gloo.solo.io.Transformations.prototype.getRequestTransformation = function() {
  return /** @type{?proto.envoy.api.v2.filter.http.Transformation} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation, 1));
};
...
proto.transformation.options.gloo.solo.io.Transformations.prototype.getResponseTransformation = function() {
  return /** @type{?proto.envoy.api.v2.filter.http.Transformation} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_extensions_transformation_transformation_pb.Transformation, 2));
};
