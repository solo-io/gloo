...
proto.solo.io.envoy.extensions.filters.http.jwt_authn.v3.JwtProvider.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    localJwks: (f = msg.getLocalJwks()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource.toObject(includeInstance, f),
...
proto.solo.io.envoy.extensions.filters.http.jwt_authn.v3.JwtProvider.prototype.getLocalJwks = function() {
  return /** @type{?proto.solo.io.envoy.config.core.v3.DataSource} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource, 4));
};
