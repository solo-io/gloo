...
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_pb = require('../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/health_check_pb.js');
...
proto.envoy.config.health_checker.http_path.v2.HttpPath.toObject = function(includeInstance, msg) {
  var f, obj = {
    httpHealthCheck: (f = msg.getHttpHealthCheck()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_pb.HealthCheck.HttpHealthCheck.toObject(includeInstance, f)
  };
...
proto.envoy.config.health_checker.http_path.v2.HttpPath.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_pb.HealthCheck.HttpHealthCheck;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_pb.HealthCheck.HttpHealthCheck.deserializeBinaryFromReader);
...
proto.envoy.config.health_checker.http_path.v2.HttpPath.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_pb.HealthCheck.HttpHealthCheck.serializeBinaryToWriter
    );
  }
};
...
proto.envoy.config.health_checker.http_path.v2.HttpPath.prototype.getHttpHealthCheck = function() {
  return /** @type{?proto.solo.io.envoy.config.core.v3.HealthCheck.HttpHealthCheck} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_health_check_pb.HealthCheck.HttpHealthCheck, 1));
};
