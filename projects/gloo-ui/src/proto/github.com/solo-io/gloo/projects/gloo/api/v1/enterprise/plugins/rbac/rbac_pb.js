...
goog.exportSymbol('proto.rbac.plugins.gloo.solo.io.ExtensionSettings', null, global);
 ...
 * @constructor
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rbac.plugins.gloo.solo.io.ExtensionSettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.rbac.plugins.gloo.solo.io.ExtensionSettings.displayName = 'proto.rbac.plugins.gloo.solo.io.ExtensionSettings';
}
 ...
 * @return {!Object}
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.prototype.toObject = function(opt_includeInstance) {
  return proto.rbac.plugins.gloo.solo.io.ExtensionSettings.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rbac.plugins.gloo.solo.io.ExtensionSettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rbac.plugins.gloo.solo.io.ExtensionSettings;
  return proto.rbac.plugins.gloo.solo.io.ExtensionSettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rbac.plugins.gloo.solo.io.ExtensionSettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rbac.plugins.gloo.solo.io.ExtensionSettings}
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rbac.plugins.gloo.solo.io.ExtensionSettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rbac.plugins.gloo.solo.io.ExtensionSettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  f = message.getPoliciesMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.rbac.plugins.gloo.solo.io.Policy.serializeBinaryToWriter);
  }
};
 ...
 * @return {boolean}
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.prototype.getDisable = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.prototype.setDisable = function(value) {
  jspb.Message.setProto3BooleanField(this, 1, value);
};
 ...
 * @return {!jspb.Map<string,!proto.rbac.plugins.gloo.solo.io.Policy>}
 */
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.prototype.getPoliciesMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.rbac.plugins.gloo.solo.io.Policy>} */ (
...
proto.rbac.plugins.gloo.solo.io.ExtensionSettings.prototype.clearPoliciesMap = function() {
  this.getPoliciesMap().clear();
};
