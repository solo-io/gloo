...
// file: github.com/solo-io/gloo/projects/gloo/api/v1/options/kubernetes/kubernetes.proto
...
import * as github_com_solo_io_gloo_projects_gloo_api_v1_options_subset_spec_pb from "../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/v1/options/subset_spec_pb";
...
export class UpstreamSpec extends jspb.Message {
  ...
  getSubsetSpec(): github_com_solo_io_gloo_projects_gloo_api_v1_options_subset_spec_pb.SubsetSpec | undefined;
  setSubsetSpec(value?: github_com_solo_io_gloo_projects_gloo_api_v1_options_subset_spec_pb.SubsetSpec): void;
...
export namespace UpstreamSpec {
  export type AsObject = {
    ...
    subsetSpec?: github_com_solo_io_gloo_projects_gloo_api_v1_options_subset_spec_pb.SubsetSpec.AsObject,
  }
}
