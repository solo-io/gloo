...
// file: github.com/solo-io/gloo/projects/gloo/api/external/envoy/extensions/filters/http/jwt_authn/v3/config.proto
...
export class JwtProvider extends jspb.Message {
  ...
  clearLocalJwks(): void;
  getLocalJwks(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource | undefined;
  setLocalJwks(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource): void;
...
export namespace JwtProvider {
  export type AsObject = {
    ...
    localJwks?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource.AsObject,
    forward: boolean,
