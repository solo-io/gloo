...
var github_com_solo$io_gloo_projects_gloo_api_v1_failover_pb = require('../../../../../../../github.com/solo-io/gloo/projects/gloo/api/v1/failover_pb.js');
...
proto.gloo.solo.io.Upstream.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    failover: (f = msg.getFailover()) && github_com_solo$io_gloo_projects_gloo_api_v1_failover_pb.Failover.toObject(includeInstance, f),
...
proto.gloo.solo.io.Upstream.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 17:
      ...
      break;
    case 18:
      var value = new github_com_solo$io_gloo_projects_gloo_api_v1_failover_pb.Failover;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_v1_failover_pb.Failover.deserializeBinaryFromReader);
...
proto.gloo.solo.io.Upstream.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      18,
      f,
      github_com_solo$io_gloo_projects_gloo_api_v1_failover_pb.Failover.serializeBinaryToWriter
    );
  }
...
proto.gloo.solo.io.Upstream.prototype.getFailover = function() {
  return /** @type{?proto.gloo.solo.io.Failover} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_v1_failover_pb.Failover, 18));
};
 ...
 */
proto.gloo.solo.io.Upstream.prototype.getHttpProxyHostname = function() {
...
proto.gloo.solo.io.Upstream.prototype.setHttpProxyHostname = function(value) {
  jspb.Message.setWrapperField(this, 21, value);
};


proto.gloo.solo.io.Upstream.prototype.clearHttpProxyHostname = function() {
 ...
 * @return {!boolean}
 */
proto.gloo.solo.io.Upstream.prototype.hasHttpProxyHostname = function() {
