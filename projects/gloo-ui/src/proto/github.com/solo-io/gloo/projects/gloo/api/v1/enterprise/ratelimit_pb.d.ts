...
export class RateLimitConfig extends jspb.Message {
  ...
  getDescriptorsList(): Array<github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_plugins_ratelimit_ratelimit_pb.Descriptor>;
  setDescriptorsList(value: Array<github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_plugins_ratelimit_ratelimit_pb.Descriptor>): void;
  addDescriptors(value?: github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_plugins_ratelimit_ratelimit_pb.Descriptor, index?: number): github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_plugins_ratelimit_ratelimit_pb.Descriptor;
...
export namespace RateLimitConfig {
  export type AsObject = {
    domain: string,
    descriptorsList: Array<github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_plugins_ratelimit_ratelimit_pb.Descriptor.AsObject>,
  }
}
