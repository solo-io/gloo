...
proto.ratelimit.options.gloo.solo.io.IngressRateLimit.toObject = function(includeInstance, msg) {
  var f, obj = {
    authorizedLimits: (f = msg.getAuthorizedLimits()) && github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit.toObject(includeInstance, f),
    anonymousLimits: (f = msg.getAnonymousLimits()) && github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit.toObject(includeInstance, f)
  };
...
proto.ratelimit.options.gloo.solo.io.IngressRateLimit.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit.deserializeBinaryFromReader);
...
proto.ratelimit.options.gloo.solo.io.IngressRateLimit.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit.serializeBinaryToWriter
    );
  }
...
proto.ratelimit.options.gloo.solo.io.IngressRateLimit.prototype.getAuthorizedLimits = function() {
  return /** @type{?proto.ratelimit.api.solo.io.RateLimit} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit, 1));
};
...
proto.ratelimit.options.gloo.solo.io.IngressRateLimit.prototype.getAnonymousLimits = function() {
  return /** @type{?proto.ratelimit.api.solo.io.RateLimit} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimit, 2));
};
...
proto.ratelimit.options.gloo.solo.io.ServiceSettings.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.Descriptor.toObject, includeInstance),
    setDescriptorsList: jspb.Message.toObjectList(msg.getSetDescriptorsList(),
    github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.SetDescriptor.toObject, includeInstance)
  };
...
proto.ratelimit.options.gloo.solo.io.ServiceSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.Descriptor;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.Descriptor.deserializeBinaryFromReader);
      msg.addDescriptors(value);
      break;
    case 2:
      var value = new github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.SetDescriptor;
      reader.readMessage(value,github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.SetDescriptor.deserializeBinaryFromReader);
...
proto.ratelimit.options.gloo.solo.io.ServiceSettings.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.Descriptor.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.SetDescriptor.serializeBinaryToWriter
    );
  }
};
...
proto.ratelimit.options.gloo.solo.io.ServiceSettings.prototype.getDescriptorsList = function() {
  return /** @type{!Array<!proto.ratelimit.api.solo.io.Descriptor>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.Descriptor, 1));
};
...
proto.ratelimit.options.gloo.solo.io.ServiceSettings.prototype.getSetDescriptorsList = function() {
  return /** @type{!Array<!proto.ratelimit.api.solo.io.SetDescriptor>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.SetDescriptor, 2));
};
...
proto.ratelimit.options.gloo.solo.io.RateLimitVhostExtension.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimitActions;
...
proto.ratelimit.options.gloo.solo.io.RateLimitVhostExtension.prototype.getRateLimitsList = function() {
  return /** @type{!Array<!proto.ratelimit.api.solo.io.RateLimitActions>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimitActions, 1));
};
...
proto.ratelimit.options.gloo.solo.io.RateLimitRouteExtension.prototype.getRateLimitsList = function() {
  return /** @type{!Array<!proto.ratelimit.api.solo.io.RateLimitActions>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_solo$apis_api_rate$limiter_v1alpha1_ratelimit_pb.RateLimitActions, 2));
};
