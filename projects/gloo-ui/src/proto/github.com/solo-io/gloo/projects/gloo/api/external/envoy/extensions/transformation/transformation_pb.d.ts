...
import * as github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb from "../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/route/v3/route_components_pb";
...
export class TransformationRule extends jspb.Message {
  hasMatch(): boolean;
  clearMatch(): void;
  getMatch(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.RouteMatch | undefined;
  setMatch(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.RouteMatch): void;
...
export namespace TransformationRule {
  export type AsObject = {
    match?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.RouteMatch.AsObject,
...
export class ResponseMatcher extends jspb.Message {
  ...
  getHeadersList(): Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.HeaderMatcher>;
  setHeadersList(value: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.HeaderMatcher>): void;
  addHeaders(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.HeaderMatcher, index?: number): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.HeaderMatcher;

  hasResponseCodeDetails(): boolean;
  clearResponseCodeDetails(): void;
  getResponseCodeDetails(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_matcher_v3_string_pb.StringMatcher | undefined;
  setResponseCodeDetails(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_matcher_v3_string_pb.StringMatcher): void;
...
export namespace ResponseMatcher {
  export type AsObject = {
    headersList: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_route_v3_route_components_pb.HeaderMatcher.AsObject>,
    responseCodeDetails?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_matcher_v3_string_pb.StringMatcher.AsObject,
  }
}
