...
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb = require('../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/address_pb.js');
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb = require('../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/backoff_pb.js');
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb = require('../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/http_uri_pb.js');
...
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb = require('../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/type/v3/semantic_version_pb.js');
...
proto.solo.io.envoy.config.core.v3.BuildVersion.toObject = function(includeInstance, msg) {
  var f, obj = {
    version: (f = msg.getVersion()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion.toObject(includeInstance, f),
...
proto.solo.io.envoy.config.core.v3.BuildVersion.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion.deserializeBinaryFromReader);
...
proto.solo.io.envoy.config.core.v3.BuildVersion.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion.serializeBinaryToWriter
    );
  }
...
proto.solo.io.envoy.config.core.v3.BuildVersion.prototype.getVersion = function() {
  return /** @type{?proto.solo.io.envoy.type.v3.SemanticVersion} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion, 1));
};
...
proto.solo.io.envoy.config.core.v3.Node.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address.toObject, includeInstance)
  };
...
proto.solo.io.envoy.config.core.v3.Node.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      ...
      break;
    case 11:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address.deserializeBinaryFromReader);
...
proto.solo.io.envoy.config.core.v3.Node.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      11,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address.serializeBinaryToWriter
    );
  }
};
...
proto.solo.io.envoy.config.core.v3.Node.prototype.getListeningAddressesList = function() {
  return /** @type{!Array<!proto.solo.io.envoy.config.core.v3.Address>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address, 11));
};
...
proto.solo.io.envoy.config.core.v3.RetryPolicy.toObject = function(includeInstance, msg) {
  var f, obj = {
    retryBackOff: (f = msg.getRetryBackOff()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy.toObject(includeInstance, f),
...
proto.solo.io.envoy.config.core.v3.RetryPolicy.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy.deserializeBinaryFromReader);
...
proto.solo.io.envoy.config.core.v3.RetryPolicy.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy.serializeBinaryToWriter
    );
  }
...
proto.solo.io.envoy.config.core.v3.RetryPolicy.prototype.getRetryBackOff = function() {
  return /** @type{?proto.solo.io.envoy.config.core.v3.BackoffStrategy} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy, 1));
};
...
proto.solo.io.envoy.config.core.v3.RemoteDataSource.toObject = function(includeInstance, msg) {
  var f, obj = {
    httpUri: (f = msg.getHttpUri()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri.toObject(includeInstance, f),
...
proto.solo.io.envoy.config.core.v3.RemoteDataSource.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri.deserializeBinaryFromReader);
...
proto.solo.io.envoy.config.core.v3.RemoteDataSource.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri.serializeBinaryToWriter
    );
  }
  f = message.getSha256();
  if (f.length > 0) {
...
proto.solo.io.envoy.config.core.v3.RemoteDataSource.prototype.getHttpUri = function() {
  return /** @type{?proto.solo.io.envoy.config.core.v3.HttpUri} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri, 1));
};
...
proto.solo.io.envoy.config.core.v3.RuntimeFractionalPercent.toObject = function(includeInstance, msg) {
  var f, obj = {
    defaultValue: (f = msg.getDefaultValue()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_type_v3_percent_pb.FractionalPercent.toObject(includeInstance, f),
    runtimeKey: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
