...
// file: github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/base.proto

import * as jspb from "google-protobuf";
import * as github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb from "../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/address_pb";
import * as github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb from "../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/backoff_pb";
import * as github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb from "../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/http_uri_pb";
...
import * as github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb from "../../../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/type/v3/semantic_version_pb";
...
export class BuildVersion extends jspb.Message {
  hasVersion(): boolean;
  clearVersion(): void;
  getVersion(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion | undefined;
  setVersion(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion): void;
...
export namespace BuildVersion {
  export type AsObject = {
    version?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_semantic_version_pb.SemanticVersion.AsObject,
...
export class Node extends jspb.Message {
  ...
  getListeningAddressesList(): Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address>;
  setListeningAddressesList(value: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address>): void;
  addListeningAddresses(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address, index?: number): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address;
...
export namespace Node {
  export type AsObject = {
    ...
    listeningAddressesList: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_address_pb.Address.AsObject>,
  }
...
export class RetryPolicy extends jspb.Message {
  ...
  getRetryBackOff(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy | undefined;
  setRetryBackOff(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy): void;
...
export namespace RetryPolicy {
  export type AsObject = {
    retryBackOff?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_backoff_pb.BackoffStrategy.AsObject,
...
export class RemoteDataSource extends jspb.Message {
  hasHttpUri(): boolean;
  clearHttpUri(): void;
  getHttpUri(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri | undefined;
  setHttpUri(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri): void;
...
export namespace RemoteDataSource {
  export type AsObject = {
    httpUri?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_http_uri_pb.HttpUri.AsObject,
    sha256: string,
...
export class RuntimeFractionalPercent extends jspb.Message {
  hasDefaultValue(): boolean;
  clearDefaultValue(): void;
  getDefaultValue(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_percent_pb.FractionalPercent | undefined;
  setDefaultValue(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_percent_pb.FractionalPercent): void;
...
export namespace RuntimeFractionalPercent {
  export type AsObject = {
    defaultValue?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_v3_percent_pb.FractionalPercent.AsObject,
    runtimeKey: string,
  }
}
