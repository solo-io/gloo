...
goog.exportSymbol('proto.als.plugins.gloo.solo.io.GrpcService', null, global);
 ...
 * @const
 */
proto.als.plugins.gloo.solo.io.AccessLog.oneofGroups_ = [[2,3]];
...
proto.als.plugins.gloo.solo.io.AccessLog.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    grpcService: (f = msg.getGrpcService()) && proto.als.plugins.gloo.solo.io.GrpcService.toObject(includeInstance, f)
  };
...
proto.als.plugins.gloo.solo.io.AccessLog.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.als.plugins.gloo.solo.io.GrpcService;
      reader.readMessage(value,proto.als.plugins.gloo.solo.io.GrpcService.deserializeBinaryFromReader);
...
proto.als.plugins.gloo.solo.io.AccessLog.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.als.plugins.gloo.solo.io.GrpcService.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.als.plugins.gloo.solo.io.GrpcService}
 */
proto.als.plugins.gloo.solo.io.AccessLog.prototype.getGrpcService = function() {
  return /** @type{?proto.als.plugins.gloo.solo.io.GrpcService} */ (
    jspb.Message.getWrapperField(this, proto.als.plugins.gloo.solo.io.GrpcService, 3));
};


/** @param {?proto.als.plugins.gloo.solo.io.GrpcService|undefined} value */
proto.als.plugins.gloo.solo.io.AccessLog.prototype.setGrpcService = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.als.plugins.gloo.solo.io.AccessLog.oneofGroups_[0], value);
};


proto.als.plugins.gloo.solo.io.AccessLog.prototype.clearGrpcService = function() {
 ...
 * @return {!boolean}
 */
proto.als.plugins.gloo.solo.io.AccessLog.prototype.hasGrpcService = function() {
 ...
 * @constructor
 */
proto.als.plugins.gloo.solo.io.GrpcService = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.als.plugins.gloo.solo.io.GrpcService.repeatedFields_, proto.als.plugins.gloo.solo.io.GrpcService.oneofGroups_);
};
goog.inherits(proto.als.plugins.gloo.solo.io.GrpcService, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.als.plugins.gloo.solo.io.GrpcService.displayName = 'proto.als.plugins.gloo.solo.io.GrpcService';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.als.plugins.gloo.solo.io.GrpcService.repeatedFields_ = [4,5,6];
 ...
 * @const
 */
proto.als.plugins.gloo.solo.io.GrpcService.oneofGroups_ = [[2]];

/**
 * @enum {number}
 */
proto.als.plugins.gloo.solo.io.GrpcService.ServiceRefCase = {
  SERVICE_REF_NOT_SET: 0,
  STATIC_CLUSTER_NAME: 2
};

/**
 * @return {proto.als.plugins.gloo.solo.io.GrpcService.ServiceRefCase}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.getServiceRefCase = function() {
  return /** @type {proto.als.plugins.gloo.solo.io.GrpcService.ServiceRefCase} */(jspb.Message.computeOneofCase(this, proto.als.plugins.gloo.solo.io.GrpcService.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.toObject = function(opt_includeInstance) {
  return proto.als.plugins.gloo.solo.io.GrpcService.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.als.plugins.gloo.solo.io.GrpcService} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.als.plugins.gloo.solo.io.GrpcService.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.als.plugins.gloo.solo.io.GrpcService}
 */
proto.als.plugins.gloo.solo.io.GrpcService.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.als.plugins.gloo.solo.io.GrpcService;
  return proto.als.plugins.gloo.solo.io.GrpcService.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.als.plugins.gloo.solo.io.GrpcService} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.als.plugins.gloo.solo.io.GrpcService}
 */
proto.als.plugins.gloo.solo.io.GrpcService.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.als.plugins.gloo.solo.io.GrpcService.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.als.plugins.gloo.solo.io.GrpcService} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.als.plugins.gloo.solo.io.GrpcService.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.getLogName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.setLogName = function(value) {
  jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.getStaticClusterName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.setStaticClusterName = function(value) {
  jspb.Message.setOneofField(this, 2, proto.als.plugins.gloo.solo.io.GrpcService.oneofGroups_[0], value);
};


proto.als.plugins.gloo.solo.io.GrpcService.prototype.clearStaticClusterName = function() {
  jspb.Message.setOneofField(this, 2, proto.als.plugins.gloo.solo.io.GrpcService.oneofGroups_[0], undefined);
};
 ...
 * @return {!boolean}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.hasStaticClusterName = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Array<string>}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.getAdditionalRequestHeadersToLogList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 4));
};


/** @param {!Array<string>} value */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.setAdditionalRequestHeadersToLogList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.addAdditionalRequestHeadersToLog = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 4, value, opt_index);
};


proto.als.plugins.gloo.solo.io.GrpcService.prototype.clearAdditionalRequestHeadersToLogList = function() {
 ...
 * @return {!Array<string>}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.getAdditionalResponseHeadersToLogList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 5));
};


/** @param {!Array<string>} value */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.setAdditionalResponseHeadersToLogList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.addAdditionalResponseHeadersToLog = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 5, value, opt_index);
};


proto.als.plugins.gloo.solo.io.GrpcService.prototype.clearAdditionalResponseHeadersToLogList = function() {
 ...
 * @return {!Array<string>}
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.getAdditionalResponseTrailersToLogList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 6));
};


/** @param {!Array<string>} value */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.setAdditionalResponseTrailersToLogList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.als.plugins.gloo.solo.io.GrpcService.prototype.addAdditionalResponseTrailersToLog = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 6, value, opt_index);
};


proto.als.plugins.gloo.solo.io.GrpcService.prototype.clearAdditionalResponseTrailersToLogList = function() {
