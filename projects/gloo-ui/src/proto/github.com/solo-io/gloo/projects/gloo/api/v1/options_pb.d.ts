...
import * as github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_pb from "../../../../../../../github.com/solo-io/gloo/projects/gloo/api/v1/options/grpc_json/grpc_json_pb";
...
export class HttpListenerOptions extends jspb.Message {
  ...
  hasGzip(): boolean;
  clearGzip(): void;
  getGzip(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_filter_http_gzip_v2_gzip_pb.Gzip | undefined;
  setGzip(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_filter_http_gzip_v2_gzip_pb.Gzip): void;

  hasProxyLatency(): boolean;
  clearProxyLatency(): void;
  getProxyLatency(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_proxylatency_proxylatency_pb.ProxyLatency | undefined;
  setProxyLatency(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_extensions_proxylatency_proxylatency_pb.ProxyLatency): void;
  ...
  setGrpcJsonTranscoder(value?: github_com_solo_io_gloo_projects_gloo_api_v1_options_grpc_json_grpc_json_pb.GrpcJsonTranscoder): void;
...
export class VirtualHostOptions extends jspb.Message {
  ...
  getTransformations(): github_com_solo_io_gloo_projects_gloo_api_v1_options_transformation_transformation_pb.Transformations | undefined;
  setTransformations(value?: github_com_solo_io_gloo_projects_gloo_api_v1_options_transformation_transformation_pb.Transformations): void;
  ...
  getRateLimitConfigs(): github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs | undefined;
  setRateLimitConfigs(value?: github_com_solo_io_gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.RateLimitConfigRefs): void;
...
export namespace VirtualHostOptions {
  export type AsObject = {
    ...
    transformations?: github_com_solo_io_gloo_projects_gloo_api_v1_options_transformation_transformation_pb.Transformations.AsObject,
