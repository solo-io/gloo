...
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_zipkin_pb = require('../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/trace/v3/zipkin_pb.js');
var github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_datadog_pb = require('../../../../../../../../../github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/trace/v3/datadog_pb.js');
...
proto.tracing.options.gloo.solo.io.ListenerTracingSettings.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    zipkinConfig: (f = msg.getZipkinConfig()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_zipkin_pb.ZipkinConfig.toObject(includeInstance, f),
    datadogConfig: (f = msg.getDatadogConfig()) && github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_datadog_pb.DatadogConfig.toObject(includeInstance, f)
  };
...
proto.tracing.options.gloo.solo.io.ListenerTracingSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_zipkin_pb.ZipkinConfig;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_zipkin_pb.ZipkinConfig.deserializeBinaryFromReader);
      msg.setZipkinConfig(value);
      break;
    case 5:
      var value = new github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_datadog_pb.DatadogConfig;
      reader.readMessage(value,github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_datadog_pb.DatadogConfig.deserializeBinaryFromReader);
...
proto.tracing.options.gloo.solo.io.ListenerTracingSettings.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_zipkin_pb.ZipkinConfig.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_datadog_pb.DatadogConfig.serializeBinaryToWriter
    );
  }
};
...
proto.tracing.options.gloo.solo.io.ListenerTracingSettings.prototype.getZipkinConfig = function() {
  return /** @type{?proto.solo.io.envoy.config.trace.v3.ZipkinConfig} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_zipkin_pb.ZipkinConfig, 4));
};
...
proto.tracing.options.gloo.solo.io.ListenerTracingSettings.prototype.getDatadogConfig = function() {
  return /** @type{?proto.solo.io.envoy.config.trace.v3.DatadogConfig} */ (
    jspb.Message.getWrapperField(this, github_com_solo$io_gloo_projects_gloo_api_external_envoy_config_trace_v3_datadog_pb.DatadogConfig, 5));
};
