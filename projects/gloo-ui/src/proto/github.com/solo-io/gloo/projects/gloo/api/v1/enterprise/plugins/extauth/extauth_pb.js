...
goog.exportSymbol('proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool', null, global);
...
proto.extauth.plugins.gloo.solo.io.Ldap.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pool: (f = msg.getPool()) && proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.toObject(includeInstance, f)
  };
...
proto.extauth.plugins.gloo.solo.io.Ldap.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool;
      reader.readMessage(value,proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.deserializeBinaryFromReader);
      msg.setPool(value);
      break;
    default:
      reader.skipField();
...
proto.extauth.plugins.gloo.solo.io.Ldap.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.serializeBinaryToWriter
    );
  }
};
 ...
 * @constructor
 */
proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.displayName = 'proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool';
}
 ...
 * @return {!Object}
 */
proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.prototype.toObject = function(opt_includeInstance) {
  return proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool}
 */
proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool;
  return proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool}
 */
proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @return {?proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool}
 */
proto.extauth.plugins.gloo.solo.io.Ldap.prototype.getPool = function() {
  return /** @type{?proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool} */ (
    jspb.Message.getWrapperField(this, proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool, 5));
};


/** @param {?proto.extauth.plugins.gloo.solo.io.Ldap.ConnectionPool|undefined} value */
proto.extauth.plugins.gloo.solo.io.Ldap.prototype.setPool = function(value) {
  jspb.Message.setWrapperField(this, 5, value);
};


proto.extauth.plugins.gloo.solo.io.Ldap.prototype.clearPool = function() {
 ...
 * @return {!boolean}
 */
proto.extauth.plugins.gloo.solo.io.Ldap.prototype.hasPool = function() {
