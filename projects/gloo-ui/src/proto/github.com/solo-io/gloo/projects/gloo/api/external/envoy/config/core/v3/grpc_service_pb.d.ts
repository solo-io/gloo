...
// file: github.com/solo-io/gloo/projects/gloo/api/external/envoy/config/core/v3/grpc_service.proto
...
export class GrpcService extends jspb.Message {
  ...
  getInitialMetadataList(): Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.HeaderValue>;
  setInitialMetadataList(value: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.HeaderValue>): void;
  addInitialMetadata(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.HeaderValue, index?: number): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.HeaderValue;
...
export namespace GrpcService {
  export type AsObject = {
    ...
    initialMetadataList: Array<github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.HeaderValue.AsObject>,
  }
  ...
  export namespace GoogleGrpc {
    ...
    export class SslCredentials extends jspb.Message {
      ...
      clearRootCerts(): void;
      getRootCerts(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource | undefined;
      setRootCerts(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource): void;

      hasPrivateKey(): boolean;
      clearPrivateKey(): void;
      getPrivateKey(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource | undefined;
      setPrivateKey(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource): void;

      hasCertChain(): boolean;
      clearCertChain(): void;
      getCertChain(): github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource | undefined;
      setCertChain(value?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource): void;
    ...
    export namespace SslCredentials {
      export type AsObject = {
        rootCerts?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource.AsObject,
        privateKey?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource.AsObject,
        certChain?: github_com_solo_io_gloo_projects_gloo_api_external_envoy_config_core_v3_base_pb.DataSource.AsObject,
      }
    }
