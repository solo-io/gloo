...
goog.exportSymbol('proto.devportal.solo.io.UserStatus.State', null, global);
...
proto.devportal.solo.io.UserStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hasLoggedIn: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
...
proto.devportal.solo.io.UserStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.devportal.solo.io.UserStatus.State} */ (reader.readEnum());
      msg.setState(value);
      break;
    case 3:
 ...
 * @enum {number}
 */
proto.devportal.solo.io.UserStatus.State = {
  PENDING: 0,
  ACCEPTED: 1,
  INVALID: 2
};
 ...
 * @return {!proto.devportal.solo.io.UserStatus.State}
 */
proto.devportal.solo.io.UserStatus.prototype.getState = function() {
  return /** @type {!proto.devportal.solo.io.UserStatus.State} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.devportal.solo.io.UserStatus.State} value */
proto.devportal.solo.io.UserStatus.prototype.setState = function(value) {
