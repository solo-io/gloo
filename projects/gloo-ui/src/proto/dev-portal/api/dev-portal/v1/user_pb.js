...
proto.devportal.solo.io.UserStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    hasLoggedIn: jspb.Message.getFieldWithDefault(msg, 5, false)
  };
 ...
 * @return {string}
 */
proto.devportal.solo.io.UserStatus.prototype.getReason = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};


/** @param {string} value */
proto.devportal.solo.io.UserStatus.prototype.setReason = function(value) {
  jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * optional AccessLevelStatus access_level = 4;
...
proto.devportal.solo.io.UserStatus.prototype.getAccessLevel = function() {
  return /** @type{?proto.devportal.solo.io.AccessLevelStatus} */ (
    jspb.Message.getWrapperField(this, dev$portal_api_dev$portal_v1_access_level_pb.AccessLevelStatus, 4));
};
