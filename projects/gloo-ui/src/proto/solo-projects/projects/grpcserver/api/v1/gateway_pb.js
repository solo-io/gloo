...
var gloo_projects_gateway_api_v1_gateway_pb = require('../../../../../gloo/projects/gateway/api/v1/gateway_pb.js');
...
proto.glooeeapi.solo.io.GatewayDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
    gateway: (f = msg.getGateway()) && gloo_projects_gateway_api_v1_gateway_pb.Gateway.toObject(includeInstance, f),
...
proto.glooeeapi.solo.io.GatewayDetails.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gateway_api_v1_gateway_pb.Gateway;
      reader.readMessage(value,gloo_projects_gateway_api_v1_gateway_pb.Gateway.deserializeBinaryFromReader);
...
proto.glooeeapi.solo.io.GatewayDetails.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      gloo_projects_gateway_api_v1_gateway_pb.Gateway.serializeBinaryToWriter
    );
  }
  f = message.getRaw();
  if (f != null) {
...
proto.glooeeapi.solo.io.GatewayDetails.prototype.getGateway = function() {
  return /** @type{?proto.gateway.solo.io.Gateway} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gateway_api_v1_gateway_pb.Gateway, 1));
};
