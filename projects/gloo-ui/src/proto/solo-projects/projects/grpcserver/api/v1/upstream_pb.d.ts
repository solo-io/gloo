...
import * as gloo_projects_gloo_api_v1_upstream_pb from "../../../../../gloo/projects/gloo/api/v1/upstream_pb";
...
export class UpstreamDetails extends jspb.Message {
  hasUpstream(): boolean;
  clearUpstream(): void;
  getUpstream(): gloo_projects_gloo_api_v1_upstream_pb.Upstream | undefined;
  setUpstream(value?: gloo_projects_gloo_api_v1_upstream_pb.Upstream): void;
...
export namespace UpstreamDetails {
  export type AsObject = {
    upstream?: gloo_projects_gloo_api_v1_upstream_pb.Upstream.AsObject,
...
export class CreateUpstreamRequest extends jspb.Message {
  ...
  getUpstreamInput(): gloo_projects_gloo_api_v1_upstream_pb.Upstream | undefined;
  setUpstreamInput(value?: gloo_projects_gloo_api_v1_upstream_pb.Upstream): void;
...
export namespace CreateUpstreamRequest {
  export type AsObject = {
    upstreamInput?: gloo_projects_gloo_api_v1_upstream_pb.Upstream.AsObject,
  }
}
...
export class UpdateUpstreamYamlRequest extends jspb.Message {
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UpdateUpstreamYamlRequest.AsObject;
  static toObject(includeInstance: boolean, msg: UpdateUpstreamYamlRequest): UpdateUpstreamYamlRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: UpdateUpstreamYamlRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UpdateUpstreamYamlRequest;
  static deserializeBinaryFromReader(message: UpdateUpstreamYamlRequest, reader: jspb.BinaryReader): UpdateUpstreamYamlRequest;
}

export namespace UpdateUpstreamYamlRequest {
  export type AsObject = {
