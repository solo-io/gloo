...
export class VirtualServiceDetails extends jspb.Message {
  ...
  getVirtualService(): gloo_projects_gateway_api_v1_virtual_service_pb.VirtualService | undefined;
  setVirtualService(value?: gloo_projects_gateway_api_v1_virtual_service_pb.VirtualService): void;
...
export namespace VirtualServiceDetails {
  export type AsObject = {
    virtualService?: gloo_projects_gateway_api_v1_virtual_service_pb.VirtualService.AsObject,
...
export class ExtAuthPlugin extends jspb.Message {
  hasValue(): boolean;
  clearValue(): void;
  getValue(): gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.ExtAuthConfig | undefined;
  setValue(value?: gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.ExtAuthConfig): void;
...
export namespace ExtAuthPlugin {
  export type AsObject = {
    value?: gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.ExtAuthConfig.AsObject,
    error: string,
  }
}
...
export class RateLimitPlugin extends jspb.Message {
  hasValue(): boolean;
  clearValue(): void;
  getValue(): gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.IngressRateLimit | undefined;
  setValue(value?: gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.IngressRateLimit): void;
...
export namespace RateLimitPlugin {
  export type AsObject = {
    value?: gloo_projects_gloo_api_v1_enterprise_options_ratelimit_ratelimit_pb.IngressRateLimit.AsObject,
    error: string,
  }
}
...
export class RepeatedRoutes extends jspb.Message {
  clearValuesList(): void;
  getValuesList(): Array<gloo_projects_gateway_api_v1_virtual_service_pb.Route>;
  setValuesList(value: Array<gloo_projects_gateway_api_v1_virtual_service_pb.Route>): void;
  addValues(value?: gloo_projects_gateway_api_v1_virtual_service_pb.Route, index?: number): gloo_projects_gateway_api_v1_virtual_service_pb.Route;
...
export namespace RepeatedRoutes {
  export type AsObject = {
    valuesList: Array<gloo_projects_gateway_api_v1_virtual_service_pb.Route.AsObject>,
  }
}
...
export class SslConfigValue extends jspb.Message {
  hasValue(): boolean;
  clearValue(): void;
  getValue(): gloo_projects_gloo_api_v1_ssl_pb.SslConfig | undefined;
  setValue(value?: gloo_projects_gloo_api_v1_ssl_pb.SslConfig): void;
...
export namespace SslConfigValue {
  export type AsObject = {
    value?: gloo_projects_gloo_api_v1_ssl_pb.SslConfig.AsObject,
  }
}
...
export namespace ExtAuthInput {
  ...
  export class Config extends jspb.Message {
    hasOauth(): boolean;
    clearOauth(): void;
    getOauth(): gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.OAuth | undefined;
    setOauth(value?: gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.OAuth): void;

    hasCustomAuth(): boolean;
    clearCustomAuth(): void;
    getCustomAuth(): gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.CustomAuth | undefined;
    setCustomAuth(value?: gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.CustomAuth): void;
  ...
  export namespace Config {
    export type AsObject = {
      oauth?: gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.OAuth.AsObject,
      customAuth?: gloo_projects_gloo_api_v1_enterprise_options_extauth_v1_extauth_pb.CustomAuth.AsObject,
    }
...
export class RouteInput extends jspb.Message {
  ...
  getVirtualServiceRef(): solo_kit_api_v1_ref_pb.ResourceRef | undefined;
  setVirtualServiceRef(value?: solo_kit_api_v1_ref_pb.ResourceRef): void;
  ...
  hasRoute(): boolean;
  clearRoute(): void;
  getRoute(): gloo_projects_gateway_api_v1_virtual_service_pb.Route | undefined;
  setRoute(value?: gloo_projects_gateway_api_v1_virtual_service_pb.Route): void;
...
export namespace RouteInput {
  export type AsObject = {
    virtualServiceRef?: solo_kit_api_v1_ref_pb.ResourceRef.AsObject,
    index: number,
    route?: gloo_projects_gateway_api_v1_virtual_service_pb.Route.AsObject,
  }
}
