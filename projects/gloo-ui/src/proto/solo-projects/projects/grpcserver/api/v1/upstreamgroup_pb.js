...
proto.glooeeapi.solo.io.UpstreamGroupDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
    upstreamGroup: (f = msg.getUpstreamGroup()) && gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup.toObject(includeInstance, f),
...
proto.glooeeapi.solo.io.UpstreamGroupDetails.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup;
      reader.readMessage(value,gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup.deserializeBinaryFromReader);
...
proto.glooeeapi.solo.io.UpstreamGroupDetails.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup.serializeBinaryToWriter
    );
  }
  f = message.getRaw();
  if (f != null) {
...
proto.glooeeapi.solo.io.UpstreamGroupDetails.prototype.getUpstreamGroup = function() {
  return /** @type{?proto.gloo.solo.io.UpstreamGroup} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_proxy_pb.UpstreamGroup, 1));
};
