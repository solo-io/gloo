...
var solo_projects_projects_grpcserver_api_v1_secret_pb = require("../../../../../solo-projects/projects/grpcserver/api/v1/secret_pb");
...
SecretApi.GetSecret = {
  ...
  requestType: solo_projects_projects_grpcserver_api_v1_secret_pb.GetSecretRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_secret_pb.GetSecretResponse
};
...
SecretApi.ListSecrets = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_secret_pb.ListSecretsRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_secret_pb.ListSecretsResponse
};
...
SecretApi.CreateSecret = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_secret_pb.CreateSecretRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_secret_pb.CreateSecretResponse
};
...
SecretApi.UpdateSecret = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_secret_pb.UpdateSecretRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_secret_pb.UpdateSecretResponse
};
...
SecretApi.DeleteSecret = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_secret_pb.DeleteSecretRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_secret_pb.DeleteSecretResponse
};
