...
var gloo_projects_gloo_api_v1_artifact_pb = require('../../../../../gloo/projects/gloo/api/v1/artifact_pb.js');
...
proto.glooeeapi.solo.io.GetArtifactResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    artifact: (f = msg.getArtifact()) && gloo_projects_gloo_api_v1_artifact_pb.Artifact.toObject(includeInstance, f)
  };
...
proto.glooeeapi.solo.io.GetArtifactResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gloo_api_v1_artifact_pb.Artifact;
      reader.readMessage(value,gloo_projects_gloo_api_v1_artifact_pb.Artifact.deserializeBinaryFromReader);
...
proto.glooeeapi.solo.io.GetArtifactResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      gloo_projects_gloo_api_v1_artifact_pb.Artifact.serializeBinaryToWriter
    );
  }
};
...
proto.glooeeapi.solo.io.GetArtifactResponse.prototype.getArtifact = function() {
  return /** @type{?proto.gloo.solo.io.Artifact} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_artifact_pb.Artifact, 1));
};
...
proto.glooeeapi.solo.io.ListArtifactsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    gloo_projects_gloo_api_v1_artifact_pb.Artifact.toObject, includeInstance)
  };
...
proto.glooeeapi.solo.io.ListArtifactsResponse.prototype.getArtifactsList = function() {
  return /** @type{!Array<!proto.gloo.solo.io.Artifact>} */ (
    jspb.Message.getRepeatedWrapperField(this, gloo_projects_gloo_api_v1_artifact_pb.Artifact, 1));
};
...
proto.glooeeapi.solo.io.CreateArtifactRequest.prototype.getArtifact = function() {
  return /** @type{?proto.gloo.solo.io.Artifact} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_artifact_pb.Artifact, 3));
};
