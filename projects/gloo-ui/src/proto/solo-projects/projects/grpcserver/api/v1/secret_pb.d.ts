...
import * as gloo_projects_gloo_api_v1_secret_pb from "../../../../../gloo/projects/gloo/api/v1/secret_pb";
...
export class GetSecretResponse extends jspb.Message {
  hasSecret(): boolean;
  clearSecret(): void;
  getSecret(): gloo_projects_gloo_api_v1_secret_pb.Secret | undefined;
  setSecret(value?: gloo_projects_gloo_api_v1_secret_pb.Secret): void;
...
export namespace GetSecretResponse {
  export type AsObject = {
    secret?: gloo_projects_gloo_api_v1_secret_pb.Secret.AsObject,
  }
}
...
export class ListSecretsResponse extends jspb.Message {
  ...
  getSecretsList(): Array<gloo_projects_gloo_api_v1_secret_pb.Secret>;
  setSecretsList(value: Array<gloo_projects_gloo_api_v1_secret_pb.Secret>): void;
  addSecrets(value?: gloo_projects_gloo_api_v1_secret_pb.Secret, index?: number): gloo_projects_gloo_api_v1_secret_pb.Secret;
...
export namespace ListSecretsResponse {
  export type AsObject = {
    secretsList: Array<gloo_projects_gloo_api_v1_secret_pb.Secret.AsObject>,
  }
}
