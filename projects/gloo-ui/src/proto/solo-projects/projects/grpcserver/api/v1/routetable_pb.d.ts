...
import * as gloo_projects_gateway_api_v1_route_table_pb from "../../../../../gloo/projects/gateway/api/v1/route_table_pb";
...
export class RouteTableDetails extends jspb.Message {
  ...
  getRouteTable(): gloo_projects_gateway_api_v1_route_table_pb.RouteTable | undefined;
  setRouteTable(value?: gloo_projects_gateway_api_v1_route_table_pb.RouteTable): void;
...
export namespace RouteTableDetails {
  export type AsObject = {
    routeTable?: gloo_projects_gateway_api_v1_route_table_pb.RouteTable.AsObject,
