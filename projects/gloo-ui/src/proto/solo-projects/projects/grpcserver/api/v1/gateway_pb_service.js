...
var solo_projects_projects_grpcserver_api_v1_gateway_pb = require("../../../../../solo-projects/projects/grpcserver/api/v1/gateway_pb");
...
GatewayApi.GetGateway = {
  ...
  requestType: solo_projects_projects_grpcserver_api_v1_gateway_pb.GetGatewayRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_gateway_pb.GetGatewayResponse
};
...
GatewayApi.ListGateways = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_gateway_pb.ListGatewaysRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_gateway_pb.ListGatewaysResponse
};
...
GatewayApi.UpdateGateway = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_gateway_pb.UpdateGatewayRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_gateway_pb.UpdateGatewayResponse
};
...
GatewayApi.UpdateGatewayYaml = {
  ...
  requestStream: false,
  responseStream: false,
  requestType: solo_projects_projects_grpcserver_api_v1_gateway_pb.UpdateGatewayYamlRequest,
  responseType: solo_projects_projects_grpcserver_api_v1_gateway_pb.UpdateGatewayResponse
};
