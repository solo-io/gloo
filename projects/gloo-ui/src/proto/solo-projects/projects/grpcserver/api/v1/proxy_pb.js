...
proto.glooeeapi.solo.io.ProxyDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
    proxy: (f = msg.getProxy()) && gloo_projects_gloo_api_v1_proxy_pb.Proxy.toObject(includeInstance, f),
...
proto.glooeeapi.solo.io.ProxyDetails.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gloo_api_v1_proxy_pb.Proxy;
      reader.readMessage(value,gloo_projects_gloo_api_v1_proxy_pb.Proxy.deserializeBinaryFromReader);
      msg.setProxy(value);
      break;
    case 2:
...
proto.glooeeapi.solo.io.ProxyDetails.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      gloo_projects_gloo_api_v1_proxy_pb.Proxy.serializeBinaryToWriter
    );
  }
  f = message.getRaw();
  if (f != null) {
...
proto.glooeeapi.solo.io.ProxyDetails.prototype.getProxy = function() {
  return /** @type{?proto.gloo.solo.io.Proxy} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gloo_api_v1_proxy_pb.Proxy, 1));
};
