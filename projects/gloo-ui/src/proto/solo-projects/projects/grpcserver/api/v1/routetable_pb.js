...
var gloo_projects_gateway_api_v1_route_table_pb = require('../../../../../gloo/projects/gateway/api/v1/route_table_pb.js');
...
proto.glooeeapi.solo.io.RouteTableDetails.toObject = function(includeInstance, msg) {
  var f, obj = {
    routeTable: (f = msg.getRouteTable()) && gloo_projects_gateway_api_v1_route_table_pb.RouteTable.toObject(includeInstance, f),
...
proto.glooeeapi.solo.io.RouteTableDetails.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new gloo_projects_gateway_api_v1_route_table_pb.RouteTable;
      reader.readMessage(value,gloo_projects_gateway_api_v1_route_table_pb.RouteTable.deserializeBinaryFromReader);
...
proto.glooeeapi.solo.io.RouteTableDetails.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      gloo_projects_gateway_api_v1_route_table_pb.RouteTable.serializeBinaryToWriter
    );
  }
  f = message.getRaw();
  if (f != null) {
...
proto.glooeeapi.solo.io.RouteTableDetails.prototype.getRouteTable = function() {
  return /** @type{?proto.gateway.solo.io.RouteTable} */ (
    jspb.Message.getWrapperField(this, gloo_projects_gateway_api_v1_route_table_pb.RouteTable, 1));
};
