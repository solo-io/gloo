...
//go:generate sh -c "go list github.com/envoyproxy/go-control-plane/... | grep 'v[3-9]' | grep -v 'github.com/envoyproxy/go-control-plane/contrib/' | xargs -n1 -I{} echo '\t_ \"{}\"' >> filter_types.gen.go"
//go:generate sh -c "echo '\n\t// github.com/envoyproxy/go-control-plane/envoy/...' >> filter_types.gen.go"
//go:generate sh -c "go list github.com/envoyproxy/go-control-plane/envoy/... | grep 'v[3-9]' | grep -v 'github.com/envoyproxy/go-control-plane/contrib/' | xargs -n1 -I{} echo '\t_ \"{}\"' >> filter_types.gen.go"
//go:generate sh -c "echo '\n\t// github.com/envoyproxy/go-control-plane/ratelimit/...' >> filter_types.gen.go"
//go:generate sh -c "go list github.com/envoyproxy/go-control-plane/ratelimit/... | grep 'v[3-9]' | grep -v 'github.com/envoyproxy/go-control-plane/contrib/' | xargs -n1 -I{} echo '\t_ \"{}\"' >> filter_types.gen.go"
