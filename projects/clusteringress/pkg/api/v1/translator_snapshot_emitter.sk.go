...
var (
	...
	mTranslatorSnapshotIn = stats.Int64("translator_clusteringress_gloo_solo_io/emitter/snap_in", "Deprecated. Use translator_clusteringress_gloo_solo_io/emitter/resources_in. The number of snapshots in", "1")

	// metrics for emitter
	mTranslatorResourcesIn    = stats.Int64("translator_clusteringress_gloo_solo_io/emitter/resources_in", "The number of resource lists received on open watch channels", "1")
	mTranslatorSnapshotOut    = stats.Int64("translator_clusteringress_gloo_solo_io/emitter/snap_out", "The number of snapshots out", "1")
	mTranslatorSnapshotMissed = stats.Int64("translator_clusteringress_gloo_solo_io/emitter/snap_missed", "The number of snapshots missed", "1")

	// views for emitter
	// deprecated: see translatorResourcesInView
	translatorsnapshotInView = &view.View{
		Name:        "translator_clusteringress_gloo_solo_io/emitter/snap_in",
		Measure:     mTranslatorSnapshotIn,
		Description: "Deprecated. Use translator_clusteringress_gloo_solo_io/emitter/resources_in. The number of snapshots updates coming in.",
		Aggregation: view.Count(),
		TagKeys:     []tag.Key{},
	}

	translatorResourcesInView = &view.View{
		Name:        "translator_clusteringress_gloo_solo_io/emitter/resources_in",
	...
	translatorsnapshotOutView = &view.View{
		Name:        "translator_clusteringress_gloo_solo_io/emitter/snap_out",
	...
	translatorsnapshotMissedView = &view.View{
		Name:        "translator_clusteringress_gloo_solo_io/emitter/snap_missed",
