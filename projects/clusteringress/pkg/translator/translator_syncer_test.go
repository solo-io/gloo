...
var _ = Describe("TranslatorSyncer", func() {
	It("propagates successful proxy status to the clusteringresses it was created from", func() {
		...
		ci, err = knativeClient.ciClient.Get(ctx, clusterIngress.Name, metav1.GetOptions{})
		Expect(err).NotTo(HaveOccurred())
...
func (c *mockCiClient) UpdateStatus(ctx context.Context, ingress *v1alpha12.Ingress, opts metav1.UpdateOptions) (*v1alpha12.Ingress, error) {
	c.ci.Status = ingress.Status
	return ingress, nil
}

func (*mockCiClient) Create(ctx context.Context, ingress *v1alpha12.Ingress, opts metav1.CreateOptions) (*v1alpha12.Ingress, error) {
	panic("implement me")
}

func (*mockCiClient) Update(ctx context.Context, ingress *v1alpha12.Ingress, opts metav1.UpdateOptions) (*v1alpha12.Ingress, error) {
	panic("implement me")
}

func (*mockCiClient) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
	panic("implement me")
}

func (*mockCiClient) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	panic("implement me")
}

func (c *mockCiClient) Get(ctx context.Context, name string, opts metav1.GetOptions) (*v1alpha12.Ingress, error) {
	return c.ci, nil
}

func (*mockCiClient) List(ctx context.Context, opts metav1.ListOptions) (*v1alpha12.IngressList, error) {
	panic("implement me")
}
...
func (*mockCiClient) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts metav1.PatchOptions, subresources ...string) (result *v1alpha12.Ingress, err error) {
	panic("implement me")
}
