...
import (
	...
	versioned "github.com/solo-io/glue/implemented_modules/kube/configwatcher/crd/client/clientset/versioned"
	...
	v1 "github.com/solo-io/glue/implemented_modules/kube/configwatcher/crd/client/listers/solo.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.GlueV1().Upstreams(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlueV1().Upstreams(namespace).Watch(options)
			},
		},
		&solo_io_v1.Upstream{},
		resyncPeriod,
...
func (f *upstreamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&solo_io_v1.Upstream{}, f.defaultInformer)
}
