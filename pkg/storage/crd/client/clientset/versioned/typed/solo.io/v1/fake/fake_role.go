...
var rolesResource = schema.GroupVersionResource{Group: "gloo.solo.io", Version: "v1", Resource: "roles"}

var rolesKind = schema.GroupVersionKind{Group: "gloo.solo.io", Version: "v1", Kind: "Role"}

// Get takes name of the role, and returns the corresponding role object, and an error if there is any.
func (c *FakeRoles) Get(name string, options v1.GetOptions) (result *solo_io_v1.Role, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(rolesResource, c.ns, name), &solo_io_v1.Role{})

	if obj == nil {
		return nil, err
	}
	return obj.(*solo_io_v1.Role), err
}

// List takes label and field selectors, and returns the list of Roles that match those selectors.
func (c *FakeRoles) List(opts v1.ListOptions) (result *solo_io_v1.RoleList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(rolesResource, rolesKind, c.ns, opts), &solo_io_v1.RoleList{})
	...
	list := &solo_io_v1.RoleList{}
	for _, item := range obj.(*solo_io_v1.RoleList).Items {
...
func (c *FakeRoles) Create(role *solo_io_v1.Role) (result *solo_io_v1.Role, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(rolesResource, c.ns, role), &solo_io_v1.Role{})
...
func (c *FakeRoles) Update(role *solo_io_v1.Role) (result *solo_io_v1.Role, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(rolesResource, c.ns, role), &solo_io_v1.Role{})
...
func (c *FakeRoles) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(rolesResource, c.ns, name), &solo_io_v1.Role{})
...
func (c *FakeRoles) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &solo_io_v1.RoleList{})
	return err
}
...
func (c *FakeRoles) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *solo_io_v1.Role, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(rolesResource, c.ns, name, data, subresources...), &solo_io_v1.Role{})
