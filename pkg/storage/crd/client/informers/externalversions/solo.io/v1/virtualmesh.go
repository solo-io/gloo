	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.GlooV1().VirtualMeshes(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlooV1().VirtualMeshes(namespace).Watch(options)
			},
		},
		&solo_io_v1.VirtualMesh{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *virtualMeshInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&solo_io_v1.VirtualMesh{}, f.defaultInformer)
}

func (f *virtualMeshInformer) Lister() v1.VirtualMeshLister {
	return v1.NewVirtualMeshLister(f.Informer().GetIndexer())
}
