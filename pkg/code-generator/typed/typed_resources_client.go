...
var funcs = template.FuncMap{
	...
	"clients": func(params PackageLevelTemplateParams, addTypes bool) string {
...
var cacheTemplate = template.Must(template.New("cache").Funcs(funcs).Parse(inventoryTemplateContents))
