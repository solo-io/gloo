...
func (m *MockNamespaceLister) List(ctx context.Context) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockNamespaceListerMockRecorder) List(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockNamespaceLister)(nil).List), ctx)
}
