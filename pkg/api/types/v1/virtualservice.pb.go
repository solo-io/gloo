...
type VirtualService struct {
	...
	// Node Groups declare which nodes in the mesh the virtual service is visible to.
	// domains must be unique amongst virtual services within a node group.
	NodeGroups []string `protobuf:"bytes,7,rep,name=node_groups,json=nodeGroups" json:"node_groups,omitempty"`
...
func (m *VirtualService) GetNodeGroups() []string {
	if m != nil {
		return m.NodeGroups
	}
	return nil
...
func (this *VirtualService) Equal(that interface{}) bool {
	...
	if len(this.NodeGroups) != len(that1.NodeGroups) {
		return false
	}
	for i := range this.NodeGroups {
		if this.NodeGroups[i] != that1.NodeGroups[i] {
			return false
		}
	}
...
var fileDescriptorVirtualservice = []byte{
	...
	,
}
