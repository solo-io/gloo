...
var _ = Describe("waf", func() {
	//TODO(kdorosh) remove once we stop supporting deprecated config
 ...
 `
	...
	//TODO(kdorosh) remove this context and put it at the top level once we remove the deprecated config context
