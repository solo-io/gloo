...
// TestGlooGatewayEdgeByoGateway is the function which executes a series of tests against a given installation where
// the k8s Gateway controller is disabled
func TestGlooGatewayEdgeByoGateway(t *testing.T) {
	...
	EdgeByoGwSuiteRunner().Run(ctx, t, testInstallation)
}
