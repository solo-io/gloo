...
//
//	mockgen -destination ./cache/corecache.go github.com/solo-io/solo-kit/pkg/api/v1/clients/kube/cache KubeCoreCache
//
...
func (m *MockKubeCoreCache) NamespacedConfigMapLister(ns string) cache.ConfigMapLister {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NamespacedConfigMapLister", ns)
	ret0, _ := ret[0].(cache.ConfigMapLister)
	return ret0
}

// NamespacedConfigMapLister indicates an expected call of NamespacedConfigMapLister.
func (mr *MockKubeCoreCacheMockRecorder) NamespacedConfigMapLister(ns any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NamespacedConfigMapLister", reflect.TypeOf((*MockKubeCoreCache)(nil).NamespacedConfigMapLister), ns)
}

// NamespacedPodLister mocks base method.
func (m *MockKubeCoreCache) NamespacedPodLister(ns string) cache.PodLister {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NamespacedPodLister", ns)
	ret0, _ := ret[0].(cache.PodLister)
	return ret0
}

// NamespacedPodLister indicates an expected call of NamespacedPodLister.
func (mr *MockKubeCoreCacheMockRecorder) NamespacedPodLister(ns any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NamespacedPodLister", reflect.TypeOf((*MockKubeCoreCache)(nil).NamespacedPodLister), ns)
}

// NamespacedSecretLister mocks base method.
func (m *MockKubeCoreCache) NamespacedSecretLister(ns string) cache.SecretLister {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NamespacedSecretLister", ns)
	ret0, _ := ret[0].(cache.SecretLister)
	return ret0
}

// NamespacedSecretLister indicates an expected call of NamespacedSecretLister.
func (mr *MockKubeCoreCacheMockRecorder) NamespacedSecretLister(ns any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NamespacedSecretLister", reflect.TypeOf((*MockKubeCoreCache)(nil).NamespacedSecretLister), ns)
}

// NamespacedServiceLister mocks base method.
func (m *MockKubeCoreCache) NamespacedServiceLister(ns string) cache.ServiceLister {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NamespacedServiceLister", ns)
	ret0, _ := ret[0].(cache.ServiceLister)
	return ret0
}

// NamespacedServiceLister indicates an expected call of NamespacedServiceLister.
func (mr *MockKubeCoreCacheMockRecorder) NamespacedServiceLister(ns any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NamespacedServiceLister", reflect.TypeOf((*MockKubeCoreCache)(nil).NamespacedServiceLister), ns)
}
...
func (mr *MockKubeCoreCacheMockRecorder) Unsubscribe(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
