...
//go:generate go run github.com/golang/mock/mockgen -destination ./gloo/validation_client.go github.com/kgateway-dev/kgateway/projects/gloo/pkg/api/grpc/validation GlooValidationServiceClient
