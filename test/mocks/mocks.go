...
//go:generate mockgen -destination ./gloo/validation_client.go github.com/solo-io/gloo/projects/controller/pkg/api/grpc/validation GlooValidationServiceClient
