...
import (
	...
	kubepluginapi "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/kubernetes"
...
// Kubernetes tests for plugin from projects/controller/pkg/plugins/kubernetes
