...
func NewKubeResourceClientSet(ctx context.Context, cfg *rest.Config) (*KubeResourceClientSet, error) {
	...
	// Artifact
	// Mirror kube setup from: https://github.com/solo-io/gloo/blob/dc96c0cd0e4d93457e77a848d69a0d652488a92e/projects/controller/pkg/bootstrap/utils.go#L216
	...
	// Secret
	// Mirror kube setup from: https://github.com/solo-io/gloo/blob/dc96c0cd0e4d93457e77a848d69a0d652488a92e/projects/controller/pkg/bootstrap/utils.go#L170
