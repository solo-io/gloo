...
import (
	...
	"github.com/solo-io/gloo/projects/controllerrollerroller/pkg/setup"
...
var _ = Describe("Consul + Vault Configuration Happy Path e2e", decorators.Vault, decorators.Consul, func() {
	...
	BeforeEach(func() {
		...
		vaultResources = vault.NewVaultSecretClientFactory(ctx, vault.NoopVaultClientInitFunc(vaultClient), customSecretEngine, bootstrap.DefaultRootKey)
