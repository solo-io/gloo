...
| `circuitBreakers` | [.gloo.solo.io.CircuitBreakerConfig](../circuite_breakers.proto.sk#circuitbreakerconfig) | Circuite breakers for this upstream. if not set, the defaults ones from the Gloo settings will be used. if those are not set, [envoy's defaults](https://www.envoyproxy.io/docs/envoy/latest/api-v2/api/v2/cluster/circuit_breaker.proto#envoy-api-msg-cluster-circuitbreakers) will be used. |  |
