...
| Field | Type | Description |
| ----- | ---- | ----------- | 
| `match` | [.solo.io.envoy.config.route.v3.RouteMatch](../../../config/core/v3/route_components.proto.sk/#routematch) | if no match is specified, will match all. |
