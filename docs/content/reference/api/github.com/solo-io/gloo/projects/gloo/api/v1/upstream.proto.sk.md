...
"initialConnectionWindowSize": .google.protobuf.StringValue
...
"coolNewField": .google.protobuf.StringValue
"nonNullableNewField": string
...
| `initialConnectionWindowSize` | [.google.protobuf.StringValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/string-value) | (UInt32Value) Similar to initial_stream_window_size, but for connection-level flow-control window. Currently, this has the same minimum/maximum/default as initial_stream_window_size. Requires UseHttp2 to be true to be acknowledged. |
...
| `coolNewField` | [.google.protobuf.StringValue](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/string-value) |  |
| `nonNullableNewField` | `string` |  |
