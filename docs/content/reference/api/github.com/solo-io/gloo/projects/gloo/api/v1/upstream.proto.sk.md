...
"proxyProtocolVersion": .google.protobuf.Int32Value
...
| `proxyProtocolVersion` | [.google.protobuf.Int32Value](https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/int-32-value) | Proxy Protocol Version to add when communicating with the upstream. If unset will not wrap the transport socket. Currently only implemented on Static Upstreams. |
