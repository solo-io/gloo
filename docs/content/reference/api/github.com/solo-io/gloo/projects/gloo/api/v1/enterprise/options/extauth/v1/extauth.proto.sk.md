...
"request": .enterprise.gloo.solo.io.PassThroughGrpc.Request
...
| `request` | [.enterprise.gloo.solo.io.PassThroughGrpc.Request](../extauth.proto.sk/#request) | Pass through the incoming request body, ext auth state, and filter metadata. For more information, see the [PassThrough Http Request description](#request-1). |
