...
| `setFilterState` | [.set_filter_state.options.gloo.solo.io.SetFilterState](../options/set_filter_state/set_filter_state.proto.sk/#setfilterstate) | Settings to configure set-filter-state settings for a route. |
