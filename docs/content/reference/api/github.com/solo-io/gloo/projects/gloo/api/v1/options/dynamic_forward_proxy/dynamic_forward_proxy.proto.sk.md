...
| `circuitBreakers` | [.gloo.solo.io.CircuitBreakerConfig](../../../circuit_breaker.proto.sk/#circuitbreakerconfig) | Circuit breakers for this proxy. if not set, the defaults ones from the Gloo settings will be used. if those are not set, [envoy's defaults](https://www.envoyproxy.io/docs/envoy/latest/api-v3/config/cluster/v3/circuit_breaker.proto#envoy-api-msg-cluster-circuitbreakers) will be used. |
