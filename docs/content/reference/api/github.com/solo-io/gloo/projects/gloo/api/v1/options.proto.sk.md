...
"extProc": .extproc.options.gloo.solo.io.RouteSettings
"ai": .ai.options.gloo.solo.io.Settings
...
| `ai` | [.ai.options.gloo.solo.io.Settings](../enterprise/options/ai/ai.proto.sk/#settings) | Enterprise-only: Settings to configure ai settings for a route. These settings will only apply if the backend is an `ai` Upstream. |
