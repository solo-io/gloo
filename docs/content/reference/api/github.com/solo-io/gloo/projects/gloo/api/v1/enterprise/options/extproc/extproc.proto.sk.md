...
| `requestAttributes` | `[]string` | Set different optional attributes than the default setting of the `request_attributes` field. |
| `responseAttributes` | `[]string` | Set different optional properties than the default setting of the `response_attributes` field. |
