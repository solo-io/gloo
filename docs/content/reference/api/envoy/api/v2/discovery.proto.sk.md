...
| `errorDetail` | [.google.rpc.Status](../../../../github.com/solo-io/solo-kit/api/external/google/rpc/status.proto.sk/#status) | This is populated when the previous `DiscoveryResponse (envoy_api_msg_DiscoveryResponse)` failed to update configuration. The *message* field in *error_details* provides the Envoy internal exception related to the failure. It is only intended for consumption during manual debugging, the string provided is not guaranteed to be stable across Envoy versions. |  |
...
| `errorDetail` | [.google.rpc.Status](../../../../github.com/solo-io/solo-kit/api/external/google/rpc/status.proto.sk/#status) | This is populated when the previous `DiscoveryResponse (envoy_api_msg_DiscoveryResponse)` failed to update configuration. The *message* field in *error_details* provides the Envoy internal exception related to the failure. |  |
