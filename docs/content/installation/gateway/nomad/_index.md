...
Congratulations! You've successfully deployed Gloo to Nomad and created your first route. Now let's delve deeper into the world of [Traffic Management with Gloo]({{< versioned_link_path fromRoot="/guides/traffic_management/" >}}).
