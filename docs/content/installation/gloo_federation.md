...
Gloo Federation is installed using the `glooctl` command line tool or a Helm chart. The following document will take you through the process of performing the installation of Gloo Federation, verifying the components, and removing Gloo Federation if necessary.
...
You will also need a license key to install Gloo Federation. The key can be procured by visiting the [Solo.io website](https://solo.io).
