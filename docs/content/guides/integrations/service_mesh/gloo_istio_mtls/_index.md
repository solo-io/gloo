...
This guide was tested with Istio 1.6.6 and 1.7. For older versions of Istio, see [here](/guides/integrations/service_mesh/gloo_istio_mtls/older_istio_versions/)
