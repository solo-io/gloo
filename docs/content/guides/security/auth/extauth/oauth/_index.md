...
When front channel logout is used, `logoutPath` intiates the logout, `frontChannelLogout.path` handles the per-session deletion of the user session and cookie.
