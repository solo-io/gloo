...
* **Opencensus tracing extension**: Support for the Opencensus tracing extension is removed in Envoy 1.32 and 1.33. For more information, see the related [Envoy issue](https://github.com/envoyproxy/envoy/issues/27401). 
