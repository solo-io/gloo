...
For more information, see the [health check API documentation]({{% versioned_link_path fromRoot="/reference/api/github.com/solo-io/gloo/projects/controller/api/external/envoy/api/v2/core/health_check.proto.sk/#healthcheck" %}}).
