---
title: Contribute to the Gloo Gateway docs
...
In this step you will make the actual change to the document that has an issue. From the forked repository, select the branch you want to make changes to. The current branch being used to generate the Gloo Gateway docs is `main`. The files that make up the docs website are in `docs/content`, and the directory structure follows the menu structure of the docs site.
...
* Select the proper branch for the Gloo Gateway repository (`main`) and the branch you just created
